 ...
 *
 *	unixc.c - fichier parametre pour console UNIX SYSTEM V SCO Couleur
 *
 *	$Header:   C:/cico/fp/unixc.c@@   1.2   23 Aug 1990 14:35:28   DLR  $
 *
 */
...
char *nom = "console UNIX SYSTEM V SCO Couleur ($Date:   23 Aug 1990 14:35:28  $)";
...
char *tab_str[] = {
	...
	"\033[=4F",                     /* rouge                        */
	"\033[=2F",                     /* vert                         */
	"\033[=6F",                     /* marron / jaune fonce         */
	"\033[=1F",                     /* bleu                         */
	"\033[=5F",                     /* magenta                      */
	"\033[=3F",                     /* cyan                         */
	"\033[=7F",                     /* gris clair / blanc           */
	"\033[=8F",                     /* gris fonce                   */
	"\033[=12F",                     /* rouge clair                  */
	"\033[=10F",                     /* vert clair                   */
	"\033[=14F",                     /* jaune                        */
	"\033[=9F",                     /* bleu clair                   */
	"\033[=13F",                     /* magenta clair                */
	"\033[=11F",                     /* cyan clair                   */
	"\033[=15F",                     /* blanc brillant               */
	...
	"\033[=4G",                     /* rouge                        */
	"\033[=2G",                     /* vert                         */
	"\033[=6G",                     /* marron / jaune fonce         */
	"\033[=1G",                     /* bleu                         */
	"\033[=5G",                     /* magenta                      */
	"\033[=3G",                     /* cyan                         */
	"\033[=7G",                     /* gris clair / blanc           */
