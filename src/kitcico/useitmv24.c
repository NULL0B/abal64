...
CICO=useitmv:/opt/prologue/lib/cico:1 
*/

#define COULEUR
char *fichier="useitmv24";
...
char* tab_str[] = 
{
    ...
    "\033[[A",	/* function key 1		*/
    "\033[[B",	/* function key 2		*/
    "\033[[C",	/* function key 3		*/
    "\033[[D",	/* function key 4		*/
    "\033[[E",	/* function key 5		*/
