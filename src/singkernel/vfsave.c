...
/* Project        : vfsave.xml  */
/* Target         : vfsave.c  */
/* Identification : 0.0-1100085316-2982.2981 */
/* ------------------------------------------------------------------------- */
...
#define en_Auto1177   "skin.gif"
#define fr_Auto1177   "skin.gif"
#define en_Auto1087   "Name of Font to Save"
#define fr_Auto1087   "Nom de fichier Fonte … sauver"
#define it_Auto1087   ""
#define es_Auto1087   ""
#define de_Auto1087   ""
#define nl_Auto1087   ""
...
#define en_auto716   "texticon.gif"
#define fr_auto716   "texticon.gif"
static int	vfh[10];
	...
	char * pFileName)
{
	...
	for (i=0; i < 8; i++)_Context->msg_Auto1087[i]=" ";
	_Context->msg_Auto1087[0]=en_Auto1087;
	_Context->msg_Auto1087[1]=fr_Auto1087;
	_Context->msg_Auto1087[2]=it_Auto1087;
	_Context->msg_Auto1087[3]=es_Auto1087;
	_Context->msg_Auto1087[4]=de_Auto1087;
	_Context->msg_Auto1087[5]=nl_Auto1087;
	_Context->msg_Auto1087[6]=pt_Auto1087;
	_Context->msg_Auto1087[7]=xx_Auto1087;
	...
	for (i=0; i < 8; i++)_Context->msg_auto716[i]=" ";
	_Context->msg_auto716[0]=en_auto716;
	_Context->msg_auto716[1]=fr_auto716;
...
public	int	accept_fontsave_show(struct accept_fontsave_context * _Context)
{
	...
	visual_freeze();
	visual_window(_Context->x_auto6,_Context->y_auto6,600,170,vfh[2],_Context->msg_auto6[_Context->language],strlen(_Context->msg_auto6[_Context->language]),0x407);
	visual_image(_Context->x_auto6+3,_Context->y_auto6+22,592,144,_Context->msg_Auto1177[_Context->language],4);
	visual_text(_Context->x_auto6+20,_Context->y_auto6+40,560,16,vfh[2],38,0,_Context->msg_Auto1087[_Context->language],strlen(_Context->msg_Auto1087[_Context->language]),258);
	...
	visual_button(_Context->x_auto6+20,_Context->y_auto6+110,110,30,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),0);
	...
	visual_button(_Context->x_auto6+360,_Context->y_auto6+110,100,30,vfh[2],27,24,_Context->msg_Select[_Context->language],strlen(_Context->msg_Select[_Context->language]),0);
	_Context->trigger_Cancel=visual_trigger_code(_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]));
	visual_button(_Context->x_auto6+470,_Context->y_auto6+110,110,30,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),0);
	visual_image(_Context->x_auto6+240,_Context->y_auto6+100,40,40,_Context->msg_auto716[_Context->language],0);
...
private int on_Accept_event(struct accept_fontsave_context * _Context) {
	return(13);
	return(-1);
}
...
private int on_Cancel_event(struct accept_fontsave_context * _Context) {
	return(27);
	return(-1);
}
...
public	int	accept_fontsave_focus(struct accept_fontsave_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			...
			case	0x3 :
				/* Accept */
				visual_button(_Context->x_auto6+20,_Context->y_auto6+110,110,30,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),2);
				_Context->keycode = visual_getch();
				visual_button(_Context->x_auto6+20,_Context->y_auto6+110,110,30,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),0);
				break;
			case	0x4 :
				/* Select */
				visual_button(_Context->x_auto6+360,_Context->y_auto6+110,100,30,vfh[2],27,24,_Context->msg_Select[_Context->language],strlen(_Context->msg_Select[_Context->language]),2);
				_Context->keycode = visual_getch();
				visual_button(_Context->x_auto6+360,_Context->y_auto6+110,100,30,vfh[2],27,24,_Context->msg_Select[_Context->language],strlen(_Context->msg_Select[_Context->language]),0);
				break;
			case	0x5 :
				/* Cancel */
				visual_button(_Context->x_auto6+470,_Context->y_auto6+110,110,30,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),2);
				_Context->keycode = visual_getch();
				visual_button(_Context->x_auto6+470,_Context->y_auto6+110,110,30,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),0);
				break;
