...
#define	__abal_string_zero		__abal_term[0x0040]	/*0*/

#define	__abal_keyword_raster		__abal_term[0x0041]	/*Raster*/
#define	__abal_keyword_printer		__abal_term[0x0042]	/*Printer*/
#define	__abal_keyword_method		__abal_term[0x0043]	/*Method*/
#define	__abal_keyword_row   		__abal_term[0x0044]	/*Row*/
#define	__abal_keyword_handle		__abal_term[0x0045]	/*Handle*/
#define	__abal_keyword_paper		__abal_term[0x0046]	/*Paper*/
#define	__abal_keyword_margin		__abal_term[0x0047]	/*Margin*/
#define	__abal_keyword_width		__abal_term[0x0048]	/*Width*/
#define	__abal_keyword_height		__abal_term[0x0049]	/*Height*/
#define	__abal_keyword_top		__abal_term[0x004A]	/*Top*/
#define	__abal_keyword_bottom		__abal_term[0x004B]	/*Bottom*/
#define	__abal_keyword_buffer		__abal_term[0x004C]	/*Buffer*/
#define	__abal_keyword_dpi		__abal_term[0x004D]	/*Dpi*/
#define	__abal_keyword_control		__abal_term[0x004E]	/*Control*/
#define	__abal_keyword_options		__abal_term[0x004F]	/*Options*/
#define	__abal_visual_control 		__abal_term[0x0050]	/*VisualControl*/
#define	__abal_overlay_object		__abal_term[0x0051]	/*VisualObject */
