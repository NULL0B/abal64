...
public	void	abal_variable( FILE * h,int	datatype,int	length,int	first, int second );
public	void	abal_ptr( FILE * h,char * 	prefix, char* postfix,int	datatype,int	length,int	first, int second );
public	void	abal_dcl( FILE * h,char * 	prefix, char* postfix,int	datatype,int	length,int	first, int second );
...
public	void	resolve_tool_parameters( int * automatic, char * * sptr );
...
public	int	standard_main_menu_event(struct standard_main_menu_context * _Context);
public	int	standard_main_menu_remove(struct standard_main_menu_context * _Context);
public	int	standard_main_menu_show();
...
/* vcolours.c */
public	int	accept_visual_colour(char * pfgcolour,	char * pbgcolour);
...
/* vfload.c */
public	int	accept_fontload(void*  pFileName,char * pIsAnsi);
...
/* vfsave.c */
public	int	accept_fontsave(void*  pFileName);
...
/* vwebgen.c */
public	int	accept_html_production(char * pFilename,char * pTitle,char * pStyleSheet,char * pNature,char * pGeneration);
...
public 	void	image_write( char * nptr, struct standard_image * iptr, int mode, int transparence );
