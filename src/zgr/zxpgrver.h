...
#define VER_FILEVERSION_STR      "3.2b.0.02\0"
#define VER_FILEVERSION_STRC     "32b002"
...
#define VER_ORIGINALFILENAME_STR     "zgr.xp\0"
#define VER_PRODUCTNAME_STR          "Fonctions Syteme Z-Library pour TwinServer\0"

#elif defined(BDA_UNIX)
#define VER_ORIGINALFILENAME_STR     "zgr.so\0"
#define VER_PRODUCTNAME_STR          "Fonctions Syteme Z-Library pour UseIt\0"

#elif defined(WIN32) || defined(BDA_WIN32)
#define VER_ORIGINALFILENAME_STR     "zgr.dll\0"
#define VER_PRODUCTNAME_STR          "Fonctions Syteme Z-Library pour Windows\0"

#else // Win16
#define VER_ORIGINALFILENAME_STR     "zgr.dll\0"
#define VER_PRODUCTNAME_STR          "Fonctions Syteme Z-Library\0"
#endif

#define VER_INTERNALNAME_STR         "zgr\0"

// --- Commentaires (C) -------------------------------------------
// ----------------------------------------------------------------
#define VER_COMMENT  "French English\0"
