  ...
  while (1) 
    ...
    if (c==256)
      ...
      // les autres evt sont ignorés 
		// FCH01092005 Les 2 lignes suivantes étaient en commentaire
		// pb on déclenche sur un Down, la msgbox est effacée, 
		// mais le Up est récupéré par les éléments de la fenêtre qu'il y avait en dessous
		// si c'est un bouton, ça déclenche son traitement intempestivement
		// En rétablissant le déclenchement sur Up, ça supprime ce problème
