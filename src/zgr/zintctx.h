...
#define CI_OFFSETFONT       64 /* FCH22082005 pour eviter conflit avec sing */
#define CI_MAXFONT          32 + CI_OFFSETFONT
...
#define CI_ZINI_PALETTE_NAME	  "GIGOPALETTE" /* FCH26082005 on prend la palette de GIGO c'est plus simple */

#if defined(BDA_WIN32)
#define CI_FONTPATH_NAME		  "FONTPATH"
#endif
...
#define CI_DEFAULT_RUNTIME_PATH "\0---------------------------------------------------PRLZLIB" //not used 
#define CI_SYSTEMFONT_PATH      "\0---------------------------------------------------PRLFONT" //not used 
#define CI_SYSTEMIMAGE_PATH     "\0---------------------------------------------------PRLIMG"  //not used 
