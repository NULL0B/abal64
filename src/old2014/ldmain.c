...
#ifdef old64
	printf("\n   Abal Object Linker : Version 5.1a.0.01 ");
	printf(" -16/32/64");
	printf("\n   Provisoire du 24/04/2021 ");
	printf("\n   Copyright (c) 2021 Amenesik / Sologic \n");
#else
	printf("\n   Abal Object Linker : Version 3.2b.1.03 ");
	printf(" -16/32");
	printf("\n   Provisoire du 26/05/2008 ");
	printf("\n   Copyright (c) 2003,2008 Amenesik / Sologic \n");
#endif
	printf("\n");
