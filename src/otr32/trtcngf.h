...
/*	--------------			*/
#ifdef	ABALSQL
#define		_NGF_SELECT		0x002A
#define		_NGF_PREPARE		0x002B
#define		_NGF_FETCH		0x002C
#define		_NGF_EXEC		0x002D
#define		_NGF_KEYTYPE		0x002E
#define		_NGF_LINKNAME		0x002F
#define		_NGF_FILEUSER		0x0030
#endif
