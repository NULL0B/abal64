...
#ifdef	ABAL32A
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','2','a','0','0','1',1 };
#else
#ifdef	otr32
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','1','d','0','0','7',1 };
#else
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','1','d','0','0','7',1 };
#endif
#endif
...
WORD is_target_file_busy(BPTR FileName)
{      
#ifdef PROLOGUE
...
#endif
*/
	if ((aptr = (BPTR) getenv("ALLOCPADD")) != (BPTR) 0) {
