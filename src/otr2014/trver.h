...
// ---------------------------------------------------------------------------
#ifdef ABAL32B
#define VER_FILEVERSION_STR      "otr 3.2b.1.01\0"
#define VER_FILEVERSION_STRC     "32b101"
#else

#ifdef ABAL33A // En fait 3.2a diffusion
#define VER_FILEVERSION_STR      "otr 3.2a.1.02\0"
#define VER_FILEVERSION_STRC     "32a102"
#else
#define VER_FILEVERSION_STR      "otr 3.1e.0.13\0"
#define VER_FILEVERSION_STRC     "31e013"
#endif
...
// ----------------------------------------------------------------
	...
	#if defined (_DEBUG)
		#ifdef otr32
			#define VER_BUILD_STR		"DT328    \0"	
		#else
			#define VER_BUILD_STR		"DT168    \0"	
		#endif
	#else
		#ifdef otr32
			#define VER_BUILD_STR		"RT328    \0"	
		#else
			#define VER_BUILD_STR		"RT168    \0"	
		#endif
	#endif
	...
	#if defined (_DEBUG)
		#ifdef otr32
			#define VER_BUILD_STR		"D328    \0"	
		#else
			#define VER_BUILD_STR		"D168    \0"	
		#endif
	#else
		#ifdef otr32
			#define VER_BUILD_STR		"R328    \0"	
		#else
			#define VER_BUILD_STR		"R168    \0"	
		#endif
	#endif
