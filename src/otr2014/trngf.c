...
WORD	integer_option(WORD value)
{
	if ( is_comma() )
		return( store_parameter(evaluate_expression(0)) );
	else 	return( store_parameter(integer_result(value)) );
}

WORD	string_option(BPTR value)
{
	if ( is_comma() )
		return( store_parameter(evaluate_expression(0)) );
	else 	return( store_parameter(string_result(value)) );
}
