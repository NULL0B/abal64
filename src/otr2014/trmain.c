...
#else
#ifdef	ABALV41
#define	MODULE_PROVISOIRE  "\n   Provisoire du 02/01/2012 "
#define	MODULE_COPYRIGHT   "\n   Copyright (c) 1989,2012 Amenesik / Sologic "
#ifdef	otr32
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'4','1','a','0','0','1',1 };
#else
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'4','1','a','0','0','1',1 };
#endif
...
#ifdef	ABAL32B
#ifdef	otr32
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','2','b','1','0','5',1 };
#else
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','2','b','1','0','5',1 };
#endif
...
#ifdef	ABAL33A
#ifdef	otr32
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','2','b','0','0','8',1 };
#else
...
#ifdef	ABAL32A
#ifdef	otr32
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','2','a','0','1','8',1 };
#else
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','2','a','0','1','8',1 };
#endif
...
#ifdef	otr32
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','1','e','0','1','8',1 };
#else
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','1','e','0','1','8',1 };
#endif
