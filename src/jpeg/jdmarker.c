...
/*
 * IJM : Modification to step over about a sector of rubbish
 * looking for the SOI marker. I think this is a good compromise
 * between the above recomendation and the real-world requirement
 */

{
  ...
  for (	ijmc=0; ijmc < 128; ijmc++) { /* 128 times 2 bytes looking for SOI */
	  INPUT_BYTE(cinfo, c, return FALSE);
