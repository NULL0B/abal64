...
#define CI_TRA_ININAME_WORKING_DIR   "/home/abal64/abaltrace.ini"
...
#elif defined(__linux__) || defined(UNIX)
#define CI_TRA_NAME                  "/tmp/abaltrace.txt"
#define CI_TRA_ININAME_DEFAULT_DIR   "/home/abal64/abaltrace.ini"
...
if (pCtx->FilterLevel & CI_TRA_F_PRG) 
   {
   pCtx->p   += sprintf(pCtx->p, pCtx->pri_Prg);
