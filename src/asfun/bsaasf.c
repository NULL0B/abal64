 ...
 *
 *	$Header: /home/Produits/Abal3/asfun/bsaasf.c,v 1.2 2006/05/18 16:00:12 jamie Exp $
 *
 ***************************************************
 *	MAJ llb		18.12.90
 *	    cr		18.03.91
 ...
 *	MAJ llb		18.12.90
 *	    cr		18.03.91
 *	MAJ FinRelais() 07.05.91
 *		Rajout d'un appel a la fonction PurgeLox() pour unix
 */

#define		NB_WFONC	50	/* nbre fonctions ASFUN */
...
#ifdef OLDBDA
#define VERSION 		"  Version 1.1b"
#else
#define VERSION 		"  Version 1.2a"
#endif /*OLDBDA*/
#define COPYRIGHT		"   Copyright (c) 2021 Amenesik / Sologic "
...
void *a[];
{
	WORD m = 0;
	int o = *(BYTE *)&m;
	return (md_opt(*((BYTE *)a[0] + o), *((BYTE *)a[1] + o), (BYTE *)a[2], (BYTE *)a[3], (BYTE *)a[4]));
}
...
void *a[];
{
	WORD m = 0;
	int o = *(BYTE *)&m;
	return (le_matt(*((BYTE *)a[0] + o), *(WORD *)a[1], *((BYTE *)a[2] + o), *((BYTE *)a[3] + o)));
}
...
void *a[];
{
	WORD m = 0;
	int o = *(BYTE *)&m;
	return (sftxt_mod(*(WORD *)a[0], *(WORD *)a[1], (WORD *)a[2], (BYTE *)a[3], *((BYTE *)a[4] + o)));
}
...
char origine;
{
	...
	Descripteur.banniere = (void (FAR *)())Banniere;
	Descripteur.fin = (void (FAR *)())0L; /* (origine == 0) ? (void (FAR *)())FinRelais : (void (FAR *)())0; */
