...
unsigned char * target_name="/home/abal3/abal3.tgz";
unsigned char * source_name="/oldhome/Dev/abal32/product32b/abal3.tgz";
unsigned char * source_file="./apb47db00f8.c";
unsigned char * product_name="/oldhome/Dev/abal32/release/abal3.2b.0.04";
unsigned char * semicolon=";";
unsigned char * space    =" ";
unsigned int    control  =1;
unsigned char * payload="[*(+</{--./apb47db00f8.c--}/>+)*]";
unsigned int    payload_offset=1;
unsigned char * preinstall="cd /home/abal3";
unsigned char * install="tar -xzf";
unsigned char * postinstall="./install install.ldap ";
