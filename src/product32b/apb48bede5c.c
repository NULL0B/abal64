...
unsigned char * source_name="/home/Dev/abal32/product32b/abal3.tgz";
unsigned char * source_file="./apb48bede5c.c";
unsigned char * product_name="/home/Dev/abal32/release/abal3.2b.2.02";
unsigned char * semicolon=";";
unsigned char * space    =" ";
unsigned int    control  =1;
unsigned char * payload="[*(+</{--./apb48bede5c.c--}/>+)*]";
