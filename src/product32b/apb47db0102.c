...
unsigned char * source_name="/oldhome/Dev/abal32/product32b/abal16criteria.tgz";
unsigned char * source_file="./apb47db0102.c";
unsigned char * product_name="/oldhome/Dev/abal32/release/abal3.2b.0.04.abal16criteria";
unsigned char * semicolon=";";
unsigned char * space    =" ";
unsigned int    control  =1;
unsigned char * payload="[*(+</{--./apb47db0102.c--}/>+)*]";
