...
unsigned char * source_name="/home/Dev/abal32/product32b/abal2.tgz";
unsigned char * source_file="./apb47e8ecb1.c";
unsigned char * product_name="/home/Dev/abal32/release/abal3.2b.0.04.abal2";
unsigned char * semicolon=";";
unsigned char * space    =" ";
unsigned int    control  =1;
unsigned char * payload="[*(+</{--./apb47e8ecb1.c--}/>+)*]";
