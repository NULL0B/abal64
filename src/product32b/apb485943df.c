...
unsigned char * source_name="/home/Dev/abal32/product32b/abal3rt.tgz";
unsigned char * source_file="./apb485943df.c";
unsigned char * product_name="/home/Dev/abal32/release/abal3.2b.1.03.rt";
unsigned char * semicolon=";";
unsigned char * space    =" ";
unsigned int    control  =1;
unsigned char * payload="[*(+</{--./apb485943df.c--}/>+)*]";
