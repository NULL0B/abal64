...
#ifdef	otr64
#define	_TOOL_VERSION		"otr64"
#define	_TOOL_UPPER  		"OTR64"
#else
#ifdef	otr32
#define	_TOOL_VERSION		"otr32"
#define	_TOOL_UPPER  		"OTR32"
#else
#define	_TOOL_VERSION 		"otr16"
#define	_TOOL_UPPER  		"OTR16"
#endif
#endif
...
#ifdef	otr64
#define	TOGLOBAL4	0xFFFFFFFFFFFFFFFE
#else
#ifdef	otr32
...
struct	tcode_control_table {
...
#ifdef ABAL33A
	WORD		sector_LMT;	/* Sector Library Modules Table    */
	WORD		length_LMT;	/* Length of Library Modules Table    */
#endif

	WORD		sector_PXT;	/* Sector of Procedure Export Records */
	WORD		length_PXT;	/* Length of Procedure Export Records */
	...
	WORD		ExpliciteExtern;/* Explicite Extern Statements	*/
	WORD		VerifyStrict;	/* Requires Tolerance of BCD/INTEGER mix */
	WORD		IsExport;	/* Exportable Procedure Description	*/
	WORD		ExpliciteExport;/* Explicite Export Statements	*/
	};
