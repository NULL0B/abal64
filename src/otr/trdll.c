...
{ 
	...
	desrt.fonction[0] = (WORD (FAR PTR)()) dll_translator_initialisation;
	desrt.fonction[1] = (VOID  (FAR PTR)()) dll_translator_termination;
	desrt.fonction[2] = (WORD (FAR PTR)()) dll_translate_line;
	desrt.fonction[3] = (WORD (FAR PTR)()) dll_translator_options;
	desrt.fonction[4] = (WORD (FAR PTR)()) dll_translate_file;
	desrt.fonction[5] = (WORD (FAR PTR)()) dll_translate_block;
...
/*	-----------------------------	*/
/*	dll_translator_initialisation	*/
/*	-----------------------------	*/
WORD FAR  dll_translator_initialisation(a)
BYTE FAR PTR a[];
{
...
/*	----------------------------	*/
/*	 dll_translator_termination 	*/
/*	----------------------------	*/
WORD FAR dll_translator_termination()
{
...
i
/*	----------------------	*/
/*	dll_translator_options	*/
/*	----------------------	*/
WORD FAR dll_translator_options( a )
BYTE FAR PTR a[];
{
...
/*	dll_translate_block	*/
/*	-------------------	*/
WORD FAR dll_translate_block(a)
BYTE FAR PTR a[];
{
