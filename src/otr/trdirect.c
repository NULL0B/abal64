...
static	WORD	translate_enhanced()
{
	do	
	{
		...
		else if ( is_mnemonic("ERRORS") ) 
		{
			OtrOption.ErrorCatcher = translate_on_off(VRAI);
			printf("enhanced errors = %u \n",OtrOption.ErrorCatcher);
		}
