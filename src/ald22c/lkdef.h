...
/*	-------------------------------------		*/
	...
	/* il y a un gros con, meme des gros cons, qq part qui doit avoir les oreilles qui ressonnes ! */
	/* ------------------------------------------------------------------------------------------- */
...
#define Xstrcmpi(s,p) (PRECOND( s != 0), PRECOND( p != 0 ), strcmpi((char *) s,(char *) p))
