...
#include <stdio.h>
#include "visual.h"
#define en_Auto2794   "Sing : Version 2.1a"
#define fr_Auto2794   "Sing : Version 2.1a"
#define it_Auto2794   "Sing : Version 2.1a"
#define es_Auto2794   "Sing : Version 2.1a"
#define de_Auto2794   "Sing : Version 2.1a"
#define nl_Auto2794   "Sing : Version 2.1a"
#define pt_Auto2794   "Sing : Version 2.1a"
#define xx_Auto2794   "Sing : Version 2.1a"
#define en__Auto2794   ""
#define fr__Auto2794   ""
#define it__Auto2794   ""
#define es__Auto2794   ""
...
#define pt__Auto2794   ""
#define xx__Auto2794   ""
#define en_Auto2796   "National Language Translation Options"
#define fr_Auto2796   "Options de Traduction Langues Nationaux"
#define it_Auto2796   "National Language Translation Options"
#define es_Auto2796   "National Language Translation Options"
#define de_Auto2796   "National Language Translation Options"
#define nl_Auto2796   "National Language Translation Options"
#define pt_Auto2796   "National Language Translation Options"
#define xx_Auto2796   "National Language Translation Options"
#define en__Auto2796   ""
#define fr__Auto2796   ""
#define it__Auto2796   ""
#define es__Auto2796   ""
...
#define pt__Auto2796   ""
#define xx__Auto2796   ""
#define en_Auto2797   "Reference Language for Translation"
#define fr_Auto2797   "Langue de r‚f‚rence pour Traduction"
#define it_Auto2797   "Reference Language for Translation"
#define es_Auto2797   "Reference Language for Translation"
#define de_Auto2797   "Reference Language for Translation"
#define nl_Auto2797   "Reference Language for Translation"
#define pt_Auto2797   "Reference Language for Translation"
#define xx_Auto2797   "Reference Language for Translation"
#define en__Auto2797   ""
#define fr__Auto2797   ""
#define it__Auto2797   ""
#define es__Auto2797   ""
	...
	char * pDebugTrad)
{
	...
	_Context->x_Auto2794=180;
	_Context->y_Auto2794=190;
	_Context->w_Auto2794=440;
	_Context->h_Auto2794=220;
	...
	_Context->pushbuffer=visual_buffer(_Context->x_Auto2794,_Context->y_Auto2794,440+10,220+10);
	return(0);
}
...
public 	int	national_translation_options_hide(struct national_translation_options_context * _Context)
{
	...
	&& (_Context->ctrlbuffer != 0)) {
		(void)visual_buffer_put(_Context->pushbuffer,_Context->x_Auto2794,_Context->y_Auto2794);
		_Context->ctrlbuffer=0;
		}
...
public	int	national_translation_options_show(struct national_translation_options_context * _Context)
{
	...
	if ((_Context->pushbuffer != (void *) 0)
	&& (!(_Context->ctrlbuffer))) {
		(void)visual_buffer_get(_Context->pushbuffer,_Context->x_Auto2794,_Context->y_Auto2794);
		_Context->ctrlbuffer=1;
		}
	visual_freeze();
	visual_window(_Context->x_Auto2794,_Context->y_Auto2794,440,220,vfh[2],_Context->msg_Auto2794[_Context->language],strlen(_Context->msg_Auto2794[_Context->language]),0x407);
	visual_frame(_Context->x_Auto2794+10,_Context->y_Auto2794+30,420,180,4);
	visual_text(_Context->x_Auto2794+20,_Context->y_Auto2794+50,400,20,vfh[3],16,0,_Context->msg_Auto2796[_Context->language],strlen(_Context->msg_Auto2796[_Context->language]),1283);
	visual_text(_Context->x_Auto2794+20,_Context->y_Auto2794+90,252,16,vfh[2],16,0,_Context->msg_Auto2797[_Context->language],strlen(_Context->msg_Auto2797[_Context->language]),2);
	visual_select(_Context->x_Auto2794+280,_Context->y_Auto2794+90,140,112,vfh[2],27,0,parse_selection(NationalLanguageList,&_Context->value_NationalLanguage),768);
	...
	visual_check(_Context->x_Auto2794+120,_Context->y_Auto2794+130,224,16,vfh[2],16,28,_Context->msg_Retranslate[_Context->language],strlen(_Context->msg_Retranslate[_Context->language]),_Context->value_Retranslate|0);
	...
	visual_check(_Context->x_Auto2794+120,_Context->y_Auto2794+150,224,16,vfh[2],16,28,_Context->msg_IgnoreImages[_Context->language],strlen(_Context->msg_IgnoreImages[_Context->language]),_Context->value_IgnoreImages|0);
	...
	visual_check(_Context->x_Auto2794+120,_Context->y_Auto2794+170,224,16,vfh[2],16,28,_Context->msg_DebugTrad[_Context->language],strlen(_Context->msg_DebugTrad[_Context->language]),_Context->value_DebugTrad|0);
	_Context->trigger_Accept=visual_trigger_code(_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]));
	visual_button(_Context->x_Auto2794+20,_Context->y_Auto2794+150,56,48,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),1040);
	_Context->trigger_Cancel=visual_trigger_code(_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]));
	visual_button(_Context->x_Auto2794+360,_Context->y_Auto2794+150,56,48,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),1040);
	visual_thaw(_Context->x_Auto2794,_Context->y_Auto2794,440,220);

	return(0);
}

private int Auto2794action(struct national_translation_options_context * _Context) {
	...
	do {
		...
		_Context->x_Auto2794 += (visual_event(7)-x);
		x=visual_event(7);
		if (_Context->x_Auto2794 < 0) { _Context->x_Auto2794=0; }
		_Context->y_Auto2794 += (visual_event(6)-y);
		y=visual_event(6);
		if (_Context->y_Auto2794 < 0) { _Context->y_Auto2794=0; }
...
struct national_translation_options_context * _Context){
	...
	switch (mt) {
	case _MIMO_UP :
	if ((mx >= (_Context->x_Auto2794+419) )  
	&&  (my >= (_Context->y_Auto2794+4) )  
	&&  (mx <= (_Context->x_Auto2794+436) )  
	&&  (my <= (_Context->y_Auto2794+20) )) {
		return(1);	/* Auto2794 */

		}
	if ((mx >= (_Context->x_Auto2794+403) )  
	&&  (my >= (_Context->y_Auto2794+4) )  
	&&  (mx <= (_Context->x_Auto2794+420) )  
	&&  (my <= (_Context->y_Auto2794+20) )) {
	...
	if ((mx >= (_Context->x_Auto2794+387) )  
	&&  (my >= (_Context->y_Auto2794+4) )  
	&&  (mx <= (_Context->x_Auto2794+404) )  
	&&  (my <= (_Context->y_Auto2794+20) )) {
	...
	case _MIMO_DOWN :
		if ((mx >= (_Context->x_Auto2794+4) )  
		&&  (my >= (_Context->y_Auto2794+4) )  
		&&  (mx <= (_Context->x_Auto2794+372) )  
		&&  (my <= (_Context->y_Auto2794+20) )) {
			return( Auto2794action(_Context) );
			}
		}
	if (( mx >= (_Context->x_Auto2794+280+0) ) 
	&&  ( my >= (_Context->y_Auto2794+90) ) 
	&&  ( mx <= (_Context->x_Auto2794+280+140) ) 
	&&  ( my <= (_Context->y_Auto2794+90+16))) {
		return(2); /* NationalLanguage */
		}
	if (( mx >= (_Context->x_Auto2794+120) ) 
	&&  ( my >= (_Context->y_Auto2794+130) ) 
	&&  ( mx <= (_Context->x_Auto2794+120+224) ) 
	&&  ( my <= (_Context->y_Auto2794+130+16))) {
		return(3); /* Retranslate */
		}
	if (( mx >= (_Context->x_Auto2794+120) ) 
	&&  ( my >= (_Context->y_Auto2794+150) ) 
	&&  ( mx <= (_Context->x_Auto2794+120+224) ) 
	&&  ( my <= (_Context->y_Auto2794+150+16))) {
		return(4); /* IgnoreImages */
		}
	if (( mx >= (_Context->x_Auto2794+120) ) 
	&&  ( my >= (_Context->y_Auto2794+170) ) 
	&&  ( mx <= (_Context->x_Auto2794+120+224) ) 
	&&  ( my <= (_Context->y_Auto2794+170+16))) {
		return(5); /* DebugTrad */
		}
	if (( mx >= (_Context->x_Auto2794+20) ) 
	&&  ( my >= (_Context->y_Auto2794+150) ) 
	&&  ( mx <= (_Context->x_Auto2794+20+56) ) 
	&&  ( my <= (_Context->y_Auto2794+150+48))) {
		return(6); /* Accept */
		}
	if (( mx >= (_Context->x_Auto2794+360) ) 
	&&  ( my >= (_Context->y_Auto2794+150) ) 
	&&  ( mx <= (_Context->x_Auto2794+360+56) ) 
	&&  ( my <= (_Context->y_Auto2794+150+48))) {
		return(7); /* Cancel */
		}
...
public	int	national_translation_options_focus(struct national_translation_options_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			case	0x2 :
				/* NationalLanguage */
				_Context->keycode = visual_select(_Context->x_Auto2794+280,_Context->y_Auto2794+90,140,112,vfh[2],27,0,parse_selection(NationalLanguageList,&_Context->value_NationalLanguage),770);
				break;
			case	0x3 :
				/* Retranslate */
				visual_check(_Context->x_Auto2794+120,_Context->y_Auto2794+130,224,16,vfh[2],16,28,_Context->msg_Retranslate[_Context->language],strlen(_Context->msg_Retranslate[_Context->language]),(_Context->value_Retranslate |2));
	...
	visual_check(_Context->x_Auto2794+120,_Context->y_Auto2794+130,224,16,vfh[2],16,28,_Context->msg_Retranslate[_Context->language],strlen(_Context->msg_Retranslate[_Context->language]),_Context->value_Retranslate|0);
			...
			case	0x4 :
				/* IgnoreImages */
				visual_check(_Context->x_Auto2794+120,_Context->y_Auto2794+150,224,16,vfh[2],16,28,_Context->msg_IgnoreImages[_Context->language],strlen(_Context->msg_IgnoreImages[_Context->language]),(_Context->value_IgnoreImages |2));
				_Context->keycode = visual_getch();
				_Context->trigger_IgnoreImages=visual_trigger_code(_Context->msg_IgnoreImages[_Context->language],strlen(_Context->msg_IgnoreImages[_Context->language]));
	visual_check(_Context->x_Auto2794+120,_Context->y_Auto2794+150,224,16,vfh[2],16,28,_Context->msg_IgnoreImages[_Context->language],strlen(_Context->msg_IgnoreImages[_Context->language]),_Context->value_IgnoreImages|0);
				break;
			case	0x5 :
				/* DebugTrad */
				visual_check(_Context->x_Auto2794+120,_Context->y_Auto2794+170,224,16,vfh[2],16,28,_Context->msg_DebugTrad[_Context->language],strlen(_Context->msg_DebugTrad[_Context->language]),(_Context->value_DebugTrad |2));
				_Context->keycode = visual_getch();
				_Context->trigger_DebugTrad=visual_trigger_code(_Context->msg_DebugTrad[_Context->language],strlen(_Context->msg_DebugTrad[_Context->language]));
	visual_check(_Context->x_Auto2794+120,_Context->y_Auto2794+170,224,16,vfh[2],16,28,_Context->msg_DebugTrad[_Context->language],strlen(_Context->msg_DebugTrad[_Context->language]),_Context->value_DebugTrad|0);
				break;
...
retry:
			...
			switch ((_Context->focus_item = retcode)) {
				...
				case	0x6 :
					...
					if (visual_event(1) & _MIMO_DOWN) {
						_Context->trigger_Accept=visual_trigger_code(_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]));
						visual_button(_Context->x_Auto2794+20,_Context->y_Auto2794+150,56,48,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),1042);
						}
	...
	visual_button(_Context->x_Auto2794+20,_Context->y_Auto2794+150,56,48,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),1040);
				...
				case	0x7 :
					...
					if (visual_event(1) & _MIMO_DOWN) {
						_Context->trigger_Cancel=visual_trigger_code(_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]));
						visual_button(_Context->x_Auto2794+360,_Context->y_Auto2794+150,56,48,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),1042);
						}
					else if (visual_event(1) & _MIMO_UP) {
						_Context->trigger_Cancel=visual_trigger_code(_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]));
	visual_button(_Context->x_Auto2794+360,_Context->y_Auto2794+150,56,48,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),1040);
