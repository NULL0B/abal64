...
#include <stdio.h>
#include "visual.h"
#define en_Auto2796   "Sing : Version 1.0a"
#define en__Auto2796   ""
...
#define en__Cancel   ""
#define en_Auto2797   "Recalculate current palette and save to filename"
#define fr_Auto2797   "Recalculate current palette and save to filename"
#define it_Auto2797   "Recalculate current palette and save to filename"
#define es_Auto2797   "Recalculate current palette and save to filename"
#define de_Auto2797   "Recalculate current palette and save to filename"
#define nl_Auto2797   "Recalculate current palette and save to filename"
#define pt_Auto2797   "Recalculate current palette and save to filename"
#define xx_Auto2797   "Recalculate current palette and save to filename"
#define en__Auto2797   ""
#define fr__Auto2797   ""
#define it__Auto2797   ""
#define es__Auto2797   ""
	...
	char * pOtherColours)
{
	...
	_Context->x_Auto2796=115;
	_Context->y_Auto2796=200;
	_Context->w_Auto2796=570;
	_Context->h_Auto2796=200;
	...
	_Context->pushbuffer=visual_buffer(_Context->x_Auto2796,_Context->y_Auto2796,570+10,200+10);
	return(0);
}
...
public 	int	accept_palette_name_hide(struct accept_palette_name_context * _Context)
{
	...
	&& (_Context->ctrlbuffer != 0)) {
		(void)visual_buffer_put(_Context->pushbuffer,_Context->x_Auto2796,_Context->y_Auto2796);
		_Context->ctrlbuffer=0;
		}
...
public	int	accept_palette_name_show(struct accept_palette_name_context * _Context)
{
	...
	if ((_Context->pushbuffer != (void *) 0)
	&& (!(_Context->ctrlbuffer))) {
		(void)visual_buffer_get(_Context->pushbuffer,_Context->x_Auto2796,_Context->y_Auto2796);
		_Context->ctrlbuffer=1;
		}
	visual_freeze();
	visual_window(_Context->x_Auto2796,_Context->y_Auto2796,570,200,vfh[2],_Context->msg_Auto2796[_Context->language],strlen(_Context->msg_Auto2796[_Context->language]),0x407);
	_Context->trigger_Accept=visual_trigger_code(_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]));
	visual_button(_Context->x_Auto2796+20,_Context->y_Auto2796+130,56,48,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),1040);
	_Context->trigger_Cancel=visual_trigger_code(_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]));
	visual_button(_Context->x_Auto2796+490,_Context->y_Auto2796+130,56,48,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),1040);
	visual_text(_Context->x_Auto2796+20,_Context->y_Auto2796+60,490,16,vfh[2],16,0,_Context->msg_Auto2797[_Context->language],strlen(_Context->msg_Auto2797[_Context->language]),258);
	visual_frame(_Context->x_Auto2796+20,_Context->y_Auto2796+80,496+2,16+2,5);
	visual_text(_Context->x_Auto2796+20+1,_Context->y_Auto2796+80+1,496,16,vfh[1],16,0,_Context->buffer_PaletteName,62,0);
	...
	visual_check(_Context->x_Auto2796+120,_Context->y_Auto2796+120,336,16,vfh[2],16,28,_Context->msg_PaintColours[_Context->language],strlen(_Context->msg_PaintColours[_Context->language]),_Context->value_PaintColours|0);
	...
	visual_check(_Context->x_Auto2796+120,_Context->y_Auto2796+140,336,16,vfh[2],16,28,_Context->msg_IhmColours[_Context->language],strlen(_Context->msg_IhmColours[_Context->language]),_Context->value_IhmColours|0);
	...
	visual_check(_Context->x_Auto2796+120,_Context->y_Auto2796+160,336,16,vfh[2],16,28,_Context->msg_OtherColours[_Context->language],strlen(_Context->msg_OtherColours[_Context->language]),_Context->value_OtherColours|0);
	...
	visual_button(_Context->x_Auto2796+520,_Context->y_Auto2796+80,20,16,vfh[8],27,28,_Context->msg_Choixfconf[_Context->language],strlen(_Context->msg_Choixfconf[_Context->language]),0);
	visual_thaw(_Context->x_Auto2796,_Context->y_Auto2796,570,200);

	return(0);
}

private int Auto2796action(struct accept_palette_name_context * _Context) {
	...
	do {
		...
		_Context->x_Auto2796 += (visual_event(7)-x);
		x=visual_event(7);
		if (_Context->x_Auto2796 < 0) { _Context->x_Auto2796=0; }
		_Context->y_Auto2796 += (visual_event(6)-y);
		y=visual_event(6);
		if (_Context->y_Auto2796 < 0) { _Context->y_Auto2796=0; }
...
struct accept_palette_name_context * _Context){
	...
	switch (mt) {
	case _MIMO_UP :
	if ((mx >= (_Context->x_Auto2796+549) )  
	&&  (my >= (_Context->y_Auto2796+4) )  
	&&  (mx <= (_Context->x_Auto2796+566) )  
	&&  (my <= (_Context->y_Auto2796+20) )) {
		return(1);	/* Auto2796 */

		}
	if ((mx >= (_Context->x_Auto2796+533) )  
	&&  (my >= (_Context->y_Auto2796+4) )  
	&&  (mx <= (_Context->x_Auto2796+550) )  
	&&  (my <= (_Context->y_Auto2796+20) )) {
	...
	if ((mx >= (_Context->x_Auto2796+517) )  
	&&  (my >= (_Context->y_Auto2796+4) )  
	&&  (mx <= (_Context->x_Auto2796+534) )  
	&&  (my <= (_Context->y_Auto2796+20) )) {
	...
	case _MIMO_DOWN :
		if ((mx >= (_Context->x_Auto2796+4) )  
		&&  (my >= (_Context->y_Auto2796+4) )  
		&&  (mx <= (_Context->x_Auto2796+502) )  
		&&  (my <= (_Context->y_Auto2796+20) )) {
			return( Auto2796action(_Context) );
			}
		}
	if (( mx >= (_Context->x_Auto2796+20) ) 
	&&  ( my >= (_Context->y_Auto2796+130) ) 
	&&  ( mx <= (_Context->x_Auto2796+20+56) ) 
	&&  ( my <= (_Context->y_Auto2796+130+48))) {
		return(2); /* Accept */
		}
	if (( mx >= (_Context->x_Auto2796+490) ) 
	&&  ( my >= (_Context->y_Auto2796+130) ) 
	&&  ( mx <= (_Context->x_Auto2796+490+56) ) 
	&&  ( my <= (_Context->y_Auto2796+130+48))) {
		return(3); /* Cancel */
		}
	if (( mx >= (_Context->x_Auto2796+20) ) 
	&&  ( my >= (_Context->y_Auto2796+80) ) 
	&&  ( mx <= (_Context->x_Auto2796+20+496) ) 
	&&  ( my <= (_Context->y_Auto2796+80+16))) {
		return(4); /* PaletteName */
		}
	if (( mx >= (_Context->x_Auto2796+120) ) 
	&&  ( my >= (_Context->y_Auto2796+120) ) 
	&&  ( mx <= (_Context->x_Auto2796+120+336) ) 
	&&  ( my <= (_Context->y_Auto2796+120+16))) {
		return(5); /* PaintColours */
		}
	if (( mx >= (_Context->x_Auto2796+120) ) 
	&&  ( my >= (_Context->y_Auto2796+140) ) 
	&&  ( mx <= (_Context->x_Auto2796+120+336) ) 
	&&  ( my <= (_Context->y_Auto2796+140+16))) {
		return(6); /* IhmColours */
		}
	if (( mx >= (_Context->x_Auto2796+120) ) 
	&&  ( my >= (_Context->y_Auto2796+160) ) 
	&&  ( mx <= (_Context->x_Auto2796+120+336) ) 
	&&  ( my <= (_Context->y_Auto2796+160+16))) {
		return(7); /* OtherColours */
		}
	if (( mx >= (_Context->x_Auto2796+520) ) 
	&&  ( my >= (_Context->y_Auto2796+80) ) 
	&&  ( mx <= (_Context->x_Auto2796+520+20) ) 
	&&  ( my <= (_Context->y_Auto2796+80+16))) {
		return(8); /* Choixfconf */
		}
...
public	int	accept_palette_name_focus(struct accept_palette_name_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			case	0x4 :
				/* PaletteName */
				_Context->keycode = visual_edit(_Context->x_Auto2796+20+1,_Context->y_Auto2796+80+1,496,16,vfh[1],_Context->buffer_PaletteName,62);
			break;
			case	0x5 :
				/* PaintColours */
				visual_check(_Context->x_Auto2796+120,_Context->y_Auto2796+120,336,16,vfh[2],16,28,_Context->msg_PaintColours[_Context->language],strlen(_Context->msg_PaintColours[_Context->language]),(_Context->value_PaintColours |2));
	...
	visual_check(_Context->x_Auto2796+120,_Context->y_Auto2796+120,336,16,vfh[2],16,28,_Context->msg_PaintColours[_Context->language],strlen(_Context->msg_PaintColours[_Context->language]),_Context->value_PaintColours|0);
			...
			case	0x6 :
				/* IhmColours */
				visual_check(_Context->x_Auto2796+120,_Context->y_Auto2796+140,336,16,vfh[2],16,28,_Context->msg_IhmColours[_Context->language],strlen(_Context->msg_IhmColours[_Context->language]),(_Context->value_IhmColours |2));
				_Context->keycode = visual_getch();
				_Context->trigger_IhmColours=visual_trigger_code(_Context->msg_IhmColours[_Context->language],strlen(_Context->msg_IhmColours[_Context->language]));
	visual_check(_Context->x_Auto2796+120,_Context->y_Auto2796+140,336,16,vfh[2],16,28,_Context->msg_IhmColours[_Context->language],strlen(_Context->msg_IhmColours[_Context->language]),_Context->value_IhmColours|0);
				break;
			case	0x7 :
				/* OtherColours */
				visual_check(_Context->x_Auto2796+120,_Context->y_Auto2796+160,336,16,vfh[2],16,28,_Context->msg_OtherColours[_Context->language],strlen(_Context->msg_OtherColours[_Context->language]),(_Context->value_OtherColours |2));
				_Context->keycode = visual_getch();
				_Context->trigger_OtherColours=visual_trigger_code(_Context->msg_OtherColours[_Context->language],strlen(_Context->msg_OtherColours[_Context->language]));
	visual_check(_Context->x_Auto2796+120,_Context->y_Auto2796+160,336,16,vfh[2],16,28,_Context->msg_OtherColours[_Context->language],strlen(_Context->msg_OtherColours[_Context->language]),_Context->value_OtherColours|0);
				break;
...
retry:
			...
			switch ((_Context->focus_item = retcode)) {
				...
				case	0x2 :
					...
					if (visual_event(1) & _MIMO_DOWN) {
						_Context->trigger_Accept=visual_trigger_code(_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]));
						visual_button(_Context->x_Auto2796+20,_Context->y_Auto2796+130,56,48,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),1042);
						}
	...
	visual_button(_Context->x_Auto2796+20,_Context->y_Auto2796+130,56,48,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),1040);
				...
				case	0x3 :
					...
					if (visual_event(1) & _MIMO_DOWN) {
						_Context->trigger_Cancel=visual_trigger_code(_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]));
						visual_button(_Context->x_Auto2796+490,_Context->y_Auto2796+130,56,48,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),1042);
						}
					else if (visual_event(1) & _MIMO_UP) {
						_Context->trigger_Cancel=visual_trigger_code(_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]));
	visual_button(_Context->x_Auto2796+490,_Context->y_Auto2796+130,56,48,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),1040);
				...
				case	0x8 :
					...
					if (visual_event(1) & _MIMO_DOWN) {
						_Context->trigger_Choixfconf=visual_trigger_code(_Context->msg_Choixfconf[_Context->language],strlen(_Context->msg_Choixfconf[_Context->language]));
						visual_button(_Context->x_Auto2796+520,_Context->y_Auto2796+80,20,16,vfh[8],27,28,_Context->msg_Choixfconf[_Context->language],strlen(_Context->msg_Choixfconf[_Context->language]),2);
						}
					else if (visual_event(1) & _MIMO_UP) {
						_Context->trigger_Choixfconf=visual_trigger_code(_Context->msg_Choixfconf[_Context->language],strlen(_Context->msg_Choixfconf[_Context->language]));
	visual_button(_Context->x_Auto2796+520,_Context->y_Auto2796+80,20,16,vfh[8],27,28,_Context->msg_Choixfconf[_Context->language],strlen(_Context->msg_Choixfconf[_Context->language]),0);
