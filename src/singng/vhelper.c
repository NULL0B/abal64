...
/* Project        : vhelper.xml                                              */
/* Target         : vhelper.c                                                */
/* Identification : 0.0-1188333195-4215.4214                                 */
/* ------------------------------------------------------------------------- */
...
#define pt__Auto2901   ""
#define xx__Auto2901   ""
#define en_Auto2902   "International Document Editor"
#define fr_Auto2902   "Editeur des Documents Multi-Nationales"
#define it_Auto2902   "International Document Editor"
#define es_Auto2902   "International Document Editor"
#define de_Auto2902   "International Document Editor"
#define nl_Auto2902   "International Document Editor"
#define pt_Auto2902   "International Document Editor"
#define xx_Auto2902   "International Document Editor"
...
#define en_Other   ""
#define en__Other   ""
#define en_Auto2903   "ok.gif"
#define fr_Auto2903   "ok.gif"
#define it_Auto2903   "ok.gif"
#define es_Auto2903   "ok.gif"
#define de_Auto2903   "ok.gif"
#define nl_Auto2903   "ok.gif"
#define pt_Auto2903   "ok.gif"
#define xx_Auto2903   "ok.gif"
...
#define en_Auto2904   "cancel.gif"
#define fr_Auto2904   "cancel.gif"
#define it_Auto2904   "cancel.gif"
#define es_Auto2904   "cancel.gif"
#define de_Auto2904   "cancel.gif"
#define nl_Auto2904   "cancel.gif"
#define pt_Auto2904   "cancel.gif"
#define xx_Auto2904   "cancel.gif"
	...
	char * pOther)
{
	...
	_Context->x_Auto2901=70;
	_Context->y_Auto2901=50;
	_Context->w_Auto2901=730;
	_Context->h_Auto2901=540;
	...
	_Context->pushbuffer=visual_buffer(_Context->x_Auto2901,_Context->y_Auto2901,730+10,540+10);
	return(0);
}
...
public 	int	accept_help_messages_hide(struct accept_help_messages_context * _Context)
{
	...
	&& (_Context->ctrlbuffer != 0)) {
		(void)visual_buffer_put(_Context->pushbuffer,_Context->x_Auto2901,_Context->y_Auto2901);
		_Context->ctrlbuffer=0;
		}
...
private int on_TabEnglish_show(struct accept_help_messages_context * _Context) {
	open_window_editor(_Context->x_Auto2901+20,_Context->y_Auto2901+90,
...
public	int	accept_help_messages_show(struct accept_help_messages_context * _Context)
{
	...
	if ((_Context->pushbuffer != (void *) 0)
	&& (!(_Context->ctrlbuffer))) {
		(void)visual_buffer_get(_Context->pushbuffer,_Context->x_Auto2901,_Context->y_Auto2901);
		_Context->ctrlbuffer=1;
		}
	visual_freeze();
	if (((_Context->status = visual_styled_element(_Context->x_Auto2901,_Context->y_Auto2901,730,540,GetWidgetStyle(0),GetWindowVersion(),strlen(GetWindowVersion()))) != 0)
) {
		visual_window(_Context->x_Auto2901,_Context->y_Auto2901,730,540,vfh[1],GetWindowVersion(),strlen(GetWindowVersion()),0x407);
		}
	visual_text(_Context->x_Auto2901+20,_Context->y_Auto2901+24,650,22,vfh[4],16,0,_Context->msg_Auto2902[_Context->language],strlen(_Context->msg_Auto2902[_Context->language]),1283);
	...
	visual_tabpage(_Context->x_Auto2901+10,_Context->y_Auto2901+50,710,420,vfh[2],_Context->msg_TabEnglish[_Context->language],strlen(_Context->msg_TabEnglish[_Context->language]),0,34);
		(void) on_TabEnglish_show(_Context);
	} else {
		visual_tabpage(_Context->x_Auto2901+10,_Context->y_Auto2901+50,710,420,vfh[2],_Context->msg_TabEnglish[_Context->language],strlen(_Context->msg_TabEnglish[_Context->language]),0,32);
		}
	if (_Context->page_number == 1 ) {
	...
	visual_tabpage(_Context->x_Auto2901+10,_Context->y_Auto2901+50,710,420,vfh[2],_Context->msg_TabFrancais[_Context->language],strlen(_Context->msg_TabFrancais[_Context->language]),81,34);
		(void) on_TabFrancais_show(_Context);
	} else {
		visual_tabpage(_Context->x_Auto2901+10,_Context->y_Auto2901+50,710,420,vfh[2],_Context->msg_TabFrancais[_Context->language],strlen(_Context->msg_TabFrancais[_Context->language]),81,32);
		}
	if (_Context->page_number == 2 ) {
	...
	visual_tabpage(_Context->x_Auto2901+10,_Context->y_Auto2901+50,710,420,vfh[2],_Context->msg_TabItaliano[_Context->language],strlen(_Context->msg_TabItaliano[_Context->language]),170,34);
		(void) on_TabItaliano_show(_Context);
	} else {
		visual_tabpage(_Context->x_Auto2901+10,_Context->y_Auto2901+50,710,420,vfh[2],_Context->msg_TabItaliano[_Context->language],strlen(_Context->msg_TabItaliano[_Context->language]),170,32);
		}
	if (_Context->page_number == 3 ) {
	...
	visual_tabpage(_Context->x_Auto2901+10,_Context->y_Auto2901+50,710,420,vfh[2],_Context->msg_TabEspagnol[_Context->language],strlen(_Context->msg_TabEspagnol[_Context->language]),250,34);
		(void) on_TabEspagnol_show(_Context);
	} else {
		visual_tabpage(_Context->x_Auto2901+10,_Context->y_Auto2901+50,710,420,vfh[2],_Context->msg_TabEspagnol[_Context->language],strlen(_Context->msg_TabEspagnol[_Context->language]),250,32);
		}
	if (_Context->page_number == 4 ) {
	...
	visual_tabpage(_Context->x_Auto2901+10,_Context->y_Auto2901+50,710,420,vfh[2],_Context->msg_TabDeutsch[_Context->language],strlen(_Context->msg_TabDeutsch[_Context->language]),342,34);
		(void) on_TabDeutsch_show(_Context);
	} else {
		visual_tabpage(_Context->x_Auto2901+10,_Context->y_Auto2901+50,710,420,vfh[2],_Context->msg_TabDeutsch[_Context->language],strlen(_Context->msg_TabDeutsch[_Context->language]),342,32);
		}
	if (_Context->page_number == 5 ) {
	...
	visual_tabpage(_Context->x_Auto2901+10,_Context->y_Auto2901+50,710,420,vfh[2],_Context->msg_TabNederlands[_Context->language],strlen(_Context->msg_TabNederlands[_Context->language]),429,34);
		(void) on_TabNederlands_show(_Context);
	} else {
		visual_tabpage(_Context->x_Auto2901+10,_Context->y_Auto2901+50,710,420,vfh[2],_Context->msg_TabNederlands[_Context->language],strlen(_Context->msg_TabNederlands[_Context->language]),429,32);
		}
	if (_Context->page_number == 6 ) {
	...
	visual_tabpage(_Context->x_Auto2901+10,_Context->y_Auto2901+50,710,420,vfh[2],_Context->msg_TabPortugues[_Context->language],strlen(_Context->msg_TabPortugues[_Context->language]),533,34);
		(void) on_TabPortugues_show(_Context);
	} else {
		visual_tabpage(_Context->x_Auto2901+10,_Context->y_Auto2901+50,710,420,vfh[2],_Context->msg_TabPortugues[_Context->language],strlen(_Context->msg_TabPortugues[_Context->language]),533,32);
		}
	if (_Context->page_number == 7 ) {
	...
	visual_tabpage(_Context->x_Auto2901+10,_Context->y_Auto2901+50,710,420,vfh[2],_Context->msg_TabOther[_Context->language],strlen(_Context->msg_TabOther[_Context->language]),632,34);
		(void) on_TabOther_show(_Context);
	} else {
		visual_tabpage(_Context->x_Auto2901+10,_Context->y_Auto2901+50,710,420,vfh[2],_Context->msg_TabOther[_Context->language],strlen(_Context->msg_TabOther[_Context->language]),632,32);
		}
	if (_Context->page_number == 8 ) {
	(void) on_Other_show(_Context);
		}
	_Context->trigger_Auto2903=visual_trigger_code(_Context->msg_Auto2903[_Context->language],strlen(_Context->msg_Auto2903[_Context->language]));
	visual_button(_Context->x_Auto2901+10,_Context->y_Auto2901+480,56,48,vfh[2],34,0,_Context->msg_Auto2903[_Context->language],strlen(_Context->msg_Auto2903[_Context->language]),1040);
	...
	visual_button(_Context->x_Auto2901+340,_Context->y_Auto2901+480,56,48,vfh[2],28,28,_Context->msg_FullScreen[_Context->language],strlen(_Context->msg_FullScreen[_Context->language]),1040);
	_Context->trigger_Auto2904=visual_trigger_code(_Context->msg_Auto2904[_Context->language],strlen(_Context->msg_Auto2904[_Context->language]));
	visual_button(_Context->x_Auto2901+660,_Context->y_Auto2901+480,56,48,vfh[2],34,0,_Context->msg_Auto2904[_Context->language],strlen(_Context->msg_Auto2904[_Context->language]),1040);
	visual_thaw(_Context->x_Auto2901,_Context->y_Auto2901,730,540);
...
private int Auto2901action(struct accept_help_messages_context * _Context) {
	...
	do {
		...
		_Context->x_Auto2901 += (visual_event(7)-x);
		x=visual_event(7);
		if (_Context->x_Auto2901 < 0) { _Context->x_Auto2901=0; }
		_Context->y_Auto2901 += (visual_event(6)-y);
		y=visual_event(6);
		if (_Context->y_Auto2901 < 0) { _Context->y_Auto2901=0; }
...
private int on_Auto2903_event(struct accept_help_messages_context * _Context) {
	return(13);
	return(-1);
}
...
;
	...
	use_editor(_Context->buffer_English,_GENERATE_HTML);
		accept_help_messages_show(_Context);
;
	visual_frame(_Context->x_Auto2901+20,_Context->y_Auto2901+90,688+2,368+2,5);
;
		/* English */
	/* TabEnglish */
...
private int on_Auto2904_event(struct accept_help_messages_context * _Context) {
	return(27);
	return(-1);
}
...
struct accept_help_messages_context * _Context){
	...
	if (visual_event(1) & _MIMO_ALT) {
		...
		if (_Context->trigger_Auto2903 == mb ) return(18);
		if (_Context->trigger_FullScreen == mb ) return(19);
		if (_Context->trigger_Auto2904 == mb ) return(20);
		return(-1);
		}
	...
	switch (mt) {
	case _MIMO_UP :
	if ((mx >= (_Context->x_Auto2901+709) )  
	&&  (my >= (_Context->y_Auto2901+4) )  
	&&  (mx <= (_Context->x_Auto2901+726) )  
	&&  (my <= (_Context->y_Auto2901+20) )) {
		return(1);	/* Auto2901 */

		}
	if ((mx >= (_Context->x_Auto2901+693) )  
	&&  (my >= (_Context->y_Auto2901+4) )  
	&&  (mx <= (_Context->x_Auto2901+710) )  
	&&  (my <= (_Context->y_Auto2901+20) )) {
	...
	if ((mx >= (_Context->x_Auto2901+677) )  
	&&  (my >= (_Context->y_Auto2901+4) )  
	&&  (mx <= (_Context->x_Auto2901+694) )  
	&&  (my <= (_Context->y_Auto2901+20) )) {
	...
	case _MIMO_DOWN :
		if ((mx >= (_Context->x_Auto2901+4) )  
		&&  (my >= (_Context->y_Auto2901+4) )  
		&&  (mx <= (_Context->x_Auto2901+662) )  
		&&  (my <= (_Context->y_Auto2901+20) )) {
			return( Auto2901action(_Context) );
			}
		}
	if (_Context->page_number == 1 ) {
	} else {
		if (( mx >= (_Context->x_Auto2901+10+0) ) 
		&&  ( my >= (_Context->y_Auto2901+50) ) 
		&&  ( mx <= (_Context->x_Auto2901+10+80) ) 
		&&  ( my <= (_Context->y_Auto2901+50+24))) {
			return(2); /* TabEnglish */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto2901+20) ) 
		&&  ( my >= (_Context->y_Auto2901+90) ) 
		&&  ( mx <= (_Context->x_Auto2901+20+688) ) 
		&&  ( my <= (_Context->y_Auto2901+90+368))) {
			return(3); /* English */
			}
		}
	if (_Context->page_number == 2 ) {
	} else {
		if (( mx >= (_Context->x_Auto2901+10+81) ) 
		&&  ( my >= (_Context->y_Auto2901+50) ) 
		&&  ( mx <= (_Context->x_Auto2901+10+169) ) 
		&&  ( my <= (_Context->y_Auto2901+50+24))) {
	...
	if (_Context->page_number == 3 ) {
		...
		if (( mx >= (_Context->x_Auto2901+10+170) ) 
		&&  ( my >= (_Context->y_Auto2901+50) ) 
		&&  ( mx <= (_Context->x_Auto2901+10+249) ) 
		&&  ( my <= (_Context->y_Auto2901+50+24))) {
	...
	if (_Context->page_number == 4 ) {
		...
		if (( mx >= (_Context->x_Auto2901+10+250) ) 
		&&  ( my >= (_Context->y_Auto2901+50) ) 
		&&  ( mx <= (_Context->x_Auto2901+10+341) ) 
		&&  ( my <= (_Context->y_Auto2901+50+24))) {
	...
	if (_Context->page_number == 5 ) {
		...
		if (( mx >= (_Context->x_Auto2901+10+342) ) 
		&&  ( my >= (_Context->y_Auto2901+50) ) 
		&&  ( mx <= (_Context->x_Auto2901+10+428) ) 
		&&  ( my <= (_Context->y_Auto2901+50+24))) {
	...
	if (_Context->page_number == 6 ) {
		...
		if (( mx >= (_Context->x_Auto2901+10+429) ) 
		&&  ( my >= (_Context->y_Auto2901+50) ) 
		&&  ( mx <= (_Context->x_Auto2901+10+532) ) 
		&&  ( my <= (_Context->y_Auto2901+50+24))) {
	...
	if (_Context->page_number == 7 ) {
		...
		if (( mx >= (_Context->x_Auto2901+10+533) ) 
		&&  ( my >= (_Context->y_Auto2901+50) ) 
		&&  ( mx <= (_Context->x_Auto2901+10+631) ) 
		&&  ( my <= (_Context->y_Auto2901+50+24))) {
	...
	if (_Context->page_number == 8 ) {
		...
		if (( mx >= (_Context->x_Auto2901+10+632) ) 
		&&  ( my >= (_Context->y_Auto2901+50) ) 
		&&  ( mx <= (_Context->x_Auto2901+10+704) ) 
		&&  ( my <= (_Context->y_Auto2901+50+24))) {
			return(16); /* TabOther */
			}
		}
	...
	if (( mx >= (_Context->x_Auto2901+10) ) 
	&&  ( my >= (_Context->y_Auto2901+480) ) 
	&&  ( mx <= (_Context->x_Auto2901+10+56) ) 
	&&  ( my <= (_Context->y_Auto2901+480+48))) {
		return(18); /* Auto2903 */
		}
	if (( mx >= (_Context->x_Auto2901+340) ) 
	&&  ( my >= (_Context->y_Auto2901+480) ) 
	&&  ( mx <= (_Context->x_Auto2901+340+56) ) 
	&&  ( my <= (_Context->y_Auto2901+480+48))) {
		return(19); /* FullScreen */
		}
	if (( mx >= (_Context->x_Auto2901+660) ) 
	&&  ( my >= (_Context->y_Auto2901+480) ) 
	&&  ( mx <= (_Context->x_Auto2901+660+56) ) 
	&&  ( my <= (_Context->y_Auto2901+480+48))) {
		return(20); /* Auto2904 */
		}
	...
	while(1) {
		switch (_Context->focus_item) {
			...
			case	0x12 :
				/* Auto2903 */
				_Context->trigger_Auto2903=visual_trigger_code(_Context->msg_Auto2903[_Context->language],strlen(_Context->msg_Auto2903[_Context->language]));
				visual_button(_Context->x_Auto2901+10,_Context->y_Auto2901+480,56,48,vfh[2],34,0,_Context->msg_Auto2903[_Context->language],strlen(_Context->msg_Auto2903[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto2903=visual_trigger_code(_Context->msg_Auto2903[_Context->language],strlen(_Context->msg_Auto2903[_Context->language]));
	visual_button(_Context->x_Auto2901+10,_Context->y_Auto2901+480,56,48,vfh[2],34,0,_Context->msg_Auto2903[_Context->language],strlen(_Context->msg_Auto2903[_Context->language]),1040);
				break;
			case	0x14 :
				/* Auto2904 */
				_Context->trigger_Auto2904=visual_trigger_code(_Context->msg_Auto2904[_Context->language],strlen(_Context->msg_Auto2904[_Context->language]));
				visual_button(_Context->x_Auto2901+660,_Context->y_Auto2901+480,56,48,vfh[2],34,0,_Context->msg_Auto2904[_Context->language],strlen(_Context->msg_Auto2904[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto2904=visual_trigger_code(_Context->msg_Auto2904[_Context->language],strlen(_Context->msg_Auto2904[_Context->language]));
	visual_button(_Context->x_Auto2901+660,_Context->y_Auto2901+480,56,48,vfh[2],34,0,_Context->msg_Auto2904[_Context->language],strlen(_Context->msg_Auto2904[_Context->language]),1040);
				break;
...
retry:
		...
		case	0x100 :
			...
			if (( visual_event(1) == _MIMO_DOWN ) && ( visual_event(2) == _MIMO_RIGHT)) {
				switch ((_Context->focus_item = retcode)) {
					...
					case	0x12 :
						if (Auto2903_help(_Context) != 0) { continue; }
						else { break; }
					case	0x13 :
						if (FullScreen_help(_Context) != 0) { continue; }
						else { break; }
					case	0x14 :
						if (Auto2904_help(_Context) != 0) { continue; }
						else { break; }
					}
				}
			switch ((_Context->focus_item = retcode)) {
	...
	visual_button(_Context->x_Auto2901+10,_Context->y_Auto2901+480,56,48,vfh[2],34,0,_Context->msg_Auto2903[_Context->language],strlen(_Context->msg_Auto2903[_Context->language]),1040);
					...
					if ((_Context->keycode = on_Auto2903_event(_Context)) != -1) break;
				...
				case	0x13 :
					...
					if (visual_event(1) & _MIMO_DOWN) {
						_Context->trigger_FullScreen=visual_trigger_code(_Context->msg_FullScreen[_Context->language],strlen(_Context->msg_FullScreen[_Context->language]));
						visual_button(_Context->x_Auto2901+340,_Context->y_Auto2901+480,56,48,vfh[2],28,28,_Context->msg_FullScreen[_Context->language],strlen(_Context->msg_FullScreen[_Context->language]),1042);
						}
					else if (visual_event(1) & _MIMO_UP) {
						_Context->trigger_FullScreen=visual_trigger_code(_Context->msg_FullScreen[_Context->language],strlen(_Context->msg_FullScreen[_Context->language]));
	visual_button(_Context->x_Auto2901+340,_Context->y_Auto2901+480,56,48,vfh[2],28,28,_Context->msg_FullScreen[_Context->language],strlen(_Context->msg_FullScreen[_Context->language]),1040);
	...
	visual_button(_Context->x_Auto2901+660,_Context->y_Auto2901+480,56,48,vfh[2],34,0,_Context->msg_Auto2904[_Context->language],strlen(_Context->msg_Auto2904[_Context->language]),1040);
					...
					if ( visual_event(1) &  0x20 ) {
					if ((_Context->keycode = on_Auto2904_event(_Context)) != -1) break;
