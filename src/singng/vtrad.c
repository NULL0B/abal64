...
#define pt__Auto2765   ""
#define xx__Auto2765   ""
#define en_Auto2767   "otricon.gif"
#define fr_Auto2767   "otricon.gif"
#define it_Auto2767   "otricon.gif"
#define es_Auto2767   "otricon.gif"
#define de_Auto2767   "otricon.gif"
#define nl_Auto2767   "otricon.gif"
#define pt_Auto2767   "otricon.gif"
#define xx_Auto2767   "otricon.gif"
...
#define en_Auto2768   "ABAL++ Translator Options"
#define fr_Auto2768   "Options du Traducteur d'ABAL++"
#define it_Auto2768   "ABAL++ Translator Options"
#define es_Auto2768   "ABAL++ Translator Options"
#define de_Auto2768   "ABAL++ Translator Options"
#define nl_Auto2768   "ABAL++ Translator Options"
#define pt_Auto2768   "ABAL++ Translator Options"
#define xx_Auto2768   "ABAL++ Translator Options"
...
#define en_Auto2769   "ok.gif"
#define fr_Auto2769   "ok.gif"
#define it_Auto2769   "ok.gif"
#define es_Auto2769   "ok.gif"
#define de_Auto2769   "ok.gif"
#define nl_Auto2769   "ok.gif"
#define pt_Auto2769   "ok.gif"
#define xx_Auto2769   "ok.gif"
#define en_Auto2770   "cancel.gif"
#define fr_Auto2770   "cancel.gif"
#define it_Auto2770   "cancel.gif"
#define es_Auto2770   "cancel.gif"
#define de_Auto2770   "cancel.gif"
#define nl_Auto2770   "cancel.gif"
#define pt_Auto2770   "cancel.gif"
#define xx_Auto2770   "cancel.gif"
...
private struct accept_traduction_context {
	...
	int	value_Compact;
	char * msg_Auto2769[8];
	int	trigger_Auto2769;
	char * hint_Auto2769[8];
	char * msg_Auto2770[8];
	int	trigger_Auto2770;
	...
	char * pInclusion)
{
	...
	_Context->hint_Auto2765[1]=fr__Auto2765;
	_Context->hint_Auto2765[2]=it__Auto2765;
	_Context->hint_Auto2765[3]=es__Auto2765;
	_Context->hint_Auto2765[4]=de__Auto2765;
	_Context->hint_Auto2765[5]=nl__Auto2765;
	_Context->hint_Auto2765[6]=pt__Auto2765;
	_Context->hint_Auto2765[7]=xx__Auto2765;
	_Context->x_Auto2765=170;
	_Context->y_Auto2765=105;
	_Context->w_Auto2765=460;
	_Context->h_Auto2765=390;
	...
	_Context->pushbuffer=visual_buffer(_Context->x_Auto2765,_Context->y_Auto2765,460+10,390+10);
	return(0);
}
...
public 	int	accept_traduction_hide(struct accept_traduction_context * _Context)
{
	...
	&& (_Context->ctrlbuffer != 0)) {
		(void)visual_buffer_put(_Context->pushbuffer,_Context->x_Auto2765,_Context->y_Auto2765);
		_Context->ctrlbuffer=0;
		}
...
public	int	accept_traduction_show(struct accept_traduction_context * _Context)
{
	...
	if ((_Context->pushbuffer != (void *) 0)
	&& (!(_Context->ctrlbuffer))) {
		(void)visual_buffer_get(_Context->pushbuffer,_Context->x_Auto2765,_Context->y_Auto2765);
		_Context->ctrlbuffer=1;
		}
	visual_freeze();
	if (((_Context->status = visual_styled_element(_Context->x_Auto2765,_Context->y_Auto2765,460,390,GetWidgetStyle(0),GetWindowVersion(),strlen(GetWindowVersion()))) != 0)
) {
		visual_window(_Context->x_Auto2765,_Context->y_Auto2765,460,390,vfh[2],GetWindowVersion(),strlen(GetWindowVersion()),0x407);
		}
	visual_frame(_Context->x_Auto2765+21,_Context->y_Auto2765+168,420,60,2);
	visual_image(_Context->x_Auto2765+350,_Context->y_Auto2765+30,30,20,_Context->msg_Auto2767[_Context->language],3);
	visual_image(_Context->x_Auto2765+390,_Context->y_Auto2765+30,51,50,_Context->msg_auto726[_Context->language],0);
	visual_text(_Context->x_Auto2765+20,_Context->y_Auto2765+30,392,32,vfh[3],34,0,_Context->msg_Auto2768[_Context->language],strlen(_Context->msg_Auto2768[_Context->language]),770);
	visual_text(_Context->x_Auto2765+20,_Context->y_Auto2765+70,414,16,vfh[2],34,0,_Context->msg_auto281[_Context->language],strlen(_Context->msg_auto281[_Context->language]),256);
	visual_text(_Context->x_Auto2765+20,_Context->y_Auto2765+120,415,16,vfh[2],34,0,_Context->msg_auto282[_Context->language],strlen(_Context->msg_auto282[_Context->language]),256);
	visual_frame(_Context->x_Auto2765+20,_Context->y_Auto2765+90,416+2,16+2,5);
	visual_text(_Context->x_Auto2765+20+1,_Context->y_Auto2765+90+1,416,16,vfh[1],16,28,_Context->buffer_FileName,255,0);
	visual_frame(_Context->x_Auto2765+20,_Context->y_Auto2765+140,416+2,16+2,5);
	visual_text(_Context->x_Auto2765+20+1,_Context->y_Auto2765+140+1,416,16,vfh[1],16,28,_Context->buffer_Translator,255,0);
	...
	visual_check(_Context->x_Auto2765+30,_Context->y_Auto2765+180,84,16,vfh[2],34,0,_Context->msg_Debug[_Context->language],strlen(_Context->msg_Debug[_Context->language]),_Context->value_Debug|0);
	...
	visual_check(_Context->x_Auto2765+30,_Context->y_Auto2765+200,84,16,vfh[2],34,0,_Context->msg_Trace[_Context->language],strlen(_Context->msg_Trace[_Context->language]),_Context->value_Trace|0);
	...
	visual_check(_Context->x_Auto2765+160,_Context->y_Auto2765+180,98,16,vfh[2],27,0,_Context->msg_Verbose[_Context->language],strlen(_Context->msg_Verbose[_Context->language]),_Context->value_Verbose|0);
	...
	visual_check(_Context->x_Auto2765+160,_Context->y_Auto2765+200,98,16,vfh[2],27,0,_Context->msg_ListFile[_Context->language],strlen(_Context->msg_ListFile[_Context->language]),_Context->value_ListFile|0);
	...
	visual_check(_Context->x_Auto2765+290,_Context->y_Auto2765+180,126,16,vfh[2],34,0,_Context->msg_Optimise[_Context->language],strlen(_Context->msg_Optimise[_Context->language]),_Context->value_Optimise|0);
	...
	visual_check(_Context->x_Auto2765+290,_Context->y_Auto2765+200,126,16,vfh[2],34,0,_Context->msg_Compact[_Context->language],strlen(_Context->msg_Compact[_Context->language]),_Context->value_Compact|0);
	_Context->trigger_Auto2769=visual_trigger_code(_Context->msg_Auto2769[_Context->language],strlen(_Context->msg_Auto2769[_Context->language]));
	visual_button(_Context->x_Auto2765+20,_Context->y_Auto2765+330,56,48,vfh[2],34,0,_Context->msg_Auto2769[_Context->language],strlen(_Context->msg_Auto2769[_Context->language]),1040);
	_Context->trigger_Auto2770=visual_trigger_code(_Context->msg_Auto2770[_Context->language],strlen(_Context->msg_Auto2770[_Context->language]));
	visual_button(_Context->x_Auto2765+380,_Context->y_Auto2765+330,56,48,vfh[2],34,0,_Context->msg_Auto2770[_Context->language],strlen(_Context->msg_Auto2770[_Context->language]),1040);
	visual_text(_Context->x_Auto2765+20,_Context->y_Auto2765+240,419,20,vfh[2],34,0,_Context->msg_auto351[_Context->language],strlen(_Context->msg_auto351[_Context->language]),256);
	visual_frame(_Context->x_Auto2765+20,_Context->y_Auto2765+260,416+2,64+2,5);
	visual_text(_Context->x_Auto2765+20+1,_Context->y_Auto2765+260+1,416,64,vfh[1],16,28,_Context->buffer_Inclusion,255,0);
	_Context->trigger_Edit=visual_trigger_code(_Context->msg_Edit[_Context->language],strlen(_Context->msg_Edit[_Context->language]));
	visual_button(_Context->x_Auto2765+120,_Context->y_Auto2765+340,98,32,vfh[2],26,0,_Context->msg_Edit[_Context->language],strlen(_Context->msg_Edit[_Context->language]),0);
	...
	visual_button(_Context->x_Auto2765+240,_Context->y_Auto2765+340,98,32,vfh[2],27,24,_Context->msg_Select[_Context->language],strlen(_Context->msg_Select[_Context->language]),0);
	visual_thaw(_Context->x_Auto2765,_Context->y_Auto2765,460,390);
...
private int Auto2765action(struct accept_traduction_context * _Context) {
	...
	do {
		...
		_Context->x_Auto2765 += (visual_event(7)-x);
		x=visual_event(7);
		if (_Context->x_Auto2765 < 0) { _Context->x_Auto2765=0; }
		_Context->y_Auto2765 += (visual_event(6)-y);
		y=visual_event(6);
		if (_Context->y_Auto2765 < 0) { _Context->y_Auto2765=0; }
...
private int on_Auto2769_event(struct accept_traduction_context * _Context) {
	return(13);
	return(-1);
}
private int on_Auto2770_event(struct accept_traduction_context * _Context) {
	return(27);
	return(-1);
}
...
struct accept_traduction_context * _Context){
	...
	if (visual_event(1) & _MIMO_ALT) {
		...
		if (_Context->trigger_Auto2769 == mb ) return(10);
		if (_Context->trigger_Auto2770 == mb ) return(11);
	...
	switch (mt) {
	case _MIMO_UP :
	if ((mx >= (_Context->x_Auto2765+439) )  
	&&  (my >= (_Context->y_Auto2765+4) )  
	&&  (mx <= (_Context->x_Auto2765+456) )  
	&&  (my <= (_Context->y_Auto2765+20) )) {
		return(1);	/* Auto2765 */

		}
	if ((mx >= (_Context->x_Auto2765+423) )  
	&&  (my >= (_Context->y_Auto2765+4) )  
	&&  (mx <= (_Context->x_Auto2765+440) )  
	&&  (my <= (_Context->y_Auto2765+20) )) {
	...
	if ((mx >= (_Context->x_Auto2765+407) )  
	&&  (my >= (_Context->y_Auto2765+4) )  
	&&  (mx <= (_Context->x_Auto2765+424) )  
	&&  (my <= (_Context->y_Auto2765+20) )) {
	...
	case _MIMO_DOWN :
		if ((mx >= (_Context->x_Auto2765+4) )  
		&&  (my >= (_Context->y_Auto2765+4) )  
		&&  (mx <= (_Context->x_Auto2765+392) )  
		&&  (my <= (_Context->y_Auto2765+20) )) {
			return( Auto2765action(_Context) );
			}
		}
	if (( mx >= (_Context->x_Auto2765+20) ) 
	&&  ( my >= (_Context->y_Auto2765+90) ) 
	&&  ( mx <= (_Context->x_Auto2765+20+416) ) 
	&&  ( my <= (_Context->y_Auto2765+90+16))) {
		return(2); /* FileName */
		}
	if (( mx >= (_Context->x_Auto2765+20) ) 
	&&  ( my >= (_Context->y_Auto2765+140) ) 
	&&  ( mx <= (_Context->x_Auto2765+20+416) ) 
	&&  ( my <= (_Context->y_Auto2765+140+16))) {
		return(3); /* Translator */
		}
	if (( mx >= (_Context->x_Auto2765+30) ) 
	&&  ( my >= (_Context->y_Auto2765+180) ) 
	&&  ( mx <= (_Context->x_Auto2765+30+84) ) 
	&&  ( my <= (_Context->y_Auto2765+180+16))) {
		return(4); /* Debug */
		}
	if (( mx >= (_Context->x_Auto2765+30) ) 
	&&  ( my >= (_Context->y_Auto2765+200) ) 
	&&  ( mx <= (_Context->x_Auto2765+30+84) ) 
	&&  ( my <= (_Context->y_Auto2765+200+16))) {
		return(5); /* Trace */
		}
	if (( mx >= (_Context->x_Auto2765+160) ) 
	&&  ( my >= (_Context->y_Auto2765+180) ) 
	&&  ( mx <= (_Context->x_Auto2765+160+98) ) 
	&&  ( my <= (_Context->y_Auto2765+180+16))) {
		return(6); /* Verbose */
		}
	if (( mx >= (_Context->x_Auto2765+160) ) 
	...
	if (( mx >= (_Context->x_Auto2765+290) ) 
	&&  ( my >= (_Context->y_Auto2765+180) ) 
	&&  ( mx <= (_Context->x_Auto2765+290+126) ) 
	&&  ( my <= (_Context->y_Auto2765+180+16))) {
		return(8); /* Optimise */
		}
	if (( mx >= (_Context->x_Auto2765+290) ) 
	...
	if (( mx >= (_Context->x_Auto2765+20) ) 
	&&  ( my >= (_Context->y_Auto2765+330) ) 
	&&  ( mx <= (_Context->x_Auto2765+20+56) ) 
	&&  ( my <= (_Context->y_Auto2765+330+48))) {
		return(10); /* Auto2769 */
		}
	if (( mx >= (_Context->x_Auto2765+380) ) 
	&&  ( my >= (_Context->y_Auto2765+330) ) 
	&&  ( mx <= (_Context->x_Auto2765+380+56) ) 
	&&  ( my <= (_Context->y_Auto2765+330+48))) {
		return(11); /* Auto2770 */
		}
	if (( mx >= (_Context->x_Auto2765+20) ) 
	&&  ( my >= (_Context->y_Auto2765+260) ) 
	&&  ( mx <= (_Context->x_Auto2765+20+416) ) 
	&&  ( my <= (_Context->y_Auto2765+260+64))) {
		return(12); /* Inclusion */
		}
	if (( mx >= (_Context->x_Auto2765+120) ) 
	&&  ( my >= (_Context->y_Auto2765+340) ) 
	&&  ( mx <= (_Context->x_Auto2765+120+98) ) 
	&&  ( my <= (_Context->y_Auto2765+340+32))) {
		return(13); /* Edit */
		}
	if (( mx >= (_Context->x_Auto2765+240) ) 
	&&  ( my >= (_Context->y_Auto2765+340) ) 
	&&  ( mx <= (_Context->x_Auto2765+240+98) ) 
	&&  ( my <= (_Context->y_Auto2765+340+32))) {
		return(14); /* Select */
		}
...
public	int	accept_traduction_focus(struct accept_traduction_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			case	0x2 :
				/* FileName */
				_Context->keycode = visual_edit(_Context->x_Auto2765+20+1,_Context->y_Auto2765+90+1,416,16,vfh[1],_Context->buffer_FileName,255);
			break;
			case	0x3 :
				/* Translator */
				_Context->keycode = visual_edit(_Context->x_Auto2765+20+1,_Context->y_Auto2765+140+1,416,16,vfh[1],_Context->buffer_Translator,255);
			break;
			case	0x4 :
				/* Debug */
				visual_check(_Context->x_Auto2765+30,_Context->y_Auto2765+180,84,16,vfh[2],34,0,_Context->msg_Debug[_Context->language],strlen(_Context->msg_Debug[_Context->language]),(_Context->value_Debug |2));
	...
	visual_check(_Context->x_Auto2765+30,_Context->y_Auto2765+180,84,16,vfh[2],34,0,_Context->msg_Debug[_Context->language],strlen(_Context->msg_Debug[_Context->language]),_Context->value_Debug|0);
			...
			case	0x5 :
				/* Trace */
				visual_check(_Context->x_Auto2765+30,_Context->y_Auto2765+200,84,16,vfh[2],34,0,_Context->msg_Trace[_Context->language],strlen(_Context->msg_Trace[_Context->language]),(_Context->value_Trace |2));
				_Context->keycode = visual_getch();
				_Context->trigger_Trace=visual_trigger_code(_Context->msg_Trace[_Context->language],strlen(_Context->msg_Trace[_Context->language]));
	visual_check(_Context->x_Auto2765+30,_Context->y_Auto2765+200,84,16,vfh[2],34,0,_Context->msg_Trace[_Context->language],strlen(_Context->msg_Trace[_Context->language]),_Context->value_Trace|0);
				break;
			case	0x6 :
				/* Verbose */
				visual_check(_Context->x_Auto2765+160,_Context->y_Auto2765+180,98,16,vfh[2],27,0,_Context->msg_Verbose[_Context->language],strlen(_Context->msg_Verbose[_Context->language]),(_Context->value_Verbose |2));
				_Context->keycode = visual_getch();
				_Context->trigger_Verbose=visual_trigger_code(_Context->msg_Verbose[_Context->language],strlen(_Context->msg_Verbose[_Context->language]));
	visual_check(_Context->x_Auto2765+160,_Context->y_Auto2765+180,98,16,vfh[2],27,0,_Context->msg_Verbose[_Context->language],strlen(_Context->msg_Verbose[_Context->language]),_Context->value_Verbose|0);
				break;
			case	0x7 :
				/* ListFile */
				visual_check(_Context->x_Auto2765+160,_Context->y_Auto2765+200,98,16,vfh[2],27,0,_Context->msg_ListFile[_Context->language],strlen(_Context->msg_ListFile[_Context->language]),(_Context->value_ListFile |2));
				_Context->keycode = visual_getch();
				_Context->trigger_ListFile=visual_trigger_code(_Context->msg_ListFile[_Context->language],strlen(_Context->msg_ListFile[_Context->language]));
	visual_check(_Context->x_Auto2765+160,_Context->y_Auto2765+200,98,16,vfh[2],27,0,_Context->msg_ListFile[_Context->language],strlen(_Context->msg_ListFile[_Context->language]),_Context->value_ListFile|0);
				break;
			case	0x8 :
				/* Optimise */
				visual_check(_Context->x_Auto2765+290,_Context->y_Auto2765+180,126,16,vfh[2],34,0,_Context->msg_Optimise[_Context->language],strlen(_Context->msg_Optimise[_Context->language]),(_Context->value_Optimise |2));
				_Context->keycode = visual_getch();
				_Context->trigger_Optimise=visual_trigger_code(_Context->msg_Optimise[_Context->language],strlen(_Context->msg_Optimise[_Context->language]));
	visual_check(_Context->x_Auto2765+290,_Context->y_Auto2765+180,126,16,vfh[2],34,0,_Context->msg_Optimise[_Context->language],strlen(_Context->msg_Optimise[_Context->language]),_Context->value_Optimise|0);
				break;
			case	0x9 :
				/* Compact */
				visual_check(_Context->x_Auto2765+290,_Context->y_Auto2765+200,126,16,vfh[2],34,0,_Context->msg_Compact[_Context->language],strlen(_Context->msg_Compact[_Context->language]),(_Context->value_Compact |2));
				_Context->keycode = visual_getch();
				_Context->trigger_Compact=visual_trigger_code(_Context->msg_Compact[_Context->language],strlen(_Context->msg_Compact[_Context->language]));
	visual_check(_Context->x_Auto2765+290,_Context->y_Auto2765+200,126,16,vfh[2],34,0,_Context->msg_Compact[_Context->language],strlen(_Context->msg_Compact[_Context->language]),_Context->value_Compact|0);
				break;
			case	0xa :
				/* Auto2769 */
				_Context->trigger_Auto2769=visual_trigger_code(_Context->msg_Auto2769[_Context->language],strlen(_Context->msg_Auto2769[_Context->language]));
				visual_button(_Context->x_Auto2765+20,_Context->y_Auto2765+330,56,48,vfh[2],34,0,_Context->msg_Auto2769[_Context->language],strlen(_Context->msg_Auto2769[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto2769=visual_trigger_code(_Context->msg_Auto2769[_Context->language],strlen(_Context->msg_Auto2769[_Context->language]));
	visual_button(_Context->x_Auto2765+20,_Context->y_Auto2765+330,56,48,vfh[2],34,0,_Context->msg_Auto2769[_Context->language],strlen(_Context->msg_Auto2769[_Context->language]),1040);
				break;
			case	0xb :
				/* Auto2770 */
				_Context->trigger_Auto2770=visual_trigger_code(_Context->msg_Auto2770[_Context->language],strlen(_Context->msg_Auto2770[_Context->language]));
				visual_button(_Context->x_Auto2765+380,_Context->y_Auto2765+330,56,48,vfh[2],34,0,_Context->msg_Auto2770[_Context->language],strlen(_Context->msg_Auto2770[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto2770=visual_trigger_code(_Context->msg_Auto2770[_Context->language],strlen(_Context->msg_Auto2770[_Context->language]));
	visual_button(_Context->x_Auto2765+380,_Context->y_Auto2765+330,56,48,vfh[2],34,0,_Context->msg_Auto2770[_Context->language],strlen(_Context->msg_Auto2770[_Context->language]),1040);
				break;
			case	0xc :
				/* Inclusion */
				_Context->keycode = visual_edit(_Context->x_Auto2765+20+1,_Context->y_Auto2765+260+1,416,64,vfh[1],_Context->buffer_Inclusion,255);
			break;
			case	0xd :
				/* Edit */
				_Context->trigger_Edit=visual_trigger_code(_Context->msg_Edit[_Context->language],strlen(_Context->msg_Edit[_Context->language]));
				visual_button(_Context->x_Auto2765+120,_Context->y_Auto2765+340,98,32,vfh[2],26,0,_Context->msg_Edit[_Context->language],strlen(_Context->msg_Edit[_Context->language]),2);
				_Context->keycode = visual_getch();
				_Context->trigger_Edit=visual_trigger_code(_Context->msg_Edit[_Context->language],strlen(_Context->msg_Edit[_Context->language]));
	visual_button(_Context->x_Auto2765+120,_Context->y_Auto2765+340,98,32,vfh[2],26,0,_Context->msg_Edit[_Context->language],strlen(_Context->msg_Edit[_Context->language]),0);
				break;
			case	0xe :
				/* Select */
				_Context->trigger_Select=visual_trigger_code(_Context->msg_Select[_Context->language],strlen(_Context->msg_Select[_Context->language]));
				visual_button(_Context->x_Auto2765+240,_Context->y_Auto2765+340,98,32,vfh[2],27,24,_Context->msg_Select[_Context->language],strlen(_Context->msg_Select[_Context->language]),2);
				_Context->keycode = visual_getch();
				_Context->trigger_Select=visual_trigger_code(_Context->msg_Select[_Context->language],strlen(_Context->msg_Select[_Context->language]));
	visual_button(_Context->x_Auto2765+240,_Context->y_Auto2765+340,98,32,vfh[2],27,24,_Context->msg_Select[_Context->language],strlen(_Context->msg_Select[_Context->language]),0);
				break;
...
retry:
		...
		case	0x100 :
			...
			if (( visual_event(1) == _MIMO_DOWN ) && ( visual_event(2) == _MIMO_RIGHT)) {
				switch ((_Context->focus_item = retcode)) {
					...
					case	0xa :
						if (Auto2769_help(_Context) != 0) { continue; }
						else { break; }
					case	0xb :
						if (Auto2770_help(_Context) != 0) { continue; }
						else { break; }
					case	0xc :
	...
	visual_button(_Context->x_Auto2765+20,_Context->y_Auto2765+330,56,48,vfh[2],34,0,_Context->msg_Auto2769[_Context->language],strlen(_Context->msg_Auto2769[_Context->language]),1040);
					...
					if ((_Context->keycode = on_Auto2769_event(_Context)) != -1) break;
	...
	visual_button(_Context->x_Auto2765+380,_Context->y_Auto2765+330,56,48,vfh[2],34,0,_Context->msg_Auto2770[_Context->language],strlen(_Context->msg_Auto2770[_Context->language]),1040);
					...
					if ( visual_event(1) &  0x20 ) {
					if ((_Context->keycode = on_Auto2770_event(_Context)) != -1) break;
