...
#define en_FileName   ""
#define en_Auto2737   "ok.gif"
#define fr_Auto2737   "ok.gif"
#define it_Auto2737   "ok.gif"
#define es_Auto2737   "ok.gif"
#define de_Auto2737   "ok.gif"
#define nl_Auto2737   "ok.gif"
#define pt_Auto2737   "ok.gif"
#define xx_Auto2737   "ok.gif"
...
#define en_Auto2738   "cancel.gif"
#define fr_Auto2738   "cancel.gif"
#define it_Auto2738   "cancel.gif"
#define es_Auto2738   "cancel.gif"
#define de_Auto2738   "cancel.gif"
#define nl_Auto2738   "cancel.gif"
#define pt_Auto2738   "cancel.gif"
#define xx_Auto2738   "cancel.gif"
...
public	int	accept_imageload_show(struct accept_imageload_context * _Context)
{
	...
	visual_button(_Context->x_auto6+20,_Context->y_auto6+90,56,48,vfh[2],34,0,_Context->msg_Auto2737[_Context->language],strlen(_Context->msg_Auto2737[_Context->language]),1040);
	...
	visual_button(_Context->x_auto6+520,_Context->y_auto6+90,56,48,vfh[2],34,0,_Context->msg_Auto2738[_Context->language],strlen(_Context->msg_Auto2738[_Context->language]),1040);
...
private int on_Auto2737_event(struct accept_imageload_context * _Context) {
	return(13);
	return(-1);
}
...
private int on_Auto2738_event(struct accept_imageload_context * _Context) {
	return(27);
	return(-1);
}
...
struct accept_imageload_context * _Context){
	...
	if (visual_event(1) & _MIMO_ALT) {
		...
		if (_Context->trigger_Auto2737 == mb ) return(3);
		if (_Context->trigger_Select == mb ) return(4);
		if (_Context->trigger_Auto2738 == mb ) return(5);
		return(-1);
		}
...
public	int	accept_imageload_focus(struct accept_imageload_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			...
			case	0x3 :
				/* Auto2737 */
				_Context->trigger_Auto2737=visual_trigger_code(_Context->msg_Auto2737[_Context->language],strlen(_Context->msg_Auto2737[_Context->language]));
				visual_button(_Context->x_auto6+20,_Context->y_auto6+90,56,48,vfh[2],34,0,_Context->msg_Auto2737[_Context->language],strlen(_Context->msg_Auto2737[_Context->language]),1042);
	...
	visual_button(_Context->x_auto6+360,_Context->y_auto6+100,100,30,vfh[2],27,24,_Context->msg_Select[_Context->language],strlen(_Context->msg_Select[_Context->language]),0);
			...
			case	0x5 :
				/* Auto2738 */
				_Context->trigger_Auto2738=visual_trigger_code(_Context->msg_Auto2738[_Context->language],strlen(_Context->msg_Auto2738[_Context->language]));
				visual_button(_Context->x_auto6+520,_Context->y_auto6+90,56,48,vfh[2],34,0,_Context->msg_Auto2738[_Context->language],strlen(_Context->msg_Auto2738[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto2738=visual_trigger_code(_Context->msg_Auto2738[_Context->language],strlen(_Context->msg_Auto2738[_Context->language]));
	visual_button(_Context->x_auto6+520,_Context->y_auto6+90,56,48,vfh[2],34,0,_Context->msg_Auto2738[_Context->language],strlen(_Context->msg_Auto2738[_Context->language]),1040);
				break;
