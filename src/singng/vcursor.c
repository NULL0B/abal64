...
#define pt__SzlView   ""
#define xx__SzlView   ""
#define en_Auto629   "3dView"
#define fr_Auto629   "3dView"
#define it_Auto629   "3dView"
#define es_Auto629   "3dView"
#define de_Auto629   "3dView"
#define nl_Auto629   "3dView"
#define pt_Auto629   "3dView"
#define xx_Auto629   "3dView"
#define en_Auto630   "View"
#define fr_Auto630   "Vue"
#define it_Auto630   "View"
#define es_Auto630   "View"
#define de_Auto630   "View"
#define nl_Auto630   "View"
#define pt_Auto630   "View"
#define xx_Auto630   "View"
#define en__Auto630   ""
#define fr__Auto630   ""
#define it__Auto630   ""
#define es__Auto630   ""
...
#define pt__Auto630   ""
#define xx__Auto630   ""
#define en_Auto631   "Focus"
#define fr_Auto631   "Focus"
#define it_Auto631   "Focus"
#define es_Auto631   "Focus"
#define de_Auto631   "Focus"
#define nl_Auto631   "Focus"
#define pt_Auto631   "Focus"
#define xx_Auto631   "Focus"
#define en__Auto631   ""
#define fr__Auto631   ""
#define it__Auto631   ""
#define es__Auto631   ""
...
#define pt__Auto631   ""
#define xx__Auto631   ""
#define en_Auto632   "Step"
#define fr_Auto632   "Pas"
#define it_Auto632   "Step"
#define es_Auto632   "Step"
#define de_Auto632   "Step"
#define nl_Auto632   "Step"
#define pt_Auto632   "Step"
#define xx_Auto632   "Step"
#define en__Auto632   ""
#define en_Xadjust   "X+/-"
#define fr_Xadjust   "X+/-"
#define it_Xadjust   "X+/-"
...
#define en_Auto633   "Position"
#define fr_Auto633   "Position"
#define it_Auto633   "Position"
#define es_Auto633   "Position"
#define de_Auto633   "Position"
#define nl_Auto633   "Position"
#define pt_Auto633   "Position"
#define xx_Auto633   "Position"
#define en__Auto633   ""
#define en_AtX   ""
#define en_AtY   ""
#define en_AtZ   ""
...
public	int	visual_3d_cursor_create(struct visual_3d_cursor_context **cptr)
{
	...
	_Context->x_GridIcon=19;
	_Context->y_GridIcon=360;
...
private int on_AtX_show(struct visual_3d_cursor_context * _Context) {
	...
	sprintf(_Context->buffer_AtX,"%u",x);
	visual_frame(2,141,48+2,16+2,5);
visual_text(2+1,141+1,48,16,vfh[1],0,0,_Context->buffer_AtX,6,3);
;
	return(-1);
}
private int on_AtY_show(struct visual_3d_cursor_context * _Context) {
	...
	visual_frame(2,160,48+2,16+2,5);
visual_text(2+1,160+1,48,16,vfh[1],0,0,_Context->buffer_AtY,6,3);
;
	return(-1);
}
private int on_AtZ_show(struct visual_3d_cursor_context * _Context) {
	...
	visual_frame(2,179,48+2,16+2,5);
visual_text(2+1,179+1,48,16,vfh[1],16,31,_Context->buffer_AtZ,6,3);
;
	return(-1);
}
...
public	int	visual_3d_cursor_show(struct visual_3d_cursor_context * _Context)
{
	_Context->language = visual_national_language(-1);
	visual_freeze();
	if (((_Context->status = visual_styled_element(0,30,56,400,GetWidgetStyle(7)," ",0)) != 0)
) {
		visual_filzone(0,30,56,400,21,16);
		}
	...
	visual_button(2,411,24,16,vfh[8],27,28,_Context->msg_AddView[_Context->language],strlen(_Context->msg_AddView[_Context->language]),0);
	...
	visual_button(28,411,24,16,vfh[8],27,28,_Context->msg_SzlView[_Context->language],strlen(_Context->msg_SzlView[_Context->language]),0);
	visual_text(0,46,56,16,vfh[2],0,0,_Context->msg_Auto629[_Context->language],strlen(_Context->msg_Auto629[_Context->language]),1283);
	visual_text(0,397,56,16,vfh[2],0,0,_Context->msg_Auto630[_Context->language],strlen(_Context->msg_Auto630[_Context->language]),1283);
	visual_text(0,329,56,16,vfh[2],0,0,_Context->msg_Auto631[_Context->language],strlen(_Context->msg_Auto631[_Context->language]),1283);
	visual_text(0,206,56,16,vfh[2],0,0,_Context->msg_Auto632[_Context->language],strlen(_Context->msg_Auto632[_Context->language]),1283);
	...
	visual_button(2,221,50,16,vfh[8],27,28,_Context->msg_Xadjust[_Context->language],strlen(_Context->msg_Xadjust[_Context->language]),0);
	visual_frame(2,238,48+2,16+2,5);
	visual_text(2+1,238+1,48,16,vfh[1],0,0,_Context->buffer_ByX,6,3);
	...
	visual_button(2,257,50,16,vfh[8],27,28,_Context->msg_Yadjust[_Context->language],strlen(_Context->msg_Yadjust[_Context->language]),0);
	visual_frame(2,274,48+2,16+2,5);
	visual_text(2+1,274+1,48,16,vfh[1],0,0,_Context->buffer_ByY,6,3);
	...
	visual_button(2,293,50,16,vfh[8],27,28,_Context->msg_Zadjust[_Context->language],strlen(_Context->msg_Zadjust[_Context->language]),0);
	visual_frame(2,310,48+2,16+2,5);
	visual_text(2+1,310+1,48,16,vfh[1],0,0,_Context->buffer_ByZ,6,3);
	visual_image(2,78,16,20,_Context->msg_MoveLeft[_Context->language],0);
	visual_image(34,78,16,20,_Context->msg_MoveRight[_Context->language],0);
	visual_image(35,360,20,20,_Context->msg_FocusRight[_Context->language],0);
	visual_image(3,360,20,20,_Context->msg_FocusLeft[_Context->language],0);
	visual_image(19,344,20,20,_Context->msg_FocusUp[_Context->language],0);
	visual_image(19,376,20,20,_Context->msg_FocusDown[_Context->language],0);
	visual_image(18,62,16,20,_Context->msg_MoveUp[_Context->language],0);
	visual_image(18,78,16,20,_Context->msg_MoveInOut[_Context->language],0);
	visual_image(18,94,16,20,_Context->msg_MoveDown[_Context->language],0);
	visual_image(19,360,16,20,_Context->msg_FocusZero[_Context->language],0);
	visual_text(0,124,56,16,vfh[2],0,0,_Context->msg_Auto633[_Context->language],strlen(_Context->msg_Auto633[_Context->language]),1283);
...
private int on_MoveLeft_event(struct visual_3d_cursor_context * _Context) {
	_Context->x_GridIcon=2;
	_Context->y_GridIcon=78;
	if(visual_event(2)==1)
...
private int on_MoveUp_event(struct visual_3d_cursor_context * _Context) {
	_Context->x_GridIcon=18;
	_Context->y_GridIcon=62;
	if(visual_event(2)==1)
...
struct visual_3d_cursor_context * _Context){
	...
	if (visual_event(1) & _MIMO_ALT) {
		...
		if (visual_event(1) & _MIMO_DOWN) {
			_Context->trigger_AddView=visual_trigger_code(_Context->msg_AddView[_Context->language],strlen(_Context->msg_AddView[_Context->language]));
			visual_button(2,411,24,16,vfh[8],27,28,_Context->msg_AddView[_Context->language],strlen(_Context->msg_AddView[_Context->language]),2);
			}
	...
	visual_button(2,411,24,16,vfh[8],27,28,_Context->msg_AddView[_Context->language],strlen(_Context->msg_AddView[_Context->language]),0);
		...
		if (visual_event(1) & _MIMO_DOWN) {
			_Context->trigger_SzlView=visual_trigger_code(_Context->msg_SzlView[_Context->language],strlen(_Context->msg_SzlView[_Context->language]));
			visual_button(28,411,24,16,vfh[8],27,28,_Context->msg_SzlView[_Context->language],strlen(_Context->msg_SzlView[_Context->language]),2);
			}
		else if (visual_event(1) & _MIMO_UP) {
			_Context->trigger_SzlView=visual_trigger_code(_Context->msg_SzlView[_Context->language],strlen(_Context->msg_SzlView[_Context->language]));
	visual_button(28,411,24,16,vfh[8],27,28,_Context->msg_SzlView[_Context->language],strlen(_Context->msg_SzlView[_Context->language]),0);
		...
		if (visual_event(1) & _MIMO_DOWN) {
			_Context->trigger_Xadjust=visual_trigger_code(_Context->msg_Xadjust[_Context->language],strlen(_Context->msg_Xadjust[_Context->language]));
			visual_button(2,221,50,16,vfh[8],27,28,_Context->msg_Xadjust[_Context->language],strlen(_Context->msg_Xadjust[_Context->language]),2);
			}
		else if (visual_event(1) & _MIMO_UP) {
			_Context->trigger_Xadjust=visual_trigger_code(_Context->msg_Xadjust[_Context->language],strlen(_Context->msg_Xadjust[_Context->language]));
	visual_button(2,221,50,16,vfh[8],27,28,_Context->msg_Xadjust[_Context->language],strlen(_Context->msg_Xadjust[_Context->language]),0);
		...
		if (visual_event(1) & _MIMO_DOWN) {
			_Context->trigger_Yadjust=visual_trigger_code(_Context->msg_Yadjust[_Context->language],strlen(_Context->msg_Yadjust[_Context->language]));
			visual_button(2,257,50,16,vfh[8],27,28,_Context->msg_Yadjust[_Context->language],strlen(_Context->msg_Yadjust[_Context->language]),2);
			}
		else if (visual_event(1) & _MIMO_UP) {
			_Context->trigger_Yadjust=visual_trigger_code(_Context->msg_Yadjust[_Context->language],strlen(_Context->msg_Yadjust[_Context->language]));
	visual_button(2,257,50,16,vfh[8],27,28,_Context->msg_Yadjust[_Context->language],strlen(_Context->msg_Yadjust[_Context->language]),0);
		...
		if (visual_event(1) & _MIMO_DOWN) {
			_Context->trigger_Zadjust=visual_trigger_code(_Context->msg_Zadjust[_Context->language],strlen(_Context->msg_Zadjust[_Context->language]));
			visual_button(2,293,50,16,vfh[8],27,28,_Context->msg_Zadjust[_Context->language],strlen(_Context->msg_Zadjust[_Context->language]),2);
			}
		else if (visual_event(1) & _MIMO_UP) {
			_Context->trigger_Zadjust=visual_trigger_code(_Context->msg_Zadjust[_Context->language],strlen(_Context->msg_Zadjust[_Context->language]));
	visual_button(2,293,50,16,vfh[8],27,28,_Context->msg_Zadjust[_Context->language],strlen(_Context->msg_Zadjust[_Context->language]),0);
...
public	int	visual_3d_cursor_focus(struct visual_3d_cursor_context * _Context)
{
	...
	visual_button(2,293,50,16,vfh[8],27,28,_Context->msg_Zadjust[_Context->language],strlen(_Context->msg_Zadjust[_Context->language]),0);
			...
			case	0x8 :
				/* FocusRight */
				if ((_Context->keycode = on_FocusRight_getfocus(_Context)) != -1) break;
				break;
			case	0x9 :
				/* FocusLeft */
				if ((_Context->keycode = on_FocusLeft_getfocus(_Context)) != -1) break;
				break;
			case	0xa :
				/* FocusUp */
				if ((_Context->keycode = on_FocusUp_getfocus(_Context)) != -1) break;
				break;
			case	0xb :
				/* FocusDown */
				if ((_Context->keycode = on_FocusDown_getfocus(_Context)) != -1) break;
				break;
			case	0xc :
				/* MoveUp */
			...
			case	0x10 :
				/* FocusZero */
				if ((_Context->keycode = on_FocusZero_getfocus(_Context)) != -1) break;
				break;
