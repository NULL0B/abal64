...
#define en_FileName   ""
#define en_Auto2758   "ok.gif"
#define fr_Auto2758   "ok.gif"
#define it_Auto2758   "ok.gif"
#define es_Auto2758   "ok.gif"
#define de_Auto2758   "ok.gif"
#define nl_Auto2758   "ok.gif"
#define pt_Auto2758   "ok.gif"
#define xx_Auto2758   "ok.gif"
#define en_Auto2759   "cancel.gif"
#define fr_Auto2759   "cancel.gif"
#define it_Auto2759   "cancel.gif"
#define es_Auto2759   "cancel.gif"
#define de_Auto2759   "cancel.gif"
#define nl_Auto2759   "cancel.gif"
#define pt_Auto2759   "cancel.gif"
#define xx_Auto2759   "cancel.gif"
...
public	int	accept_form_save_show(struct accept_form_save_context * _Context)
{
	...
	_Context->trigger_Auto2758=visual_trigger_code(_Context->msg_Auto2758[_Context->language],strlen(_Context->msg_Auto2758[_Context->language]));
	visual_button(_Context->x_auto2+20,_Context->y_auto2+110,56,48,vfh[2],34,0,_Context->msg_Auto2758[_Context->language],strlen(_Context->msg_Auto2758[_Context->language]),1040);
	...
	visual_button(_Context->x_auto2+520,_Context->y_auto2+110,56,48,vfh[2],34,0,_Context->msg_Auto2759[_Context->language],strlen(_Context->msg_Auto2759[_Context->language]),1040);
...
private int on_Auto2758_event(struct accept_form_save_context * _Context) {
	return(13);
	return(-1);
}
private int on_Auto2759_event(struct accept_form_save_context * _Context) {
	return(27);
	return(-1);
}
...
struct accept_form_save_context * _Context){
	...
	if (visual_event(1) & _MIMO_ALT) {
		...
		if (_Context->trigger_Auto2758 == mb ) return(3);
		if (_Context->trigger_Auto2759 == mb ) return(4);
...
public	int	accept_form_save_focus(struct accept_form_save_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			...
			case	0x3 :
				/* Auto2758 */
				_Context->trigger_Auto2758=visual_trigger_code(_Context->msg_Auto2758[_Context->language],strlen(_Context->msg_Auto2758[_Context->language]));
				visual_button(_Context->x_auto2+20,_Context->y_auto2+110,56,48,vfh[2],34,0,_Context->msg_Auto2758[_Context->language],strlen(_Context->msg_Auto2758[_Context->language]),1042);
	...
	visual_button(_Context->x_auto2+20,_Context->y_auto2+110,56,48,vfh[2],34,0,_Context->msg_Auto2758[_Context->language],strlen(_Context->msg_Auto2758[_Context->language]),1040);
			...
			case	0x4 :
				/* Auto2759 */
				_Context->trigger_Auto2759=visual_trigger_code(_Context->msg_Auto2759[_Context->language],strlen(_Context->msg_Auto2759[_Context->language]));
				visual_button(_Context->x_auto2+520,_Context->y_auto2+110,56,48,vfh[2],34,0,_Context->msg_Auto2759[_Context->language],strlen(_Context->msg_Auto2759[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto2759=visual_trigger_code(_Context->msg_Auto2759[_Context->language],strlen(_Context->msg_Auto2759[_Context->language]));
	visual_button(_Context->x_auto2+520,_Context->y_auto2+110,56,48,vfh[2],34,0,_Context->msg_Auto2759[_Context->language],strlen(_Context->msg_Auto2759[_Context->language]),1040);
				break;
...
retry:
		...
		case	0x100 :
			...
			if (( visual_event(1) == _MIMO_DOWN ) && ( visual_event(2) == _MIMO_RIGHT)) {
				switch ((_Context->focus_item = retcode)) {
					...
					case	0x3 :
						if (Auto2758_help(_Context) != 0) { continue; }
						else { break; }
					case	0x4 :
	...
	visual_button(_Context->x_auto2+20,_Context->y_auto2+110,56,48,vfh[2],34,0,_Context->msg_Auto2758[_Context->language],strlen(_Context->msg_Auto2758[_Context->language]),1040);
					...
					if ((_Context->keycode = on_Auto2758_event(_Context)) != -1) break;
