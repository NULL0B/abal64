...
#ifdef	ABALCPP 
public 	char 	LaPaterne[20] = { '*','P','R','L','@','I','N','F','O','*','#',6,'2','1','b','0','2','3',0 };
public 	char 	StringPaterne[20] = { '*','P','R','L','@','I','N','F','O','*','$','6','2','1','b','0','2','3',0 };
#else
#ifdef	ABAL32A
public 	char 	LaPaterne[20] = { '*','P','R','L','@','I','N','F','O','*','#',6,'2','1','a','0','3','7',0 };
public 	char 	StringPaterne[20] = { '*','P','R','L','@','I','N','F','O','*','$','6','2','1','a','0','3','7',0 };
#else
public 	char 	LaPaterne[20] = { '*','P','R','L','@','I','N','F','O','*','#',6,'1','1','e','0','3','7',0 };
public 	char 	StringPaterne[20] = { '*','P','R','L','@','I','N','F','O','*','$','6','1','1','e','0','3','7',0 };
#endif
#endif
...
private	int	banner()
{
	...
	iVer += sprintf(&bufVer[iVer],"\n   Copyright (c) 2001,2008 Amenesik / Sologic ");
