...
/* Project        : vdomain.xml                                              */
/* Target         : vdomain.c                                                */
/* Identification : 0.0-1196380801-4697.4696                                 */
/* ------------------------------------------------------------------------- */
...
#define en_Auto3321   "Selection by"
#define fr_Auto3321   "Nom de domain"
#define it_Auto3321   "Domain / Prefix"
#define es_Auto3321   "Domain / Prefix"
#define de_Auto3321   "Domain / Prefix"
#define nl_Auto3321   "Domain / Prefix"
#define pt_Auto3321   "Domain / Prefix"
#define xx_Auto3321   "Domain / Prefix"
#define en__Auto3321   ""
#define fr__Auto3321   ""
#define it__Auto3321   ""
#define es__Auto3321   ""
...
#define pt__Auto3321   ""
#define xx__Auto3321   ""
#define en_Auto3322   "Domain or File"
#define fr_Auto3322   "Nom de domain"
#define it_Auto3322   "Domain / Prefix"
#define es_Auto3322   "Domain / Prefix"
#define de_Auto3322   "Domain / Prefix"
#define nl_Auto3322   "Domain / Prefix"
#define pt_Auto3322   "Domain / Prefix"
#define xx_Auto3322   "Domain / Prefix"
#define en__Auto3322   ""
#define fr__Auto3322   ""
#define it__Auto3322   ""
#define es__Auto3322   ""
	...
	char * pDomainName)
{
	...
	_Context->x_Auto3320=105;
	_Context->y_Auto3320=205;
	_Context->w_Auto3320=590;
	_Context->h_Auto3320=190;
...
public	int	accept_css_domain_show(struct accept_css_domain_context * _Context)
{
	...
	visual_text(125,325,112,16,vfh[2],16,0,_Context->msg_Auto3321[_Context->language],strlen(_Context->msg_Auto3321[_Context->language]),258);
	visual_text(125,295,112,16,vfh[2],16,0,_Context->msg_Auto3322[_Context->language],strlen(_Context->msg_Auto3322[_Context->language]),258);
...
private int Auto3320action(struct accept_css_domain_context * _Context) {
	...
	do {
		...
		_Context->x_Auto3320 += (visual_event(7)-x);
		x=visual_event(7);
		if (_Context->x_Auto3320 < 0) { _Context->x_Auto3320=0; }
		_Context->y_Auto3320 += (visual_event(6)-y);
		y=visual_event(6);
		if (_Context->y_Auto3320 < 0) { _Context->y_Auto3320=0; }
...
struct accept_css_domain_context * _Context){
	...
	case _MIMO_DOWN :
		...
		&&  (mx <= (105+522) )  
		&&  (my <= (205+20) )) {
			return( Auto3320action(_Context) );
			}
		}
	if ((mx >= 245 ) 
	&&  (my >= 325 ) 
