...
#define pt__Auto2733   ""
#define xx__Auto2733   ""
#define en_Auto2734   "Widget Gridlock Parameters"
#define fr_Auto2734   "Alignement des Widgets"
#define it_Auto2734   "Widget Gridlock Parameters"
#define es_Auto2734   "Widget Gridlock Parameters"
#define de_Auto2734   "Widget Gridlock Parameters"
#define nl_Auto2734   "Widget Gridlock Parameters"
#define pt_Auto2734   "Widget Gridlock Parameters"
#define xx_Auto2734   "Widget Gridlock Parameters"
#define en__Auto2734   ""
#define fr__Auto2734   ""
#define it__Auto2734   ""
#define es__Auto2734   ""
...
#define pt__Auto2734   ""
#define xx__Auto2734   ""
#define en_Auto2735   "Forms editor widget font/grid lock configuration"
#define fr_Auto2735   "Configuration de l'alignement automatique des widgets"
#define it_Auto2735   "Forms editor widget font/grid lock configuration"
#define es_Auto2735   "Forms editor widget font/grid lock configuration"
#define de_Auto2735   "Forms editor widget font/grid lock configuration"
#define nl_Auto2735   "Forms editor widget font/grid lock configuration"
#define pt_Auto2735   "Forms editor widget font/grid lock configuration"
#define xx_Auto2735   "Forms editor widget font/grid lock configuration"
#define en__Auto2735   ""
#define fr__Auto2735   ""
#define it__Auto2735   ""
#define es__Auto2735   ""
...
public	int	accept_widget_gridlock_create(struct accept_widget_gridlock_context **cptr)
{
	...
	_Context->hint_Auto2733[0]=en__Auto2733;
	_Context->hint_Auto2733[1]=fr__Auto2733;
	_Context->hint_Auto2733[2]=it__Auto2733;
	_Context->hint_Auto2733[3]=es__Auto2733;
	_Context->hint_Auto2733[4]=de__Auto2733;
	_Context->hint_Auto2733[5]=nl__Auto2733;
	_Context->hint_Auto2733[6]=pt__Auto2733;
	_Context->hint_Auto2733[7]=xx__Auto2733;
	_Context->x_Auto2733=125;
	_Context->y_Auto2733=65;
	_Context->w_Auto2733=550;
	_Context->h_Auto2733=470;
	...
	_Context->pushbuffer=visual_buffer(_Context->x_Auto2733,_Context->y_Auto2733,550+10,470+10);
	return(0);
}
...
public 	int	accept_widget_gridlock_hide(struct accept_widget_gridlock_context * _Context)
{
	...
	&& (_Context->ctrlbuffer != 0)) {
		(void)visual_buffer_put(_Context->pushbuffer,_Context->x_Auto2733,_Context->y_Auto2733);
		_Context->ctrlbuffer=0;
		}
...
public	int	accept_widget_gridlock_show(struct accept_widget_gridlock_context * _Context)
{
	...
	if ((_Context->pushbuffer != (void *) 0)
	&& (!(_Context->ctrlbuffer))) {
		(void)visual_buffer_get(_Context->pushbuffer,_Context->x_Auto2733,_Context->y_Auto2733);
		_Context->ctrlbuffer=1;
		}
	visual_freeze();
	if (((_Context->status = visual_styled_element(_Context->x_Auto2733,_Context->y_Auto2733,550,470,GetWidgetStyle(0),GetWindowVersion(),strlen(GetWindowVersion()))) != 0)
) {
		visual_window(_Context->x_Auto2733,_Context->y_Auto2733,550,470,vfh[2],GetWindowVersion(),strlen(GetWindowVersion()),0x407);
		}
	visual_text(_Context->x_Auto2733+20,_Context->y_Auto2733+20,506,40,vfh[3],16,0,_Context->msg_Auto2734[_Context->language],strlen(_Context->msg_Auto2734[_Context->language]),1283);
	visual_text(_Context->x_Auto2733+20,_Context->y_Auto2733+60,510,16,vfh[2],16,0,_Context->msg_Auto2735[_Context->language],strlen(_Context->msg_Auto2735[_Context->language]),259);
	visual_frame(_Context->x_Auto2733+20,_Context->y_Auto2733+76,510,324,4);
	visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+90,40,128,vfh[1],27,28,parse_selection(_Context->msg_wfill[_Context->language],&_Context->value_wfill),0);
	...
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+90,182,16,vfh[2],27,28,_Context->msg_cfill[_Context->language],strlen(_Context->msg_cfill[_Context->language]),_Context->value_cfill|0);
	visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+120,40,128,vfh[1],27,28,parse_selection(_Context->msg_woutset[_Context->language],&_Context->value_woutset),0);
	...
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+120,182,16,vfh[2],27,28,_Context->msg_coutset[_Context->language],strlen(_Context->msg_coutset[_Context->language]),_Context->value_coutset|0);
	visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+150,40,128,vfh[1],27,28,parse_selection(_Context->msg_winset[_Context->language],&_Context->value_winset),0);
	...
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+150,182,16,vfh[2],27,28,_Context->msg_cinset[_Context->language],strlen(_Context->msg_cinset[_Context->language]),_Context->value_cinset|0);
	visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+180,40,128,vfh[1],27,28,parse_selection(_Context->msg_wridge[_Context->language],&_Context->value_wridge),0);
	...
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+180,182,16,vfh[2],27,28,_Context->msg_cridge[_Context->language],strlen(_Context->msg_cridge[_Context->language]),_Context->value_cridge|0);
	visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+210,40,128,vfh[1],27,28,parse_selection(_Context->msg_wgroove[_Context->language],&_Context->value_wgroove),0);
	...
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+210,182,16,vfh[2],27,28,_Context->msg_cgroove[_Context->language],strlen(_Context->msg_cgroove[_Context->language]),_Context->value_cgroove|0);
	visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+240,40,128,vfh[1],27,28,parse_selection(_Context->msg_wedit[_Context->language],&_Context->value_wedit),0);
	...
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+240,182,16,vfh[2],27,28,_Context->msg_cedit[_Context->language],strlen(_Context->msg_cedit[_Context->language]),_Context->value_cedit|0);
	visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+270,40,128,vfh[1],27,28,parse_selection(_Context->msg_wtext[_Context->language],&_Context->value_wtext),0);
	...
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+270,182,16,vfh[2],27,28,_Context->msg_ctext[_Context->language],strlen(_Context->msg_ctext[_Context->language]),_Context->value_ctext|0);
	visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+300,40,128,vfh[1],27,28,parse_selection(_Context->msg_wimage[_Context->language],&_Context->value_wimage),0);
	...
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+300,182,16,vfh[2],27,28,_Context->msg_cimage[_Context->language],strlen(_Context->msg_cimage[_Context->language]),_Context->value_cimage|0);
	visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+330,40,128,vfh[1],27,28,parse_selection(_Context->msg_wline[_Context->language],&_Context->value_wline),0);
	...
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+330,182,16,vfh[2],27,28,_Context->msg_cline[_Context->language],strlen(_Context->msg_cline[_Context->language]),_Context->value_cline|0);
	visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+360,40,128,vfh[1],27,28,parse_selection(_Context->msg_wpush[_Context->language],&_Context->value_wpush),0);
	...
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+360,168,16,vfh[2],27,28,_Context->msg_cpush[_Context->language],strlen(_Context->msg_cpush[_Context->language]),_Context->value_cpush|0);
	visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+90,40,128,vfh[1],27,28,parse_selection(_Context->msg_wwindow[_Context->language],&_Context->value_wwindow),0);
	...
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+90,154,16,vfh[2],27,28,_Context->msg_cwindow[_Context->language],strlen(_Context->msg_cwindow[_Context->language]),_Context->value_cwindow|0);
	visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+120,40,128,vfh[1],27,28,parse_selection(_Context->msg_wtab[_Context->language],&_Context->value_wtab),0);
	_Context->trigger_ctab=visual_trigger_code(_Context->msg_ctab[_Context->language],strlen(_Context->msg_ctab[_Context->language]));
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+120,168,16,vfh[2],27,28,_Context->msg_ctab[_Context->language],strlen(_Context->msg_ctab[_Context->language]),_Context->value_ctab|0);
	visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+150,40,128,vfh[1],27,28,parse_selection(_Context->msg_wcheck[_Context->language],&_Context->value_wcheck),0);
	...
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+150,168,16,vfh[2],27,28,_Context->msg_ccheck[_Context->language],strlen(_Context->msg_ccheck[_Context->language]),_Context->value_ccheck|0);
	visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+180,40,128,vfh[1],27,28,parse_selection(_Context->msg_wradio[_Context->language],&_Context->value_wradio),0);
	...
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+180,168,16,vfh[2],27,28,_Context->msg_cradio[_Context->language],strlen(_Context->msg_cradio[_Context->language]),_Context->value_cradio|0);
	visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+210,40,128,vfh[1],27,28,parse_selection(_Context->msg_wselect[_Context->language],&_Context->value_wselect),0);
	...
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+210,168,16,vfh[2],27,28,_Context->msg_cselect[_Context->language],strlen(_Context->msg_cselect[_Context->language]),_Context->value_cselect|0);
	visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+240,40,128,vfh[1],27,28,parse_selection(_Context->msg_wtable[_Context->language],&_Context->value_wtable),0);
	...
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+240,168,16,vfh[2],27,28,_Context->msg_ctable[_Context->language],strlen(_Context->msg_ctable[_Context->language]),_Context->value_ctable|0);
	visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+270,40,128,vfh[1],27,28,parse_selection(_Context->msg_wscroll[_Context->language],&_Context->value_wscroll),0);
	...
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+270,168,16,vfh[2],27,28,_Context->msg_cscroll[_Context->language],strlen(_Context->msg_cscroll[_Context->language]),_Context->value_cscroll|0);
	visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+300,40,128,vfh[1],27,28,parse_selection(_Context->msg_wprogress[_Context->language],&_Context->value_wprogress),0);
	...
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+300,168,16,vfh[2],27,28,_Context->msg_cprogress[_Context->language],strlen(_Context->msg_cprogress[_Context->language]),_Context->value_cprogress|0);
	visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+330,40,128,vfh[1],27,28,parse_selection(_Context->msg_wswitch[_Context->language],&_Context->value_wswitch),0);
	...
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+330,168,16,vfh[2],27,28,_Context->msg_cswitch[_Context->language],strlen(_Context->msg_cswitch[_Context->language]),_Context->value_cswitch|0);
	visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+360,40,128,vfh[1],27,28,parse_selection(_Context->msg_wgraph[_Context->language],&_Context->value_wgraph),0);
	...
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+360,154,16,vfh[2],27,28,_Context->msg_cgraph[_Context->language],strlen(_Context->msg_cgraph[_Context->language]),_Context->value_cgraph|0);
	_Context->trigger_Accept=visual_trigger_code(_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]));
	visual_button(_Context->x_Auto2733+20,_Context->y_Auto2733+410,56,48,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),1040);
	_Context->trigger_Cancel=visual_trigger_code(_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]));
	visual_button(_Context->x_Auto2733+470,_Context->y_Auto2733+410,56,48,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),1040);
	visual_thaw(_Context->x_Auto2733,_Context->y_Auto2733,550,470);

	return(0);
}

private int Auto2733action(struct accept_widget_gridlock_context * _Context) {
	...
	do {
		...
		_Context->x_Auto2733 += (visual_event(7)-x);
		x=visual_event(7);
		if (_Context->x_Auto2733 < 0) { _Context->x_Auto2733=0; }
		_Context->y_Auto2733 += (visual_event(6)-y);
		y=visual_event(6);
		if (_Context->y_Auto2733 < 0) { _Context->y_Auto2733=0; }
...
struct accept_widget_gridlock_context * _Context){
	...
	switch (mt) {
	case _MIMO_UP :
	if ((mx >= (_Context->x_Auto2733+529) )  
	&&  (my >= (_Context->y_Auto2733+4) )  
	&&  (mx <= (_Context->x_Auto2733+546) )  
	&&  (my <= (_Context->y_Auto2733+20) )) {
		return(1);	/* Auto2733 */

		}
	if ((mx >= (_Context->x_Auto2733+513) )  
	&&  (my >= (_Context->y_Auto2733+4) )  
	&&  (mx <= (_Context->x_Auto2733+530) )  
	&&  (my <= (_Context->y_Auto2733+20) )) {
	...
	if ((mx >= (_Context->x_Auto2733+497) )  
	&&  (my >= (_Context->y_Auto2733+4) )  
	&&  (mx <= (_Context->x_Auto2733+514) )  
	&&  (my <= (_Context->y_Auto2733+20) )) {
	...
	case _MIMO_DOWN :
		if ((mx >= (_Context->x_Auto2733+4) )  
		&&  (my >= (_Context->y_Auto2733+4) )  
		&&  (mx <= (_Context->x_Auto2733+482) )  
		&&  (my <= (_Context->y_Auto2733+20) )) {
			return( Auto2733action(_Context) );
			}
		}
	if (( mx >= (_Context->x_Auto2733+50+0) ) 
	&&  ( my >= (_Context->y_Auto2733+90) ) 
	&&  ( mx <= (_Context->x_Auto2733+50+40) ) 
	&&  ( my <= (_Context->y_Auto2733+90+16))) {
		return(2); /* wfill */
		}
	if (( mx >= (_Context->x_Auto2733+100) ) 
	&&  ( my >= (_Context->y_Auto2733+90) ) 
	&&  ( mx <= (_Context->x_Auto2733+100+182) ) 
	&&  ( my <= (_Context->y_Auto2733+90+16))) {
		return(3); /* cfill */
		}
	if (( mx >= (_Context->x_Auto2733+50+0) ) 
	&&  ( my >= (_Context->y_Auto2733+120) ) 
	&&  ( mx <= (_Context->x_Auto2733+50+40) ) 
	&&  ( my <= (_Context->y_Auto2733+120+16))) {
		return(4); /* woutset */
		}
	if (( mx >= (_Context->x_Auto2733+100) ) 
	&&  ( my >= (_Context->y_Auto2733+120) ) 
	...
	if (( mx >= (_Context->x_Auto2733+50+0) ) 
	&&  ( my >= (_Context->y_Auto2733+150) ) 
	&&  ( mx <= (_Context->x_Auto2733+50+40) ) 
	&&  ( my <= (_Context->y_Auto2733+150+16))) {
		return(6); /* winset */
		}
	if (( mx >= (_Context->x_Auto2733+100) ) 
	&&  ( my >= (_Context->y_Auto2733+150) ) 
	...
	if (( mx >= (_Context->x_Auto2733+50+0) ) 
	&&  ( my >= (_Context->y_Auto2733+180) ) 
	&&  ( mx <= (_Context->x_Auto2733+50+40) ) 
	&&  ( my <= (_Context->y_Auto2733+180+16))) {
		return(8); /* wridge */
		}
	if (( mx >= (_Context->x_Auto2733+100) ) 
	&&  ( my >= (_Context->y_Auto2733+180) ) 
	...
	if (( mx >= (_Context->x_Auto2733+50+0) ) 
	&&  ( my >= (_Context->y_Auto2733+210) ) 
	&&  ( mx <= (_Context->x_Auto2733+50+40) ) 
	&&  ( my <= (_Context->y_Auto2733+210+16))) {
		return(10); /* wgroove */
		}
	if (( mx >= (_Context->x_Auto2733+100) ) 
	&&  ( my >= (_Context->y_Auto2733+210) ) 
	...
	if (( mx >= (_Context->x_Auto2733+50+0) ) 
	&&  ( my >= (_Context->y_Auto2733+240) ) 
	&&  ( mx <= (_Context->x_Auto2733+50+40) ) 
	&&  ( my <= (_Context->y_Auto2733+240+16))) {
		return(12); /* wedit */
		}
	if (( mx >= (_Context->x_Auto2733+100) ) 
	&&  ( my >= (_Context->y_Auto2733+240) ) 
	...
	if (( mx >= (_Context->x_Auto2733+50+0) ) 
	&&  ( my >= (_Context->y_Auto2733+270) ) 
	&&  ( mx <= (_Context->x_Auto2733+50+40) ) 
	&&  ( my <= (_Context->y_Auto2733+270+16))) {
		return(14); /* wtext */
		}
	if (( mx >= (_Context->x_Auto2733+100) ) 
	&&  ( my >= (_Context->y_Auto2733+270) ) 
	...
	if (( mx >= (_Context->x_Auto2733+50+0) ) 
	&&  ( my >= (_Context->y_Auto2733+300) ) 
	&&  ( mx <= (_Context->x_Auto2733+50+40) ) 
	&&  ( my <= (_Context->y_Auto2733+300+16))) {
		return(16); /* wimage */
		}
	if (( mx >= (_Context->x_Auto2733+100) ) 
	&&  ( my >= (_Context->y_Auto2733+300) ) 
	...
	if (( mx >= (_Context->x_Auto2733+50+0) ) 
	&&  ( my >= (_Context->y_Auto2733+330) ) 
	&&  ( mx <= (_Context->x_Auto2733+50+40) ) 
	&&  ( my <= (_Context->y_Auto2733+330+16))) {
		return(18); /* wline */
		}
	if (( mx >= (_Context->x_Auto2733+100) ) 
	&&  ( my >= (_Context->y_Auto2733+330) ) 
	...
	if (( mx >= (_Context->x_Auto2733+50+0) ) 
	&&  ( my >= (_Context->y_Auto2733+360) ) 
	&&  ( mx <= (_Context->x_Auto2733+50+40) ) 
	&&  ( my <= (_Context->y_Auto2733+360+16))) {
		return(20); /* wpush */
		}
	if (( mx >= (_Context->x_Auto2733+100) ) 
	&&  ( my >= (_Context->y_Auto2733+360) ) 
	&&  ( mx <= (_Context->x_Auto2733+100+168) ) 
	&&  ( my <= (_Context->y_Auto2733+360+16))) {
		return(21); /* cpush */
		}
	if (( mx >= (_Context->x_Auto2733+310+0) ) 
	&&  ( my >= (_Context->y_Auto2733+90) ) 
	&&  ( mx <= (_Context->x_Auto2733+310+40) ) 
	&&  ( my <= (_Context->y_Auto2733+90+16))) {
		return(22); /* wwindow */
		}
	if (( mx >= (_Context->x_Auto2733+360) ) 
	&&  ( my >= (_Context->y_Auto2733+90) ) 
	&&  ( mx <= (_Context->x_Auto2733+360+154) ) 
	&&  ( my <= (_Context->y_Auto2733+90+16))) {
		return(23); /* cwindow */
		}
	if (( mx >= (_Context->x_Auto2733+310+0) ) 
	...
	if (( mx >= (_Context->x_Auto2733+360) ) 
	&&  ( my >= (_Context->y_Auto2733+120) ) 
	&&  ( mx <= (_Context->x_Auto2733+360+168) ) 
	&&  ( my <= (_Context->y_Auto2733+120+16))) {
		return(25); /* ctab */
		}
	if (( mx >= (_Context->x_Auto2733+310+0) ) 
	...
	if (( mx >= (_Context->x_Auto2733+20) ) 
	&&  ( my >= (_Context->y_Auto2733+410) ) 
	&&  ( mx <= (_Context->x_Auto2733+20+56) ) 
	&&  ( my <= (_Context->y_Auto2733+410+48))) {
		return(42); /* Accept */
		}
	if (( mx >= (_Context->x_Auto2733+470) ) 
	&&  ( my >= (_Context->y_Auto2733+410) ) 
	&&  ( mx <= (_Context->x_Auto2733+470+56) ) 
	&&  ( my <= (_Context->y_Auto2733+410+48))) {
		return(43); /* Cancel */
		}
...
public	int	accept_widget_gridlock_focus(struct accept_widget_gridlock_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			...
			case	0x2 :
				/* wfill */
				_Context->keycode = visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+90,40,128,vfh[1],27,28,parse_selection(_Context->msg_wfill[_Context->language],&_Context->value_wfill),2);
				break;
			case	0x3 :
				/* cfill */
				visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+90,182,16,vfh[2],27,28,_Context->msg_cfill[_Context->language],strlen(_Context->msg_cfill[_Context->language]),(_Context->value_cfill |2));
				_Context->keycode = visual_getch();
				_Context->trigger_cfill=visual_trigger_code(_Context->msg_cfill[_Context->language],strlen(_Context->msg_cfill[_Context->language]));
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+90,182,16,vfh[2],27,28,_Context->msg_cfill[_Context->language],strlen(_Context->msg_cfill[_Context->language]),_Context->value_cfill|0);
				break;
			case	0x4 :
				/* woutset */
				_Context->keycode = visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+120,40,128,vfh[1],27,28,parse_selection(_Context->msg_woutset[_Context->language],&_Context->value_woutset),2);
				break;
			case	0x5 :
				/* coutset */
				visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+120,182,16,vfh[2],27,28,_Context->msg_coutset[_Context->language],strlen(_Context->msg_coutset[_Context->language]),(_Context->value_coutset |2));
				_Context->keycode = visual_getch();
				_Context->trigger_coutset=visual_trigger_code(_Context->msg_coutset[_Context->language],strlen(_Context->msg_coutset[_Context->language]));
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+120,182,16,vfh[2],27,28,_Context->msg_coutset[_Context->language],strlen(_Context->msg_coutset[_Context->language]),_Context->value_coutset|0);
				break;
			case	0x6 :
				/* winset */
				_Context->keycode = visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+150,40,128,vfh[1],27,28,parse_selection(_Context->msg_winset[_Context->language],&_Context->value_winset),2);
				break;
			case	0x7 :
				/* cinset */
				visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+150,182,16,vfh[2],27,28,_Context->msg_cinset[_Context->language],strlen(_Context->msg_cinset[_Context->language]),(_Context->value_cinset |2));
				_Context->keycode = visual_getch();
				_Context->trigger_cinset=visual_trigger_code(_Context->msg_cinset[_Context->language],strlen(_Context->msg_cinset[_Context->language]));
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+150,182,16,vfh[2],27,28,_Context->msg_cinset[_Context->language],strlen(_Context->msg_cinset[_Context->language]),_Context->value_cinset|0);
				break;
			case	0x8 :
				/* wridge */
				_Context->keycode = visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+180,40,128,vfh[1],27,28,parse_selection(_Context->msg_wridge[_Context->language],&_Context->value_wridge),2);
				break;
			case	0x9 :
				/* cridge */
				visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+180,182,16,vfh[2],27,28,_Context->msg_cridge[_Context->language],strlen(_Context->msg_cridge[_Context->language]),(_Context->value_cridge |2));
				_Context->keycode = visual_getch();
				_Context->trigger_cridge=visual_trigger_code(_Context->msg_cridge[_Context->language],strlen(_Context->msg_cridge[_Context->language]));
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+180,182,16,vfh[2],27,28,_Context->msg_cridge[_Context->language],strlen(_Context->msg_cridge[_Context->language]),_Context->value_cridge|0);
				break;
			case	0xa :
				/* wgroove */
				_Context->keycode = visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+210,40,128,vfh[1],27,28,parse_selection(_Context->msg_wgroove[_Context->language],&_Context->value_wgroove),2);
				break;
			case	0xb :
				/* cgroove */
				visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+210,182,16,vfh[2],27,28,_Context->msg_cgroove[_Context->language],strlen(_Context->msg_cgroove[_Context->language]),(_Context->value_cgroove |2));
				_Context->keycode = visual_getch();
				_Context->trigger_cgroove=visual_trigger_code(_Context->msg_cgroove[_Context->language],strlen(_Context->msg_cgroove[_Context->language]));
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+210,182,16,vfh[2],27,28,_Context->msg_cgroove[_Context->language],strlen(_Context->msg_cgroove[_Context->language]),_Context->value_cgroove|0);
				break;
			case	0xc :
				/* wedit */
				_Context->keycode = visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+240,40,128,vfh[1],27,28,parse_selection(_Context->msg_wedit[_Context->language],&_Context->value_wedit),2);
				break;
			case	0xd :
				/* cedit */
				visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+240,182,16,vfh[2],27,28,_Context->msg_cedit[_Context->language],strlen(_Context->msg_cedit[_Context->language]),(_Context->value_cedit |2));
				_Context->keycode = visual_getch();
				_Context->trigger_cedit=visual_trigger_code(_Context->msg_cedit[_Context->language],strlen(_Context->msg_cedit[_Context->language]));
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+240,182,16,vfh[2],27,28,_Context->msg_cedit[_Context->language],strlen(_Context->msg_cedit[_Context->language]),_Context->value_cedit|0);
				break;
			case	0xe :
				/* wtext */
				_Context->keycode = visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+270,40,128,vfh[1],27,28,parse_selection(_Context->msg_wtext[_Context->language],&_Context->value_wtext),2);
				break;
			case	0xf :
				/* ctext */
				visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+270,182,16,vfh[2],27,28,_Context->msg_ctext[_Context->language],strlen(_Context->msg_ctext[_Context->language]),(_Context->value_ctext |2));
				_Context->keycode = visual_getch();
				_Context->trigger_ctext=visual_trigger_code(_Context->msg_ctext[_Context->language],strlen(_Context->msg_ctext[_Context->language]));
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+270,182,16,vfh[2],27,28,_Context->msg_ctext[_Context->language],strlen(_Context->msg_ctext[_Context->language]),_Context->value_ctext|0);
				break;
			case	0x10 :
				/* wimage */
				_Context->keycode = visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+300,40,128,vfh[1],27,28,parse_selection(_Context->msg_wimage[_Context->language],&_Context->value_wimage),2);
				break;
			case	0x11 :
				/* cimage */
				visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+300,182,16,vfh[2],27,28,_Context->msg_cimage[_Context->language],strlen(_Context->msg_cimage[_Context->language]),(_Context->value_cimage |2));
				_Context->keycode = visual_getch();
				_Context->trigger_cimage=visual_trigger_code(_Context->msg_cimage[_Context->language],strlen(_Context->msg_cimage[_Context->language]));
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+300,182,16,vfh[2],27,28,_Context->msg_cimage[_Context->language],strlen(_Context->msg_cimage[_Context->language]),_Context->value_cimage|0);
				break;
			case	0x12 :
				/* wline */
				_Context->keycode = visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+330,40,128,vfh[1],27,28,parse_selection(_Context->msg_wline[_Context->language],&_Context->value_wline),2);
				break;
			case	0x13 :
				/* cline */
				visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+330,182,16,vfh[2],27,28,_Context->msg_cline[_Context->language],strlen(_Context->msg_cline[_Context->language]),(_Context->value_cline |2));
				_Context->keycode = visual_getch();
				_Context->trigger_cline=visual_trigger_code(_Context->msg_cline[_Context->language],strlen(_Context->msg_cline[_Context->language]));
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+330,182,16,vfh[2],27,28,_Context->msg_cline[_Context->language],strlen(_Context->msg_cline[_Context->language]),_Context->value_cline|0);
				break;
			case	0x14 :
				/* wpush */
				_Context->keycode = visual_select(_Context->x_Auto2733+50,_Context->y_Auto2733+360,40,128,vfh[1],27,28,parse_selection(_Context->msg_wpush[_Context->language],&_Context->value_wpush),2);
				break;
			case	0x15 :
				/* cpush */
				visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+360,168,16,vfh[2],27,28,_Context->msg_cpush[_Context->language],strlen(_Context->msg_cpush[_Context->language]),(_Context->value_cpush |2));
				_Context->keycode = visual_getch();
				_Context->trigger_cpush=visual_trigger_code(_Context->msg_cpush[_Context->language],strlen(_Context->msg_cpush[_Context->language]));
	visual_check(_Context->x_Auto2733+100,_Context->y_Auto2733+360,168,16,vfh[2],27,28,_Context->msg_cpush[_Context->language],strlen(_Context->msg_cpush[_Context->language]),_Context->value_cpush|0);
				break;
			case	0x16 :
				/* wwindow */
				_Context->keycode = visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+90,40,128,vfh[1],27,28,parse_selection(_Context->msg_wwindow[_Context->language],&_Context->value_wwindow),2);
				break;
			case	0x17 :
				/* cwindow */
				visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+90,154,16,vfh[2],27,28,_Context->msg_cwindow[_Context->language],strlen(_Context->msg_cwindow[_Context->language]),(_Context->value_cwindow |2));
				_Context->keycode = visual_getch();
				_Context->trigger_cwindow=visual_trigger_code(_Context->msg_cwindow[_Context->language],strlen(_Context->msg_cwindow[_Context->language]));
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+90,154,16,vfh[2],27,28,_Context->msg_cwindow[_Context->language],strlen(_Context->msg_cwindow[_Context->language]),_Context->value_cwindow|0);
				break;
			case	0x18 :
				/* wtab */
				_Context->keycode = visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+120,40,128,vfh[1],27,28,parse_selection(_Context->msg_wtab[_Context->language],&_Context->value_wtab),2);
				break;
			case	0x19 :
				/* ctab */
				visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+120,168,16,vfh[2],27,28,_Context->msg_ctab[_Context->language],strlen(_Context->msg_ctab[_Context->language]),(_Context->value_ctab |2));
				_Context->keycode = visual_getch();
				_Context->trigger_ctab=visual_trigger_code(_Context->msg_ctab[_Context->language],strlen(_Context->msg_ctab[_Context->language]));
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+120,168,16,vfh[2],27,28,_Context->msg_ctab[_Context->language],strlen(_Context->msg_ctab[_Context->language]),_Context->value_ctab|0);
				break;
			case	0x1a :
				/* wcheck */
				_Context->keycode = visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+150,40,128,vfh[1],27,28,parse_selection(_Context->msg_wcheck[_Context->language],&_Context->value_wcheck),2);
				break;
			case	0x1b :
				/* ccheck */
				visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+150,168,16,vfh[2],27,28,_Context->msg_ccheck[_Context->language],strlen(_Context->msg_ccheck[_Context->language]),(_Context->value_ccheck |2));
				_Context->keycode = visual_getch();
				_Context->trigger_ccheck=visual_trigger_code(_Context->msg_ccheck[_Context->language],strlen(_Context->msg_ccheck[_Context->language]));
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+150,168,16,vfh[2],27,28,_Context->msg_ccheck[_Context->language],strlen(_Context->msg_ccheck[_Context->language]),_Context->value_ccheck|0);
				break;
			case	0x1c :
				/* wradio */
				_Context->keycode = visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+180,40,128,vfh[1],27,28,parse_selection(_Context->msg_wradio[_Context->language],&_Context->value_wradio),2);
				break;
			case	0x1d :
				/* cradio */
				visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+180,168,16,vfh[2],27,28,_Context->msg_cradio[_Context->language],strlen(_Context->msg_cradio[_Context->language]),(_Context->value_cradio |2));
				_Context->keycode = visual_getch();
				_Context->trigger_cradio=visual_trigger_code(_Context->msg_cradio[_Context->language],strlen(_Context->msg_cradio[_Context->language]));
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+180,168,16,vfh[2],27,28,_Context->msg_cradio[_Context->language],strlen(_Context->msg_cradio[_Context->language]),_Context->value_cradio|0);
				break;
			case	0x1e :
				/* wselect */
				_Context->keycode = visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+210,40,128,vfh[1],27,28,parse_selection(_Context->msg_wselect[_Context->language],&_Context->value_wselect),2);
				break;
			case	0x1f :
				/* cselect */
				visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+210,168,16,vfh[2],27,28,_Context->msg_cselect[_Context->language],strlen(_Context->msg_cselect[_Context->language]),(_Context->value_cselect |2));
				_Context->keycode = visual_getch();
				_Context->trigger_cselect=visual_trigger_code(_Context->msg_cselect[_Context->language],strlen(_Context->msg_cselect[_Context->language]));
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+210,168,16,vfh[2],27,28,_Context->msg_cselect[_Context->language],strlen(_Context->msg_cselect[_Context->language]),_Context->value_cselect|0);
				break;
			case	0x20 :
				/* wtable */
				_Context->keycode = visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+240,40,128,vfh[1],27,28,parse_selection(_Context->msg_wtable[_Context->language],&_Context->value_wtable),2);
				break;
			case	0x21 :
				/* ctable */
				visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+240,168,16,vfh[2],27,28,_Context->msg_ctable[_Context->language],strlen(_Context->msg_ctable[_Context->language]),(_Context->value_ctable |2));
				_Context->keycode = visual_getch();
				_Context->trigger_ctable=visual_trigger_code(_Context->msg_ctable[_Context->language],strlen(_Context->msg_ctable[_Context->language]));
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+240,168,16,vfh[2],27,28,_Context->msg_ctable[_Context->language],strlen(_Context->msg_ctable[_Context->language]),_Context->value_ctable|0);
				break;
			case	0x22 :
				/* wscroll */
				_Context->keycode = visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+270,40,128,vfh[1],27,28,parse_selection(_Context->msg_wscroll[_Context->language],&_Context->value_wscroll),2);
				break;
			case	0x23 :
				/* cscroll */
				visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+270,168,16,vfh[2],27,28,_Context->msg_cscroll[_Context->language],strlen(_Context->msg_cscroll[_Context->language]),(_Context->value_cscroll |2));
				_Context->keycode = visual_getch();
				_Context->trigger_cscroll=visual_trigger_code(_Context->msg_cscroll[_Context->language],strlen(_Context->msg_cscroll[_Context->language]));
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+270,168,16,vfh[2],27,28,_Context->msg_cscroll[_Context->language],strlen(_Context->msg_cscroll[_Context->language]),_Context->value_cscroll|0);
				break;
			case	0x24 :
				/* wprogress */
				_Context->keycode = visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+300,40,128,vfh[1],27,28,parse_selection(_Context->msg_wprogress[_Context->language],&_Context->value_wprogress),2);
				break;
			case	0x25 :
				/* cprogress */
				visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+300,168,16,vfh[2],27,28,_Context->msg_cprogress[_Context->language],strlen(_Context->msg_cprogress[_Context->language]),(_Context->value_cprogress |2));
				_Context->keycode = visual_getch();
				_Context->trigger_cprogress=visual_trigger_code(_Context->msg_cprogress[_Context->language],strlen(_Context->msg_cprogress[_Context->language]));
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+300,168,16,vfh[2],27,28,_Context->msg_cprogress[_Context->language],strlen(_Context->msg_cprogress[_Context->language]),_Context->value_cprogress|0);
				break;
			case	0x26 :
				/* wswitch */
				_Context->keycode = visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+330,40,128,vfh[1],27,28,parse_selection(_Context->msg_wswitch[_Context->language],&_Context->value_wswitch),2);
				break;
			case	0x27 :
				/* cswitch */
				visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+330,168,16,vfh[2],27,28,_Context->msg_cswitch[_Context->language],strlen(_Context->msg_cswitch[_Context->language]),(_Context->value_cswitch |2));
				_Context->keycode = visual_getch();
				_Context->trigger_cswitch=visual_trigger_code(_Context->msg_cswitch[_Context->language],strlen(_Context->msg_cswitch[_Context->language]));
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+330,168,16,vfh[2],27,28,_Context->msg_cswitch[_Context->language],strlen(_Context->msg_cswitch[_Context->language]),_Context->value_cswitch|0);
				break;
			case	0x28 :
				/* wgraph */
				_Context->keycode = visual_select(_Context->x_Auto2733+310,_Context->y_Auto2733+360,40,128,vfh[1],27,28,parse_selection(_Context->msg_wgraph[_Context->language],&_Context->value_wgraph),2);
				break;
			case	0x29 :
				/* cgraph */
				visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+360,154,16,vfh[2],27,28,_Context->msg_cgraph[_Context->language],strlen(_Context->msg_cgraph[_Context->language]),(_Context->value_cgraph |2));
				_Context->keycode = visual_getch();
				_Context->trigger_cgraph=visual_trigger_code(_Context->msg_cgraph[_Context->language],strlen(_Context->msg_cgraph[_Context->language]));
	visual_check(_Context->x_Auto2733+360,_Context->y_Auto2733+360,154,16,vfh[2],27,28,_Context->msg_cgraph[_Context->language],strlen(_Context->msg_cgraph[_Context->language]),_Context->value_cgraph|0);
				break;
...
retry:
			...
			switch ((_Context->focus_item = retcode)) {
				...
				case	0x2a :
					...
					if (visual_event(1) & _MIMO_DOWN) {
						_Context->trigger_Accept=visual_trigger_code(_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]));
						visual_button(_Context->x_Auto2733+20,_Context->y_Auto2733+410,56,48,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),1042);
						}
	...
	visual_button(_Context->x_Auto2733+20,_Context->y_Auto2733+410,56,48,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),1040);
				...
				case	0x2b :
					...
					if (visual_event(1) & _MIMO_DOWN) {
						_Context->trigger_Cancel=visual_trigger_code(_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]));
						visual_button(_Context->x_Auto2733+470,_Context->y_Auto2733+410,56,48,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),1042);
						}
					else if (visual_event(1) & _MIMO_UP) {
						_Context->trigger_Cancel=visual_trigger_code(_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]));
	visual_button(_Context->x_Auto2733+470,_Context->y_Auto2733+410,56,48,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),1040);
