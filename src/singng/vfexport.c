...
/* ------------------------------------------------------------------------- */
/* Sing Version   : 2.1a.0.30                                                */
/* Production     : C                                                        */
/* Project        : vfexport.xml                                             */
/* Target         : vfexport.c                                               */
/* Identification : 0.0-1180766574-12576.12575                               */
/* ------------------------------------------------------------------------- */

#include <stdio.h>
#include "visual.h"
#define en_Auto2682   "Sing : Version 2.1a"
#define en__Auto2682   ""
#define en_Auto2683   "Font   Export   Parameters"
#define en__Auto2683   ""
#define en_Auto2685   "Image File"
#define en__Auto2685   ""
#define en_Auto2686   "Font"
#define en__Auto2686   ""
#define en_Auto2687   "Font Width"
#define en__Auto2687   ""
#define en_Auto2688   "Font Height"
#define en__Auto2688   ""
#define en_Auto2689   "Align"
#define en__Auto2689   ""
#define en_Auto2690   "Foreground"
#define en__Auto2690   ""
#define en_Auto2691   "Background"
#define en__Auto2691   ""
#define en_Auto2692   "Padd Width"
#define en__Auto2692   ""
#define en_Auto2693   "Padd Height"
#define en__Auto2693   ""
...
private struct accept_font_export_context {
	...
	int	language;
	char * msg_Auto2682[8];
	char * hint_Auto2682[8];
	int	x_Auto2682;
	int	y_Auto2682;
	int	w_Auto2682;
	int	h_Auto2682;
	char * msg_Auto2683[8];
	char * hint_Auto2683[8];
	char * hint_Auto2684[8];
	char * msg_Auto2685[8];
	char * hint_Auto2685[8];
	char * msg_Auto2686[8];
	char * hint_Auto2686[8];
	char * msg_Auto2687[8];
	char * hint_Auto2687[8];
	char * msg_Auto2688[8];
	char * hint_Auto2688[8];
	char * msg_Auto2689[8];
	char * hint_Auto2689[8];
	char * msg_Auto2690[8];
	char * hint_Auto2690[8];
	char * msg_Auto2691[8];
	char * hint_Auto2691[8];
	char * msg_Auto2692[8];
	char * hint_Auto2692[8];
	char * msg_Auto2693[8];
	char * hint_Auto2693[8];
	...
	char * pBgColour)
{
	...
	for (i=0; i < 8; i++)_Context->msg_Auto2682[i]=" ";
	_Context->msg_Auto2682[0]=en_Auto2682;
	_Context->hint_Auto2682[0]=en__Auto2682;
	_Context->x_Auto2682=95;
	_Context->y_Auto2682=165;
	_Context->w_Auto2682=610;
	_Context->h_Auto2682=270;
	_Context->window_col=0;
	_Context->window_row=0;
	for (i=0; i < 8; i++)_Context->msg_Auto2683[i]=" ";
	_Context->msg_Auto2683[0]=en_Auto2683;
	_Context->hint_Auto2683[0]=en__Auto2683;
	for (i=0; i < 8; i++)_Context->msg_Auto2685[i]=" ";
	_Context->msg_Auto2685[0]=en_Auto2685;
	_Context->hint_Auto2685[0]=en__Auto2685;
	for (i=0; i < 8; i++)_Context->msg_Auto2686[i]=" ";
	_Context->msg_Auto2686[0]=en_Auto2686;
	_Context->hint_Auto2686[0]=en__Auto2686;
	for (i=0; i < 8; i++)_Context->msg_Auto2687[i]=" ";
	_Context->msg_Auto2687[0]=en_Auto2687;
	_Context->hint_Auto2687[0]=en__Auto2687;
	for (i=0; i < 8; i++)_Context->msg_Auto2688[i]=" ";
	_Context->msg_Auto2688[0]=en_Auto2688;
	_Context->hint_Auto2688[0]=en__Auto2688;
	for (i=0; i < 8; i++)_Context->msg_Auto2689[i]=" ";
	_Context->msg_Auto2689[0]=en_Auto2689;
	_Context->hint_Auto2689[0]=en__Auto2689;
	for (i=0; i < 8; i++)_Context->msg_Auto2690[i]=" ";
	_Context->msg_Auto2690[0]=en_Auto2690;
	_Context->hint_Auto2690[0]=en__Auto2690;
	for (i=0; i < 8; i++)_Context->msg_Auto2691[i]=" ";
	_Context->msg_Auto2691[0]=en_Auto2691;
	_Context->hint_Auto2691[0]=en__Auto2691;
	for (i=0; i < 8; i++)_Context->msg_Auto2692[i]=" ";
	_Context->msg_Auto2692[0]=en_Auto2692;
	_Context->hint_Auto2692[0]=en__Auto2692;
	for (i=0; i < 8; i++)_Context->msg_Auto2693[i]=" ";
	_Context->msg_Auto2693[0]=en_Auto2693;
	_Context->hint_Auto2693[0]=en__Auto2693;
	...
	_Context->pushbuffer=visual_buffer(_Context->x_Auto2682,_Context->y_Auto2682,610+10,270+10);
	return(0);
}
...
public 	int	accept_font_export_hide(struct accept_font_export_context * _Context)
{
	...
	&& (_Context->ctrlbuffer != 0)) {
		(void)visual_buffer_put(_Context->pushbuffer,_Context->x_Auto2682,_Context->y_Auto2682);
		_Context->ctrlbuffer=0;
		}
...
private int on_FontWidth_show(struct accept_font_export_context * _Context) {
	...
	visual_frame(_Context->x_Auto2682+130,_Context->y_Auto2682+140,80+2,16+2,5);
visual_text(_Context->x_Auto2682+130+1,_Context->y_Auto2682+140+1,80,16,vfh[1],0,0,_Context->buffer_FontWidth,10,0);
;
	return(-1);
}
private int on_FontHeight_show(struct accept_font_export_context * _Context) {
	...
	visual_frame(_Context->x_Auto2682+320,_Context->y_Auto2682+140,64+2,16+2,5);
visual_text(_Context->x_Auto2682+320+1,_Context->y_Auto2682+140+1,64,16,vfh[1],0,0,_Context->buffer_FontHeight,8,0);
;
	return(-1);
}
...
public	int	accept_font_export_show(struct accept_font_export_context * _Context)
{
	...
	if ((_Context->pushbuffer != (void *) 0)
	&& (!(_Context->ctrlbuffer))) {
		(void)visual_buffer_get(_Context->pushbuffer,_Context->x_Auto2682,_Context->y_Auto2682);
		_Context->ctrlbuffer=1;
		}
	visual_freeze();
	visual_window(_Context->x_Auto2682,_Context->y_Auto2682,610,270,vfh[2],_Context->msg_Auto2682[_Context->language],strlen(_Context->msg_Auto2682[_Context->language]),0x407);
	visual_text(_Context->x_Auto2682+10,_Context->y_Auto2682+20,590,40,vfh[6],16,0,_Context->msg_Auto2683[_Context->language],strlen(_Context->msg_Auto2683[_Context->language]),1283);
	visual_frame(_Context->x_Auto2682+10,_Context->y_Auto2682+60,590,200,4);
	visual_text(_Context->x_Auto2682+20,_Context->y_Auto2682+70,96,16,vfh[2],16,0,_Context->msg_Auto2685[_Context->language],strlen(_Context->msg_Auto2685[_Context->language]),1);
	visual_text(_Context->x_Auto2682+20,_Context->y_Auto2682+100,96,16,vfh[2],16,0,_Context->msg_Auto2686[_Context->language],strlen(_Context->msg_Auto2686[_Context->language]),1);
	visual_text(_Context->x_Auto2682+20,_Context->y_Auto2682+140,96,16,vfh[2],16,0,_Context->msg_Auto2687[_Context->language],strlen(_Context->msg_Auto2687[_Context->language]),1);
	visual_text(_Context->x_Auto2682+210,_Context->y_Auto2682+140,98,16,vfh[2],16,0,_Context->msg_Auto2688[_Context->language],strlen(_Context->msg_Auto2688[_Context->language]),1);
	visual_text(_Context->x_Auto2682+30,_Context->y_Auto2682+170,84,16,vfh[2],16,0,_Context->msg_Auto2689[_Context->language],strlen(_Context->msg_Auto2689[_Context->language]),1);
	visual_text(_Context->x_Auto2682+20,_Context->y_Auto2682+200,96,16,vfh[2],16,0,_Context->msg_Auto2690[_Context->language],strlen(_Context->msg_Auto2690[_Context->language]),1);
	visual_text(_Context->x_Auto2682+20,_Context->y_Auto2682+220,96,16,vfh[2],16,0,_Context->msg_Auto2691[_Context->language],strlen(_Context->msg_Auto2691[_Context->language]),1);
	visual_text(_Context->x_Auto2682+210,_Context->y_Auto2682+200,98,16,vfh[2],16,0,_Context->msg_Auto2692[_Context->language],strlen(_Context->msg_Auto2692[_Context->language]),1);
	visual_text(_Context->x_Auto2682+210,_Context->y_Auto2682+220,96,16,vfh[2],16,0,_Context->msg_Auto2693[_Context->language],strlen(_Context->msg_Auto2693[_Context->language]),1);
	visual_frame(_Context->x_Auto2682+130,_Context->y_Auto2682+70,440+2,16+2,5);
	visual_text(_Context->x_Auto2682+130+1,_Context->y_Auto2682+70+1,440,16,vfh[1],27,28,_Context->buffer_FontFileName,255,0);
	visual_select(_Context->x_Auto2682+130,_Context->y_Auto2682+100,252,96,vfh[2],34,0,parse_selection(TextFontList,&_Context->value_TextFont),768);
	...
	visual_check(_Context->x_Auto2682+320,_Context->y_Auto2682+170,70,16,vfh[2],175,0,_Context->msg_IsBold[_Context->language],strlen(_Context->msg_IsBold[_Context->language]),_Context->value_IsBold|0);
	visual_frame(_Context->x_Auto2682+320,_Context->y_Auto2682+220,64+2,16+2,5);
	visual_text(_Context->x_Auto2682+320+1,_Context->y_Auto2682+220+1,64,16,vfh[1],27,28,_Context->buffer_vPadd,8,0);
	visual_frame(_Context->x_Auto2682+320,_Context->y_Auto2682+200,64+2,16+2,5);
	visual_text(_Context->x_Auto2682+320+1,_Context->y_Auto2682+200+1,64,16,vfh[1],27,28,_Context->buffer_hPadd,8,0);
	visual_select(_Context->x_Auto2682+130,_Context->y_Auto2682+170,112,96,vfh[2],0,0,parse_selection(WidgetOptionList(_TEXT_FRAME),&_Context->value_Align),768);
	visual_frame(_Context->x_Auto2682+130,_Context->y_Auto2682+200,80+2,16+2,5);
	visual_text(_Context->x_Auto2682+130+1,_Context->y_Auto2682+200+1,80,16,vfh[1],27,28,_Context->buffer_FgColour,10,0);
	visual_frame(_Context->x_Auto2682+130,_Context->y_Auto2682+220,80+2,16+2,5);
	visual_text(_Context->x_Auto2682+130+1,_Context->y_Auto2682+220+1,80,16,vfh[1],27,28,_Context->buffer_BgColour,10,0);
	_Context->trigger_Accept=visual_trigger_code(_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]));
	visual_button(_Context->x_Auto2682+470,_Context->y_Auto2682+130,56,48,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),1040);
	_Context->trigger_Cancel=visual_trigger_code(_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]));
	visual_button(_Context->x_Auto2682+470,_Context->y_Auto2682+190,56,48,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),1040);
	visual_thaw(_Context->x_Auto2682,_Context->y_Auto2682,610,270);
...
private int IsBold_help()
{
	switch (visual_national_language(-1)) {
		case 0 : 
			...
			mptr[0] = " ";
			mptr[1]=" ";
			mptr[2]="The font characters will be printed to the exported image activetool the ";
...
private int Auto2682action(struct accept_font_export_context * _Context) {
	...
	do {
		...
		_Context->x_Auto2682 += (visual_event(7)-x);
		x=visual_event(7);
		if (_Context->x_Auto2682 < 0) { _Context->x_Auto2682=0; }
		_Context->y_Auto2682 += (visual_event(6)-y);
		y=visual_event(6);
		if (_Context->y_Auto2682 < 0) { _Context->y_Auto2682=0; }
...
struct accept_font_export_context * _Context){
	...
	switch (mt) {
	case _MIMO_UP :
	if ((mx >= (_Context->x_Auto2682+589) )  
	&&  (my >= (_Context->y_Auto2682+4) )  
	&&  (mx <= (_Context->x_Auto2682+606) )  
	&&  (my <= (_Context->y_Auto2682+20) )) {
		return(1);	/* Auto2682 */

		}
	if ((mx >= (_Context->x_Auto2682+573) )  
	&&  (my >= (_Context->y_Auto2682+4) )  
	&&  (mx <= (_Context->x_Auto2682+590) )  
	&&  (my <= (_Context->y_Auto2682+20) )) {
	...
	if ((mx >= (_Context->x_Auto2682+557) )  
	&&  (my >= (_Context->y_Auto2682+4) )  
	&&  (mx <= (_Context->x_Auto2682+574) )  
	&&  (my <= (_Context->y_Auto2682+20) )) {
	...
	case _MIMO_DOWN :
		if ((mx >= (_Context->x_Auto2682+4) )  
		&&  (my >= (_Context->y_Auto2682+4) )  
		&&  (mx <= (_Context->x_Auto2682+542) )  
		&&  (my <= (_Context->y_Auto2682+20) )) {
			return( Auto2682action(_Context) );
			}
		}
	if (( mx >= (_Context->x_Auto2682+130) ) 
	&&  ( my >= (_Context->y_Auto2682+70) ) 
	&&  ( mx <= (_Context->x_Auto2682+130+440) ) 
	&&  ( my <= (_Context->y_Auto2682+70+16))) {
		return(2); /* FontFileName */
		}
	if (( mx >= (_Context->x_Auto2682+130+0) ) 
	&&  ( my >= (_Context->y_Auto2682+100) ) 
	&&  ( mx <= (_Context->x_Auto2682+130+252) ) 
	&&  ( my <= (_Context->y_Auto2682+100+16))) {
		return(3); /* TextFont */
		}
	if (( mx >= (_Context->x_Auto2682+130) ) 
	&&  ( my >= (_Context->y_Auto2682+140) ) 
	&&  ( mx <= (_Context->x_Auto2682+130+80) ) 
	&&  ( my <= (_Context->y_Auto2682+140+16))) {
		return(4); /* FontWidth */
		}
	if (( mx >= (_Context->x_Auto2682+320) ) 
	&&  ( my >= (_Context->y_Auto2682+140) ) 
	&&  ( mx <= (_Context->x_Auto2682+320+64) ) 
	&&  ( my <= (_Context->y_Auto2682+140+16))) {
		return(5); /* FontHeight */
		}
	if (( mx >= (_Context->x_Auto2682+320) ) 
	&&  ( my >= (_Context->y_Auto2682+170) ) 
	&&  ( mx <= (_Context->x_Auto2682+320+70) ) 
	&&  ( my <= (_Context->y_Auto2682+170+16))) {
		return(6); /* IsBold */
		}
	if (( mx >= (_Context->x_Auto2682+320) ) 
	&&  ( my >= (_Context->y_Auto2682+220) ) 
	&&  ( mx <= (_Context->x_Auto2682+320+64) ) 
	&&  ( my <= (_Context->y_Auto2682+220+16))) {
		return(7); /* vPadd */
		}
	if (( mx >= (_Context->x_Auto2682+320) ) 
	&&  ( my >= (_Context->y_Auto2682+200) ) 
	&&  ( mx <= (_Context->x_Auto2682+320+64) ) 
	&&  ( my <= (_Context->y_Auto2682+200+16))) {
		return(8); /* hPadd */
		}
	if (( mx >= (_Context->x_Auto2682+130+0) ) 
	&&  ( my >= (_Context->y_Auto2682+170) ) 
	&&  ( mx <= (_Context->x_Auto2682+130+112) ) 
	&&  ( my <= (_Context->y_Auto2682+170+16))) {
		return(9); /* Align */
		}
	if (( mx >= (_Context->x_Auto2682+130) ) 
	...
	if (( mx >= (_Context->x_Auto2682+470) ) 
	&&  ( my >= (_Context->y_Auto2682+130) ) 
	&&  ( mx <= (_Context->x_Auto2682+470+56) ) 
	&&  ( my <= (_Context->y_Auto2682+130+48))) {
		return(12); /* Accept */
		}
	if (( mx >= (_Context->x_Auto2682+470) ) 
	&&  ( my >= (_Context->y_Auto2682+190) ) 
	&&  ( mx <= (_Context->x_Auto2682+470+56) ) 
	&&  ( my <= (_Context->y_Auto2682+190+48))) {
		return(13); /* Cancel */
		}
...
public	int	accept_font_export_focus(struct accept_font_export_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			case	0x2 :
				/* FontFileName */
				_Context->keycode = visual_edit(_Context->x_Auto2682+130+1,_Context->y_Auto2682+70+1,440,16,vfh[1],_Context->buffer_FontFileName,255);
			break;
			case	0x3 :
				/* TextFont */
				_Context->keycode = visual_select(_Context->x_Auto2682+130,_Context->y_Auto2682+100,252,96,vfh[2],34,0,parse_selection(TextFontList,&_Context->value_TextFont),770);
				on_FontWidth_show(_Context);
				on_FontHeight_show(_Context);
				break;
			case	0x6 :
				/* IsBold */
				visual_check(_Context->x_Auto2682+320,_Context->y_Auto2682+170,70,16,vfh[2],175,0,_Context->msg_IsBold[_Context->language],strlen(_Context->msg_IsBold[_Context->language]),(_Context->value_IsBold |2));
	...
	visual_check(_Context->x_Auto2682+320,_Context->y_Auto2682+170,70,16,vfh[2],175,0,_Context->msg_IsBold[_Context->language],strlen(_Context->msg_IsBold[_Context->language]),_Context->value_IsBold|0);
			...
			case	0x7 :
				/* vPadd */
				_Context->keycode = visual_edit(_Context->x_Auto2682+320+1,_Context->y_Auto2682+220+1,64,16,vfh[1],_Context->buffer_vPadd,8);
			break;
			case	0x8 :
				/* hPadd */
				_Context->keycode = visual_edit(_Context->x_Auto2682+320+1,_Context->y_Auto2682+200+1,64,16,vfh[1],_Context->buffer_hPadd,8);
			break;
			case	0x9 :
				/* Align */
				_Context->keycode = visual_select(_Context->x_Auto2682+130,_Context->y_Auto2682+170,112,96,vfh[2],0,0,parse_selection(WidgetOptionList(_TEXT_FRAME),&_Context->value_Align),770);
				break;
			case	0xa :
				/* FgColour */
				_Context->keycode = visual_edit(_Context->x_Auto2682+130+1,_Context->y_Auto2682+200+1,80,16,vfh[1],_Context->buffer_FgColour,10);
			break;
			case	0xb :
				/* BgColour */
				_Context->keycode = visual_edit(_Context->x_Auto2682+130+1,_Context->y_Auto2682+220+1,80,16,vfh[1],_Context->buffer_BgColour,10);
			break;
			case	0xc :
				/* Accept */
				_Context->trigger_Accept=visual_trigger_code(_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]));
				visual_button(_Context->x_Auto2682+470,_Context->y_Auto2682+130,56,48,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Accept=visual_trigger_code(_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]));
	visual_button(_Context->x_Auto2682+470,_Context->y_Auto2682+130,56,48,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),1040);
				break;
			case	0xd :
				/* Cancel */
				_Context->trigger_Cancel=visual_trigger_code(_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]));
				visual_button(_Context->x_Auto2682+470,_Context->y_Auto2682+190,56,48,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Cancel=visual_trigger_code(_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]));
	visual_button(_Context->x_Auto2682+470,_Context->y_Auto2682+190,56,48,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),1040);
				break;
