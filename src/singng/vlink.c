...
#define pt__Auto2742   ""
#define xx__Auto2742   ""
#define en_Auto2743   "ABAL++ Object Linker"
#define fr_Auto2743   "Editeur de liens ABAL++"
#define it_Auto2743   "ABAL++ Object Linker"
#define es_Auto2743   "ABAL++ Object Linker"
#define de_Auto2743   "ABAL++ Object Linker"
#define nl_Auto2743   "ABAL++ Object Linker"
#define pt_Auto2743   "ABAL++ Object Linker"
#define xx_Auto2743   "ABAL++ Object Linker"
#define en_Auto2744   "oldicon.gif"
#define fr_Auto2744   "oldicon.gif"
#define it_Auto2744   "oldicon.gif"
#define es_Auto2744   "oldicon.gif"
#define de_Auto2744   "oldicon.gif"
#define nl_Auto2744   "oldicon.gif"
#define pt_Auto2744   "oldicon.gif"
#define xx_Auto2744   "oldicon.gif"
...
#define en_Auto2746   "abal.gif"
#define fr_Auto2746   "abal.gif"
#define it_Auto2746   "abal.gif"
#define es_Auto2746   "abal.gif"
#define de_Auto2746   "abal.gif"
#define nl_Auto2746   "abal.gif"
#define pt_Auto2746   "abal.gif"
#define xx_Auto2746   "abal.gif"
#define en_Auto2747   "Linker Program Name"
#define fr_Auto2747   "Nom de l'‚diteur de liens"
#define it_Auto2747   "Linker Program Name"
#define es_Auto2747   "Linker Program Name"
#define de_Auto2747   "Linker Program Name"
#define nl_Auto2747   "Linker Program Name"
#define pt_Auto2747   "Linker Program Name"
#define xx_Auto2747   "Linker Program Name"
#define en_Linker   ""
	...
	char * pIncludePath)
{
	...
	_Context->x_Auto2742=135;
	_Context->y_Auto2742=110;
	_Context->w_Auto2742=530;
	_Context->h_Auto2742=380;
	...
	_Context->pushbuffer=visual_buffer(_Context->x_Auto2742,_Context->y_Auto2742,530+10,380+10);
	return(0);
}
...
public 	int	accept_linker_parameters_hide(struct accept_linker_parameters_context * _Context)
{
	...
	&& (_Context->ctrlbuffer != 0)) {
		(void)visual_buffer_put(_Context->pushbuffer,_Context->x_Auto2742,_Context->y_Auto2742);
		_Context->ctrlbuffer=0;
		}
...
public	int	accept_linker_parameters_show(struct accept_linker_parameters_context * _Context)
{
	...
	if ((_Context->pushbuffer != (void *) 0)
	&& (!(_Context->ctrlbuffer))) {
		(void)visual_buffer_get(_Context->pushbuffer,_Context->x_Auto2742,_Context->y_Auto2742);
		_Context->ctrlbuffer=1;
		}
	visual_freeze();
	if (((_Context->status = visual_styled_element(_Context->x_Auto2742,_Context->y_Auto2742,530,380,GetWidgetStyle(0),GetWindowVersion(),strlen(GetWindowVersion()))) != 0)
) {
		visual_window(_Context->x_Auto2742,_Context->y_Auto2742,530,380,vfh[2],GetWindowVersion(),strlen(GetWindowVersion()),0x407);
		}
	visual_text(_Context->x_Auto2742+20,_Context->y_Auto2742+30,437,20,vfh[3],27,0,_Context->msg_Auto2743[_Context->language],strlen(_Context->msg_Auto2743[_Context->language]),1282);
	visual_image(_Context->x_Auto2742+420,_Context->y_Auto2742+40,30,30,_Context->msg_Auto2744[_Context->language],3);
	...
	visual_tabpage(_Context->x_Auto2742+10,_Context->y_Auto2742+60,500,250,vfh[2],_Context->msg_General[_Context->language],strlen(_Context->msg_General[_Context->language]),0,2);
	} else {
		visual_tabpage(_Context->x_Auto2742+10,_Context->y_Auto2742+60,500,250,vfh[2],_Context->msg_General[_Context->language],strlen(_Context->msg_General[_Context->language]),0,0);
		}
	if (_Context->page_number == 1 ) {
	visual_frame(_Context->x_Auto2742+30,_Context->y_Auto2742+230,460,40,2);
		}
	visual_image(_Context->x_Auto2742+460,_Context->y_Auto2742+30,50,50,_Context->msg_Auto2746[_Context->language],3);
	if (_Context->page_number == 1 ) {
	visual_text(_Context->x_Auto2742+30,_Context->y_Auto2742+100,462,24,vfh[2],16,0,_Context->msg_Auto2747[_Context->language],strlen(_Context->msg_Auto2747[_Context->language]),1283);
		}
	if (_Context->page_number == 1 ) {
	visual_frame(_Context->x_Auto2742+30,_Context->y_Auto2742+120,464+2,16+2,5);
	visual_text(_Context->x_Auto2742+30+1,_Context->y_Auto2742+120+1,464,16,vfh[1],16,28,_Context->buffer_Linker,255,0);
		}
	if (_Context->page_number == 1 ) {
	...
	visual_check(_Context->x_Auto2742+30,_Context->y_Auto2742+150,126,16,vfh[2],16,28,_Context->msg_TargetFile[_Context->language],strlen(_Context->msg_TargetFile[_Context->language]),_Context->value_TargetFile|0);
		}
	if (_Context->page_number == 1 ) {
	visual_frame(_Context->x_Auto2742+150,_Context->y_Auto2742+150,344+2,16+2,5);
	visual_text(_Context->x_Auto2742+150+1,_Context->y_Auto2742+150+1,344,16,vfh[1],16,28,_Context->buffer_TargetName,255,0);
		}
	if (_Context->page_number == 1 ) {
	...
	visual_check(_Context->x_Auto2742+30,_Context->y_Auto2742+180,126,16,vfh[2],16,28,_Context->msg_Report[_Context->language],strlen(_Context->msg_Report[_Context->language]),_Context->value_Report|0);
		}
	if (_Context->page_number == 1 ) {
	visual_frame(_Context->x_Auto2742+150,_Context->y_Auto2742+180,344+2,16+2,5);
	visual_text(_Context->x_Auto2742+150+1,_Context->y_Auto2742+180+1,344,16,vfh[1],16,28,_Context->buffer_ReportName,255,0);
		}
	if (_Context->page_number == 1 ) {
	...
	visual_check(_Context->x_Auto2742+40,_Context->y_Auto2742+240,84,16,vfh[2],16,28,_Context->msg_Debug[_Context->language],strlen(_Context->msg_Debug[_Context->language]),_Context->value_Debug|0);
		}
	if (_Context->page_number == 1 ) {
	...
	visual_check(_Context->x_Auto2742+230,_Context->y_Auto2742+240,126,16,vfh[2],16,28,_Context->msg_InputTrace[_Context->language],strlen(_Context->msg_InputTrace[_Context->language]),_Context->value_InputTrace|0);
		}
	if (_Context->page_number == 1 ) {
	...
	visual_check(_Context->x_Auto2742+350,_Context->y_Auto2742+240,126,16,vfh[2],16,28,_Context->msg_OutputTrace[_Context->language],strlen(_Context->msg_OutputTrace[_Context->language]),_Context->value_OutputTrace|0);
		}
	if (_Context->page_number == 1 ) {
	...
	visual_check(_Context->x_Auto2742+130,_Context->y_Auto2742+240,98,16,vfh[2],16,28,_Context->msg_Verbose[_Context->language],strlen(_Context->msg_Verbose[_Context->language]),_Context->value_Verbose|0);
		}
	...
	visual_tabpage(_Context->x_Auto2742+10,_Context->y_Auto2742+60,500,250,vfh[2],_Context->msg_Modules[_Context->language],strlen(_Context->msg_Modules[_Context->language]),84,2);
	} else {
		visual_tabpage(_Context->x_Auto2742+10,_Context->y_Auto2742+60,500,250,vfh[2],_Context->msg_Modules[_Context->language],strlen(_Context->msg_Modules[_Context->language]),84,0);
		}
	if (_Context->page_number == 2 ) {
	visual_frame(_Context->x_Auto2742+20,_Context->y_Auto2742+100,480+2,192+2,5);
	visual_text(_Context->x_Auto2742+20+1,_Context->y_Auto2742+100+1,480,192,vfh[1],16,28,_Context->buffer_ModuleList,720,0);
		}
	...
	visual_tabpage(_Context->x_Auto2742+10,_Context->y_Auto2742+60,500,250,vfh[2],_Context->msg_Inclusion[_Context->language],strlen(_Context->msg_Inclusion[_Context->language]),171,2);
	} else {
		visual_tabpage(_Context->x_Auto2742+10,_Context->y_Auto2742+60,500,250,vfh[2],_Context->msg_Inclusion[_Context->language],strlen(_Context->msg_Inclusion[_Context->language]),171,0);
		}
	if (_Context->page_number == 3 ) {
	visual_frame(_Context->x_Auto2742+20,_Context->y_Auto2742+100,480+2,192+2,5);
	visual_text(_Context->x_Auto2742+20+1,_Context->y_Auto2742+100+1,480,192,vfh[1],16,28,_Context->buffer_IncludePath,720,0);
		}
	...
	visual_button(_Context->x_Auto2742+10,_Context->y_Auto2742+320,56,48,vfh[2],34,0,_Context->msg_Auto2748[_Context->language],strlen(_Context->msg_Auto2748[_Context->language]),1040);
	...
	visual_button(_Context->x_Auto2742+450,_Context->y_Auto2742+320,56,48,vfh[2],34,0,_Context->msg_Auto2749[_Context->language],strlen(_Context->msg_Auto2749[_Context->language]),1040);
	visual_thaw(_Context->x_Auto2742,_Context->y_Auto2742,530,380);
...
private int Auto2742action(struct accept_linker_parameters_context * _Context) {
	...
	do {
		...
		_Context->x_Auto2742 += (visual_event(7)-x);
		x=visual_event(7);
		if (_Context->x_Auto2742 < 0) { _Context->x_Auto2742=0; }
		_Context->y_Auto2742 += (visual_event(6)-y);
		y=visual_event(6);
		if (_Context->y_Auto2742 < 0) { _Context->y_Auto2742=0; }
...
private int on_Auto2748_event(struct accept_linker_parameters_context * _Context) {
	return(13);
	return(-1);
}
private int on_Auto2749_event(struct accept_linker_parameters_context * _Context) {
	return(27);
	return(-1);
}
...
struct accept_linker_parameters_context * _Context){
	...
	if (visual_event(1) & _MIMO_ALT) {
		...
		if (_Context->trigger_Auto2748 == mb ) return(16);
		if (_Context->trigger_Auto2749 == mb ) return(17);
		return(-1);
		}
	...
	switch (mt) {
	case _MIMO_UP :
	if ((mx >= (_Context->x_Auto2742+509) )  
	&&  (my >= (_Context->y_Auto2742+4) )  
	&&  (mx <= (_Context->x_Auto2742+526) )  
	&&  (my <= (_Context->y_Auto2742+20) )) {
		return(1);	/* Auto2742 */

		}
	if ((mx >= (_Context->x_Auto2742+493) )  
	&&  (my >= (_Context->y_Auto2742+4) )  
	&&  (mx <= (_Context->x_Auto2742+510) )  
	&&  (my <= (_Context->y_Auto2742+20) )) {
	...
	if ((mx >= (_Context->x_Auto2742+477) )  
	&&  (my >= (_Context->y_Auto2742+4) )  
	&&  (mx <= (_Context->x_Auto2742+494) )  
	&&  (my <= (_Context->y_Auto2742+20) )) {
	...
	case _MIMO_DOWN :
		if ((mx >= (_Context->x_Auto2742+4) )  
		&&  (my >= (_Context->y_Auto2742+4) )  
		&&  (mx <= (_Context->x_Auto2742+462) )  
		&&  (my <= (_Context->y_Auto2742+20) )) {
			return( Auto2742action(_Context) );
			}
		}
	if (_Context->page_number == 1 ) {
	} else {
		if (( mx >= (_Context->x_Auto2742+10+0) ) 
		&&  ( my >= (_Context->y_Auto2742+60) ) 
		&&  ( mx <= (_Context->x_Auto2742+10+83) ) 
		&&  ( my <= (_Context->y_Auto2742+60+24))) {
			return(2); /* General */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto2742+30) ) 
		&&  ( my >= (_Context->y_Auto2742+120) ) 
		&&  ( mx <= (_Context->x_Auto2742+30+464) ) 
		&&  ( my <= (_Context->y_Auto2742+120+16))) {
			return(3); /* Linker */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto2742+30) ) 
		&&  ( my >= (_Context->y_Auto2742+150) ) 
		&&  ( mx <= (_Context->x_Auto2742+30+126) ) 
		&&  ( my <= (_Context->y_Auto2742+150+16))) {
			return(4); /* TargetFile */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto2742+150) ) 
		&&  ( my >= (_Context->y_Auto2742+150) ) 
		&&  ( mx <= (_Context->x_Auto2742+150+344) ) 
		&&  ( my <= (_Context->y_Auto2742+150+16))) {
			return(5); /* TargetName */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto2742+30) ) 
		&&  ( my >= (_Context->y_Auto2742+180) ) 
		&&  ( mx <= (_Context->x_Auto2742+30+126) ) 
		&&  ( my <= (_Context->y_Auto2742+180+16))) {
			return(6); /* Report */
			}
		}
	if (_Context->page_number == 1 ) {
	...
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto2742+40) ) 
		&&  ( my >= (_Context->y_Auto2742+240) ) 
		&&  ( mx <= (_Context->x_Auto2742+40+84) ) 
		&&  ( my <= (_Context->y_Auto2742+240+16))) {
			return(8); /* Debug */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto2742+230) ) 
		&&  ( my >= (_Context->y_Auto2742+240) ) 
		&&  ( mx <= (_Context->x_Auto2742+230+126) ) 
		&&  ( my <= (_Context->y_Auto2742+240+16))) {
			return(9); /* InputTrace */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto2742+350) ) 
		&&  ( my >= (_Context->y_Auto2742+240) ) 
		&&  ( mx <= (_Context->x_Auto2742+350+126) ) 
		&&  ( my <= (_Context->y_Auto2742+240+16))) {
			return(10); /* OutputTrace */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto2742+130) ) 
		&&  ( my >= (_Context->y_Auto2742+240) ) 
		&&  ( mx <= (_Context->x_Auto2742+130+98) ) 
		&&  ( my <= (_Context->y_Auto2742+240+16))) {
			return(11); /* Verbose */
			}
		}
	if (_Context->page_number == 2 ) {
		...
		if (( mx >= (_Context->x_Auto2742+10+84) ) 
		&&  ( my >= (_Context->y_Auto2742+60) ) 
		&&  ( mx <= (_Context->x_Auto2742+10+170) ) 
		&&  ( my <= (_Context->y_Auto2742+60+24))) {
			return(12); /* Modules */
			}
		}
	if (_Context->page_number == 2 ) {
		if (( mx >= (_Context->x_Auto2742+20) ) 
		&&  ( my >= (_Context->y_Auto2742+100) ) 
		&&  ( mx <= (_Context->x_Auto2742+20+480) ) 
		&&  ( my <= (_Context->y_Auto2742+100+192))) {
			return(13); /* ModuleList */
			}
		}
	if (_Context->page_number == 3 ) {
	} else {
		if (( mx >= (_Context->x_Auto2742+10+171) ) 
		&&  ( my >= (_Context->y_Auto2742+60) ) 
		&&  ( mx <= (_Context->x_Auto2742+10+259) ) 
		&&  ( my <= (_Context->y_Auto2742+60+24))) {
			return(14); /* Inclusion */
			}
		}
	...
	if (( mx >= (_Context->x_Auto2742+10) ) 
	&&  ( my >= (_Context->y_Auto2742+320) ) 
	&&  ( mx <= (_Context->x_Auto2742+10+56) ) 
	&&  ( my <= (_Context->y_Auto2742+320+48))) {
		return(16); /* Auto2748 */
		}
	if (( mx >= (_Context->x_Auto2742+450) ) 
	&&  ( my >= (_Context->y_Auto2742+320) ) 
	&&  ( mx <= (_Context->x_Auto2742+450+56) ) 
	&&  ( my <= (_Context->y_Auto2742+320+48))) {
		return(17); /* Auto2749 */
		}
	...
	while(1) {
		switch (_Context->focus_item) {
			...
			case	0x3 :
				/* Linker */
				if (_Context->page_number == 1 ) {
					_Context->keycode = visual_edit(_Context->x_Auto2742+30+1,_Context->y_Auto2742+120+1,464,16,vfh[1],_Context->buffer_Linker,255);
				} else {
					_Context->keycode = 5;
					}
				break;
			case	0x4 :
				/* TargetFile */
				if (_Context->page_number == 1 ) {
				visual_check(_Context->x_Auto2742+30,_Context->y_Auto2742+150,126,16,vfh[2],16,28,_Context->msg_TargetFile[_Context->language],strlen(_Context->msg_TargetFile[_Context->language]),(_Context->value_TargetFile |2));
					_Context->keycode = visual_getch();
					_Context->trigger_TargetFile=visual_trigger_code(_Context->msg_TargetFile[_Context->language],strlen(_Context->msg_TargetFile[_Context->language]));
	visual_check(_Context->x_Auto2742+30,_Context->y_Auto2742+150,126,16,vfh[2],16,28,_Context->msg_TargetFile[_Context->language],strlen(_Context->msg_TargetFile[_Context->language]),_Context->value_TargetFile|0);
				} else {
			...
			case	0x5 :
				/* TargetName */
				if (_Context->page_number == 1 ) {
					_Context->keycode = visual_edit(_Context->x_Auto2742+150+1,_Context->y_Auto2742+150+1,344,16,vfh[1],_Context->buffer_TargetName,255);
				} else {
					_Context->keycode = 5;
					}
				break;
			case	0x6 :
				/* Report */
				if (_Context->page_number == 1 ) {
				visual_check(_Context->x_Auto2742+30,_Context->y_Auto2742+180,126,16,vfh[2],16,28,_Context->msg_Report[_Context->language],strlen(_Context->msg_Report[_Context->language]),(_Context->value_Report |2));
					_Context->keycode = visual_getch();
					_Context->trigger_Report=visual_trigger_code(_Context->msg_Report[_Context->language],strlen(_Context->msg_Report[_Context->language]));
	visual_check(_Context->x_Auto2742+30,_Context->y_Auto2742+180,126,16,vfh[2],16,28,_Context->msg_Report[_Context->language],strlen(_Context->msg_Report[_Context->language]),_Context->value_Report|0);
				} else {
			...
			case	0x7 :
				/* ReportName */
				if (_Context->page_number == 1 ) {
					_Context->keycode = visual_edit(_Context->x_Auto2742+150+1,_Context->y_Auto2742+180+1,344,16,vfh[1],_Context->buffer_ReportName,255);
				} else {
					_Context->keycode = 5;
					}
				break;
			case	0x8 :
				/* Debug */
				if (_Context->page_number == 1 ) {
				visual_check(_Context->x_Auto2742+40,_Context->y_Auto2742+240,84,16,vfh[2],16,28,_Context->msg_Debug[_Context->language],strlen(_Context->msg_Debug[_Context->language]),(_Context->value_Debug |2));
					_Context->keycode = visual_getch();
					_Context->trigger_Debug=visual_trigger_code(_Context->msg_Debug[_Context->language],strlen(_Context->msg_Debug[_Context->language]));
	visual_check(_Context->x_Auto2742+40,_Context->y_Auto2742+240,84,16,vfh[2],16,28,_Context->msg_Debug[_Context->language],strlen(_Context->msg_Debug[_Context->language]),_Context->value_Debug|0);
				} else {
			...
			case	0x9 :
				/* InputTrace */
				if (_Context->page_number == 1 ) {
				visual_check(_Context->x_Auto2742+230,_Context->y_Auto2742+240,126,16,vfh[2],16,28,_Context->msg_InputTrace[_Context->language],strlen(_Context->msg_InputTrace[_Context->language]),(_Context->value_InputTrace |2));
					_Context->keycode = visual_getch();
					_Context->trigger_InputTrace=visual_trigger_code(_Context->msg_InputTrace[_Context->language],strlen(_Context->msg_InputTrace[_Context->language]));
	visual_check(_Context->x_Auto2742+230,_Context->y_Auto2742+240,126,16,vfh[2],16,28,_Context->msg_InputTrace[_Context->language],strlen(_Context->msg_InputTrace[_Context->language]),_Context->value_InputTrace|0);
				} else {
			...
			case	0xa :
				/* OutputTrace */
				if (_Context->page_number == 1 ) {
				visual_check(_Context->x_Auto2742+350,_Context->y_Auto2742+240,126,16,vfh[2],16,28,_Context->msg_OutputTrace[_Context->language],strlen(_Context->msg_OutputTrace[_Context->language]),(_Context->value_OutputTrace |2));
					_Context->keycode = visual_getch();
					_Context->trigger_OutputTrace=visual_trigger_code(_Context->msg_OutputTrace[_Context->language],strlen(_Context->msg_OutputTrace[_Context->language]));
	visual_check(_Context->x_Auto2742+350,_Context->y_Auto2742+240,126,16,vfh[2],16,28,_Context->msg_OutputTrace[_Context->language],strlen(_Context->msg_OutputTrace[_Context->language]),_Context->value_OutputTrace|0);
				} else {
			...
			case	0xb :
				/* Verbose */
				if (_Context->page_number == 1 ) {
				visual_check(_Context->x_Auto2742+130,_Context->y_Auto2742+240,98,16,vfh[2],16,28,_Context->msg_Verbose[_Context->language],strlen(_Context->msg_Verbose[_Context->language]),(_Context->value_Verbose |2));
					_Context->keycode = visual_getch();
					_Context->trigger_Verbose=visual_trigger_code(_Context->msg_Verbose[_Context->language],strlen(_Context->msg_Verbose[_Context->language]));
	visual_check(_Context->x_Auto2742+130,_Context->y_Auto2742+240,98,16,vfh[2],16,28,_Context->msg_Verbose[_Context->language],strlen(_Context->msg_Verbose[_Context->language]),_Context->value_Verbose|0);
				} else {
			...
			case	0xd :
				/* ModuleList */
				if (_Context->page_number == 2 ) {
					_Context->keycode = visual_edit(_Context->x_Auto2742+20+1,_Context->y_Auto2742+100+1,480,192,vfh[1],_Context->buffer_ModuleList,720);
				} else {
					_Context->keycode = 5;
					}
				break;
			...
			case	0xf :
				/* IncludePath */
				if (_Context->page_number == 3 ) {
					_Context->keycode = visual_edit(_Context->x_Auto2742+20+1,_Context->y_Auto2742+100+1,480,192,vfh[1],_Context->buffer_IncludePath,720);
				} else {
					_Context->keycode = 5;
					}
				break;
			case	0x10 :
				/* Auto2748 */
				_Context->trigger_Auto2748=visual_trigger_code(_Context->msg_Auto2748[_Context->language],strlen(_Context->msg_Auto2748[_Context->language]));
				visual_button(_Context->x_Auto2742+10,_Context->y_Auto2742+320,56,48,vfh[2],34,0,_Context->msg_Auto2748[_Context->language],strlen(_Context->msg_Auto2748[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto2748=visual_trigger_code(_Context->msg_Auto2748[_Context->language],strlen(_Context->msg_Auto2748[_Context->language]));
	visual_button(_Context->x_Auto2742+10,_Context->y_Auto2742+320,56,48,vfh[2],34,0,_Context->msg_Auto2748[_Context->language],strlen(_Context->msg_Auto2748[_Context->language]),1040);
				break;
			case	0x11 :
				/* Auto2749 */
				_Context->trigger_Auto2749=visual_trigger_code(_Context->msg_Auto2749[_Context->language],strlen(_Context->msg_Auto2749[_Context->language]));
				visual_button(_Context->x_Auto2742+450,_Context->y_Auto2742+320,56,48,vfh[2],34,0,_Context->msg_Auto2749[_Context->language],strlen(_Context->msg_Auto2749[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto2749=visual_trigger_code(_Context->msg_Auto2749[_Context->language],strlen(_Context->msg_Auto2749[_Context->language]));
	visual_button(_Context->x_Auto2742+450,_Context->y_Auto2742+320,56,48,vfh[2],34,0,_Context->msg_Auto2749[_Context->language],strlen(_Context->msg_Auto2749[_Context->language]),1040);
				break;
