...
#define en_FileName   ""
#define en_Auto2743   "ok.gif"
#define fr_Auto2743   "ok.gif"
#define it_Auto2743   "ok.gif"
#define es_Auto2743   "ok.gif"
#define de_Auto2743   "ok.gif"
#define nl_Auto2743   "ok.gif"
#define pt_Auto2743   "ok.gif"
#define xx_Auto2743   "ok.gif"
...
#define en_Auto2744   "cancel.gif"
#define fr_Auto2744   "cancel.gif"
#define it_Auto2744   "cancel.gif"
#define es_Auto2744   "cancel.gif"
#define de_Auto2744   "cancel.gif"
#define nl_Auto2744   "cancel.gif"
#define pt_Auto2744   "cancel.gif"
#define xx_Auto2744   "cancel.gif"
#define en_Auto2745   "formicon.gif"
#define fr_Auto2745   "formicon.gif"
#define it_Auto2745   "formicon.gif"
#define es_Auto2745   "formicon.gif"
#define de_Auto2745   "formicon.gif"
#define nl_Auto2745   "formicon.gif"
#define pt_Auto2745   "formicon.gif"
#define xx_Auto2745   "formicon.gif"
...
private struct accept_form_load_context {
	...
	char * msg_Auto2743[8];
	int	trigger_Auto2743;
	char * hint_Auto2743[8];
	char * msg_Select[8];
	int	trigger_Select;
	char * hint_Select[8];
	char * msg_Auto2744[8];
	int	trigger_Auto2744;
...
public	int	accept_form_load_show(struct accept_form_load_context * _Context)
{
	...
	_Context->trigger_Auto2743=visual_trigger_code(_Context->msg_Auto2743[_Context->language],strlen(_Context->msg_Auto2743[_Context->language]));
	visual_button(_Context->x_auto2+20,_Context->y_auto2+120,56,48,vfh[2],34,0,_Context->msg_Auto2743[_Context->language],strlen(_Context->msg_Auto2743[_Context->language]),1040);
	...
	_Context->trigger_Auto2744=visual_trigger_code(_Context->msg_Auto2744[_Context->language],strlen(_Context->msg_Auto2744[_Context->language]));
	visual_button(_Context->x_auto2+520,_Context->y_auto2+120,56,48,vfh[2],34,0,_Context->msg_Auto2744[_Context->language],strlen(_Context->msg_Auto2744[_Context->language]),1040);
	visual_image(_Context->x_auto2+220,_Context->y_auto2+110,50,50,_Context->msg_Auto2745[_Context->language],0);
...
private int on_Auto2743_event(struct accept_form_load_context * _Context) {
	return(13);
	return(-1);
}
...
private int on_Auto2744_event(struct accept_form_load_context * _Context) {
	return(27);
	return(-1);
}
...
struct accept_form_load_context * _Context){
	...
	if (visual_event(1) & _MIMO_ALT) {
		...
		if (_Context->trigger_Auto2743 == mb ) return(3);
		if (_Context->trigger_Select == mb ) return(4);
		if (_Context->trigger_Auto2744 == mb ) return(5);
		return(-1);
		}
...
public	int	accept_form_load_focus(struct accept_form_load_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			...
			case	0x3 :
				/* Auto2743 */
				_Context->trigger_Auto2743=visual_trigger_code(_Context->msg_Auto2743[_Context->language],strlen(_Context->msg_Auto2743[_Context->language]));
				visual_button(_Context->x_auto2+20,_Context->y_auto2+120,56,48,vfh[2],34,0,_Context->msg_Auto2743[_Context->language],strlen(_Context->msg_Auto2743[_Context->language]),1042);
	...
	visual_button(_Context->x_auto2+360,_Context->y_auto2+130,100,30,vfh[2],27,24,_Context->msg_Select[_Context->language],strlen(_Context->msg_Select[_Context->language]),0);
			...
			case	0x5 :
				/* Auto2744 */
				_Context->trigger_Auto2744=visual_trigger_code(_Context->msg_Auto2744[_Context->language],strlen(_Context->msg_Auto2744[_Context->language]));
				visual_button(_Context->x_auto2+520,_Context->y_auto2+120,56,48,vfh[2],34,0,_Context->msg_Auto2744[_Context->language],strlen(_Context->msg_Auto2744[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto2744=visual_trigger_code(_Context->msg_Auto2744[_Context->language],strlen(_Context->msg_Auto2744[_Context->language]));
	visual_button(_Context->x_auto2+520,_Context->y_auto2+120,56,48,vfh[2],34,0,_Context->msg_Auto2744[_Context->language],strlen(_Context->msg_Auto2744[_Context->language]),1040);
				break;
...
retry:
		...
		case	0x100 :
			...
			if (( visual_event(1) == _MIMO_DOWN ) && ( visual_event(2) == _MIMO_RIGHT)) {
				switch ((_Context->focus_item = retcode)) {
					...
					case	0x3 :
						if (Auto2743_help(_Context) != 0) { continue; }
						else { break; }
					case	0x4 :
						if (Select_help(_Context) != 0) { continue; }
						else { break; }
					case	0x5 :
						if (Auto2744_help(_Context) != 0) { continue; }
						else { break; }
					}
				}
			switch ((_Context->focus_item = retcode)) {
	...
	visual_button(_Context->x_auto2+520,_Context->y_auto2+120,56,48,vfh[2],34,0,_Context->msg_Auto2744[_Context->language],strlen(_Context->msg_Auto2744[_Context->language]),1040);
					...
					if ( visual_event(1) &  0x20 ) {
					if ((_Context->keycode = on_Auto2744_event(_Context)) != -1) break;
