...
#define en_Auto2741   "ok.gif"
#define fr_Auto2741   "ok.gif"
#define it_Auto2741   "ok.gif"
#define es_Auto2741   "ok.gif"
#define de_Auto2741   "ok.gif"
#define nl_Auto2741   "ok.gif"
#define pt_Auto2741   "ok.gif"
#define xx_Auto2741   "ok.gif"
...
#define en_Auto2742   "cancel.gif"
#define fr_Auto2742   "cancel.gif"
#define it_Auto2742   "cancel.gif"
#define es_Auto2742   "cancel.gif"
#define de_Auto2742   "cancel.gif"
#define nl_Auto2742   "cancel.gif"
#define pt_Auto2742   "cancel.gif"
#define xx_Auto2742   "cancel.gif"
...
public	int	accept_imagesave_show(struct accept_imagesave_context * _Context)
{
	...
	visual_button(_Context->x_auto6+20,_Context->y_auto6+150,56,48,vfh[2],34,0,_Context->msg_Auto2741[_Context->language],strlen(_Context->msg_Auto2741[_Context->language]),1040);
	...
	_Context->trigger_Auto2742=visual_trigger_code(_Context->msg_Auto2742[_Context->language],strlen(_Context->msg_Auto2742[_Context->language]));
	visual_button(_Context->x_auto6+520,_Context->y_auto6+150,56,48,vfh[2],34,0,_Context->msg_Auto2742[_Context->language],strlen(_Context->msg_Auto2742[_Context->language]),1040);
...
private int on_Auto2741_event(struct accept_imagesave_context * _Context) {
	return(13);
	return(-1);
}
...
private int on_Auto2742_event(struct accept_imagesave_context * _Context) {
	return(27);
	return(-1);
}
...
struct accept_imagesave_context * _Context){
	...
	if (visual_event(1) & _MIMO_ALT) {
		...
		if (_Context->trigger_Auto2741 == mb ) return(6);
		if (_Context->trigger_Select == mb ) return(7);
		if (_Context->trigger_Auto2742 == mb ) return(8);
		return(-1);
		}
...
public	int	accept_imagesave_focus(struct accept_imagesave_context * _Context)
{
	...
	visual_check(_Context->x_auto6+360,_Context->y_auto6+110,140,16,vfh[2],27,0,_Context->msg_IsTransparent[_Context->language],strlen(_Context->msg_IsTransparent[_Context->language]),_Context->value_IsTransparent|0);
			...
			case	0x6 :
				/* Auto2741 */
				_Context->trigger_Auto2741=visual_trigger_code(_Context->msg_Auto2741[_Context->language],strlen(_Context->msg_Auto2741[_Context->language]));
				visual_button(_Context->x_auto6+20,_Context->y_auto6+150,56,48,vfh[2],34,0,_Context->msg_Auto2741[_Context->language],strlen(_Context->msg_Auto2741[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto2741=visual_trigger_code(_Context->msg_Auto2741[_Context->language],strlen(_Context->msg_Auto2741[_Context->language]));
	visual_button(_Context->x_auto6+20,_Context->y_auto6+150,56,48,vfh[2],34,0,_Context->msg_Auto2741[_Context->language],strlen(_Context->msg_Auto2741[_Context->language]),1040);
				break;
	...
	visual_button(_Context->x_auto6+360,_Context->y_auto6+160,100,30,vfh[2],27,24,_Context->msg_Select[_Context->language],strlen(_Context->msg_Select[_Context->language]),0);
			...
			case	0x8 :
				/* Auto2742 */
				_Context->trigger_Auto2742=visual_trigger_code(_Context->msg_Auto2742[_Context->language],strlen(_Context->msg_Auto2742[_Context->language]));
				visual_button(_Context->x_auto6+520,_Context->y_auto6+150,56,48,vfh[2],34,0,_Context->msg_Auto2742[_Context->language],strlen(_Context->msg_Auto2742[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto2742=visual_trigger_code(_Context->msg_Auto2742[_Context->language],strlen(_Context->msg_Auto2742[_Context->language]));
	visual_button(_Context->x_auto6+520,_Context->y_auto6+150,56,48,vfh[2],34,0,_Context->msg_Auto2742[_Context->language],strlen(_Context->msg_Auto2742[_Context->language]),1040);
				break;
...
retry:
		...
		case	0x100 :
			...
			if (( visual_event(1) == _MIMO_DOWN ) && ( visual_event(2) == _MIMO_RIGHT)) {
				switch ((_Context->focus_item = retcode)) {
					...
					case	0x8 :
						if (Auto2742_help(_Context) != 0) { continue; }
						else { break; }
					}
				}
			switch ((_Context->focus_item = retcode)) {
	...
	visual_button(_Context->x_auto6+520,_Context->y_auto6+150,56,48,vfh[2],34,0,_Context->msg_Auto2742[_Context->language],strlen(_Context->msg_Auto2742[_Context->language]),1040);
					...
					if ( visual_event(1) &  0x20 ) {
					if ((_Context->keycode = on_Auto2742_event(_Context)) != -1) break;
