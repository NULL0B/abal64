...
public	int	visual_command_shell_create(struct visual_command_shell_context **cptr)
{
	...
	_Context->hint_Auto2760[1]=fr__Auto2760;
	_Context->hint_Auto2760[2]=it__Auto2760;
	_Context->hint_Auto2760[3]=es__Auto2760;
	_Context->hint_Auto2760[4]=de__Auto2760;
	_Context->hint_Auto2760[5]=nl__Auto2760;
	_Context->hint_Auto2760[6]=pt__Auto2760;
	_Context->hint_Auto2760[7]=xx__Auto2760;
	_Context->x_Auto2760=60;
	_Context->y_Auto2760=45;
	_Context->w_Auto2760=680;
	_Context->h_Auto2760=510;
