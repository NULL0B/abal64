...
/* Target         : vcssname.c                                               */
/* Identification : 0.0-1196436298-4398.4397                                 */
/* ------------------------------------------------------------------------- */

#include <stdio.h>
#include "visual.h"
#define en__Auto3320   ""
#define en_ExportMsg   "Style Class Export Operation"
...
#define en_Auto3321   "File Name"
#define fr_Auto3321   "Fichier"
#define it_Auto3321   "Filename"
#define es_Auto3321   "Filename"
#define de_Auto3321   "Datei"
#define nl_Auto3321   "Filename"
#define pt_Auto3321   "Filename"
#define xx_Auto3321   "Filename"
#define en__Auto3321   ""
#define fr__Auto3321   ""
#define it__Auto3321   ""
#define es__Auto3321   ""
	...
	char * pNature)
{
	...
	_Context->x_Auto3320=100;
	_Context->y_Auto3320=195;
	_Context->w_Auto3320=600;
	_Context->h_Auto3320=210;
...
private int on_Nature_show(struct accept_css_filename_context * _Context) {
	...
	case 0:	visual_text(120,235,520,32,vfh[3],16,0,_Context->msg_ImportMsg[_Context->language],strlen(_Context->msg_ImportMsg[_Context->language]),259);
;break;
	case 1:	visual_text(120,235,520,32,vfh[3],16,0,_Context->msg_ExportMsg[_Context->language],strlen(_Context->msg_ExportMsg[_Context->language]),259);
;break;
	}
	return(-1);
}
...
public	int	accept_css_filename_show(struct accept_css_filename_context * _Context)
{
	...
	visual_text(130,295,98,16,vfh[2],16,0,_Context->msg_Auto3321[_Context->language],strlen(_Context->msg_Auto3321[_Context->language]),258);
...
private int Auto3320action(struct accept_css_filename_context * _Context) {
