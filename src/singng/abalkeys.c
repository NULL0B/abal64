...
public	char *	__abal_keyword[] = {
	...
	(char *)	/* abal_keyword_atb    	*/ "Atb",
	(char *)	/* abal_keyword_nkey   	*/ "Nkey",
	(char *)	/* abal_keyword_fkey   	*/ "Fkey",
	(char *)	/* abal_keyword_rkey   	*/ "Rkey",
	(char *)	/* abal_keyword_collect	*/ "Collect",
	(char *)	/* abal_keyword_file	*/ "File",

	(char *)	/* abal_keyword_record	*/ "Record",
	(char *)	/* abal_keyword_join	*/ "Join",
	(char *)	/* abal_keyword_cjoin	*/ "Cjoin",
	(char *)	/* abal_keyword_djoin	*/ "Djoin",
	(char *)	/* abal_keyword_rjoin	*/ "Rjoin",
	(char *)	/* abal_keyword_ljoin	*/ "Ljoin",
	(char *)	/* abal_keyword_ljoin	*/ "Lfile",
	(char *)	/* abal_keyword_ljoin	*/ "Llink",
	(char *)	/* abal_keyword_ljoin	*/ "Lkey"
	};
#else	/* ! SINGABAL_C */
...
#define	__abal_keyword_atb	__abal_keyword[0x005D]	 /*Atb*/
#define	__abal_keyword_nkey	__abal_keyword[0x005E]	 /*Nkey*/
#define	__abal_keyword_fkey	__abal_keyword[0x005F]	 /*Fkey*/
#define	__abal_keyword_rkey	__abal_keyword[0x0060]	 /*Rkey*/
#define	__abal_keyword_collect	__abal_keyword[0x0061]	 /*Collect*/
#define	__abal_keyword_file	__abal_keyword[0x0062]	 /*File*/

#define	__abal_keyword_record	__abal_keyword[0x0063]	 /*Record*/
#define	__abal_keyword_join	__abal_keyword[0x0064]	 /*Join*/
#define	__abal_keyword_cjoin	__abal_keyword[0x0065]	 /*Cjoin*/
#define	__abal_keyword_djoin	__abal_keyword[0x0066]	 /*Djoin*/
#define	__abal_keyword_rjoin	__abal_keyword[0x0067]	 /*Rjoin*/
#define	__abal_keyword_ljoin	__abal_keyword[0x0068]	 /*Ljoin*/
#define	__abal_keyword_lfile	__abal_keyword[0x0069]	 /*Lfile*/
#define	__abal_keyword_llink	__abal_keyword[0x006A]	 /*Llink*/
#define	__abal_keyword_lkey	__abal_keyword[0x006B]	 /*Lkey*/
