...
#include "visual.h"
#include "singprot.h"
#define en_Auto2704   "Sing : Version 1.0a"
#define fr_Auto2704   "Sing : Version 1.0a"
#define it_Auto2704   "Sing : Version 1.0a"
#define es_Auto2704   "Sing : Version 1.0a"
#define de_Auto2704   "Sing : Version 1.0a"
#define nl_Auto2704   "Sing : Version 1.0a"
#define pt_Auto2704   "Sing : Version 1.0a"
#define xx_Auto2704   "Sing : Version 1.0a"
#define en__Auto2704   ""
#define en_Auto2705   "Spacial Alignment of 3D Camera Items"
#define fr_Auto2705   "Alignement 3D des composants"
#define it_Auto2705   "Spacial Alignment of 3D Camera Items"
#define es_Auto2705   "Spacial Alignment of 3D Camera Items"
#define de_Auto2705   "Spacial Alignment of 3D Camera Items"
#define nl_Auto2705   "Spacial Alignment of 3D Camera Items"
#define pt_Auto2705   "Spacial Alignment of 3D Camera Items"
#define xx_Auto2705   "Spacial Alignment of 3D Camera Items"
#define en__Auto2705   ""
#define fr__Auto2705   ""
#define it__Auto2705   ""
#define es__Auto2705   ""
...
#define pt__Auto2705   ""
#define xx__Auto2705   ""
#define en_Auto2707   "Accept"
#define fr_Auto2707   "&Valider"
#define it_Auto2707   "Accept"
#define es_Auto2707   "Accept"
#define de_Auto2707   "Accept"
#define nl_Auto2707   "Accept"
#define pt_Auto2707   "Accept"
#define xx_Auto2707   "Accept"
...
#define pt1__Primary ""
#define xx1__Primary ""
#define en_Auto2708   "Cancel"
#define fr_Auto2708   "&Annuler"
#define it_Auto2708   "Cancel"
#define es_Auto2708   "Cancel"
#define de_Auto2708   "Cancel"
#define nl_Auto2708   "Cancel"
#define pt_Auto2708   "Cancel"
#define xx_Auto2708   "Cancel"
	...
	char * pPrimary)
{
	...
	_Context->hint_Auto2704[0]=en__Auto2704;
	_Context->x_Auto2704=130;
	_Context->y_Auto2704=175;
	_Context->w_Auto2704=540;
	_Context->h_Auto2704=250;
...
public	int	accept_camera_alignment_show(struct accept_camera_alignment_context * _Context)
{
	...
	visual_freeze();
	visual_window(130,175,540,250,vfh[2],_Context->msg_Auto2704[_Context->language],strlen(_Context->msg_Auto2704[_Context->language]),0x407);
	visual_text(150,205,500,30,vfh[3],16,0,_Context->msg_Auto2705[_Context->language],strlen(_Context->msg_Auto2705[_Context->language]),1283);
	visual_frame(140,255,510,100,3);
	_Context->trigger_Auto2707=visual_trigger_code(_Context->msg_Auto2707[_Context->language],strlen(_Context->msg_Auto2707[_Context->language]));
	visual_button(150,365,126,32,vfh[2],27,28,_Context->msg_Auto2707[_Context->language],strlen(_Context->msg_Auto2707[_Context->language]),0);
	...
	_Context->trigger_Auto2708=visual_trigger_code(_Context->msg_Auto2708[_Context->language],strlen(_Context->msg_Auto2708[_Context->language]));
	visual_button(520,365,128,32,vfh[2],27,28,_Context->msg_Auto2708[_Context->language],strlen(_Context->msg_Auto2708[_Context->language]),0);
...
private int on_Auto2707_event(struct accept_camera_alignment_context * _Context) {
	return(13);
	return(-1);
}
private int on_Auto2708_event(struct accept_camera_alignment_context * _Context) {
	return(27);
	return(-1);
}
...
struct accept_camera_alignment_context * _Context){
	...
	if (visual_event(1) & _MIMO_ALT) {
		...
		if (_Context->trigger_Auto2707 == mb ) return(2);
		if (_Context->trigger1_Primary == mb ) return(3);
		if (_Context->trigger_Auto2708 == mb ) return(4);
...
public	int	accept_camera_alignment_focus(struct accept_camera_alignment_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			case	0x2 :
				/* Auto2707 */
				_Context->trigger_Auto2707=visual_trigger_code(_Context->msg_Auto2707[_Context->language],strlen(_Context->msg_Auto2707[_Context->language]));
				visual_button(150,365,126,32,vfh[2],27,28,_Context->msg_Auto2707[_Context->language],strlen(_Context->msg_Auto2707[_Context->language]),2);
	...
	visual_button(150,365,126,32,vfh[2],27,28,_Context->msg_Auto2707[_Context->language],strlen(_Context->msg_Auto2707[_Context->language]),0);
			...
			case	0x4 :
				/* Auto2708 */
				_Context->trigger_Auto2708=visual_trigger_code(_Context->msg_Auto2708[_Context->language],strlen(_Context->msg_Auto2708[_Context->language]));
				visual_button(520,365,128,32,vfh[2],27,28,_Context->msg_Auto2708[_Context->language],strlen(_Context->msg_Auto2708[_Context->language]),2);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto2708=visual_trigger_code(_Context->msg_Auto2708[_Context->language],strlen(_Context->msg_Auto2708[_Context->language]));
	visual_button(520,365,128,32,vfh[2],27,28,_Context->msg_Auto2708[_Context->language],strlen(_Context->msg_Auto2708[_Context->language]),0);
				break;
...
retry:
	...
	visual_button(150,365,126,32,vfh[2],27,28,_Context->msg_Auto2707[_Context->language],strlen(_Context->msg_Auto2707[_Context->language]),0);
					...
					if ((_Context->keycode = on_Auto2707_event(_Context)) != -1) break;
	...
	visual_button(520,365,128,32,vfh[2],27,28,_Context->msg_Auto2708[_Context->language],strlen(_Context->msg_Auto2708[_Context->language]),0);
					...
					if ( visual_event(1) &  0x20 ) {
					if ((_Context->keycode = on_Auto2708_event(_Context)) != -1) break;
