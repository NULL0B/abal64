...
/* Project        : vimport.xml                                              */
/* Target         : vimport.c                                                */
/* Identification : 0.0-1180765707-12576.12575                               */
/* ------------------------------------------------------------------------- */
...
#define en_Auto2672   "ok.gif"
#define fr_Auto2672   "ok.gif"
#define it_Auto2672   "ok.gif"
#define es_Auto2672   "ok.gif"
#define de_Auto2672   "ok.gif"
#define nl_Auto2672   "ok.gif"
#define pt_Auto2672   "ok.gif"
#define xx_Auto2672   "ok.gif"
#define en__Auto2672   ""
#define fr__Auto2672   ""
#define it__Auto2672   ""
#define es__Auto2672   ""
...
private struct accept_font_import_context {
	...
	char * msg_Auto2672[8];
	int	trigger_Auto2672;
	char * hint_Auto2672[8];
	char * msg_Cancel[8];
	int	trigger_Cancel;
	char * hint_Cancel[8];
	int	ctrlbuffer;
	...
	char * pCellHeight)
{
	...
	for (i=0; i < 8; i++)_Context->msg_Auto2672[i]=" ";
	_Context->msg_Auto2672[0]=en_Auto2672;
	_Context->msg_Auto2672[1]=fr_Auto2672;
	_Context->msg_Auto2672[2]=it_Auto2672;
	_Context->msg_Auto2672[3]=es_Auto2672;
	_Context->msg_Auto2672[4]=de_Auto2672;
	_Context->msg_Auto2672[5]=nl_Auto2672;
	_Context->msg_Auto2672[6]=pt_Auto2672;
	_Context->msg_Auto2672[7]=xx_Auto2672;
	_Context->hint_Auto2672[0]=en__Auto2672;
	_Context->hint_Auto2672[1]=fr__Auto2672;
	_Context->hint_Auto2672[2]=it__Auto2672;
	_Context->hint_Auto2672[3]=es__Auto2672;
	_Context->hint_Auto2672[4]=de__Auto2672;
	_Context->hint_Auto2672[5]=nl__Auto2672;
	_Context->hint_Auto2672[6]=pt__Auto2672;
	_Context->hint_Auto2672[7]=xx__Auto2672;
...
public	int	accept_font_import_show(struct accept_font_import_context * _Context)
{
	...
	_Context->trigger_Auto2672=visual_trigger_code(_Context->msg_Auto2672[_Context->language],strlen(_Context->msg_Auto2672[_Context->language]));
	visual_button(_Context->x_auto2+100,_Context->y_auto2+190,56,48,vfh[2],26,0,_Context->msg_Auto2672[_Context->language],strlen(_Context->msg_Auto2672[_Context->language]),1040);
...
private int on_Auto2672_event(struct accept_font_import_context * _Context) {
	return(13);
	return(-1);
}
...
struct accept_font_import_context * _Context){
	...
	if (visual_event(1) & _MIMO_ALT) {
		...
		if (_Context->trigger_Auto2672 == mb ) return(4);
	...
	while(1) {
		switch (_Context->focus_item) {
			...
			case	0x4 :
				/* Auto2672 */
				_Context->trigger_Auto2672=visual_trigger_code(_Context->msg_Auto2672[_Context->language],strlen(_Context->msg_Auto2672[_Context->language]));
				visual_button(_Context->x_auto2+100,_Context->y_auto2+190,56,48,vfh[2],26,0,_Context->msg_Auto2672[_Context->language],strlen(_Context->msg_Auto2672[_Context->language]),1042);
...
retry:
		...
		case	0x100 :
			...
			if (( visual_event(1) == _MIMO_DOWN ) && ( visual_event(2) == _MIMO_RIGHT)) {
				switch ((_Context->focus_item = retcode)) {
					...
					case	0x4 :
						if (Auto2672_help(_Context) != 0) { continue; }
						else { break; }
					case	0x5 :
	...
	visual_button(_Context->x_auto2+100,_Context->y_auto2+190,56,48,vfh[2],26,0,_Context->msg_Auto2672[_Context->language],strlen(_Context->msg_Auto2672[_Context->language]),1040);
					...
					if ((_Context->keycode = on_Auto2672_event(_Context)) != -1) break;
