...
public 	int	accept_introduction_create()
{
...
public  int	accept_introduction_hide()
{

	return(0);
}

public 	int	accept_introduction_remove()
{
...
public 	int	accept_introduction_show()
{
	visual_freeze();
	visual_window(255,100,290,400,2,"Sing : Version 1.1",18,0x400);
	...
	visual_text(275,450,250,20,2,27,0,"Copyright 2006 Amenesik / Sologic",32,3);
