...
EXAWORD	value;
{
	if ((desc & 0x0060) == 0x0060) {
		...
		switch (( worktyp1 & VARB_ISOL))  {
			case	VARB_FOUR	:
			case	VARB_INT8	: *workptr1 = (EXABYTE) value; break;
			case 	VARB_INT16	: balputw(value,workptr1);  break;
			case 	VARB_INT32	: balputl(value,workptr1);  break;
			case 	VARB_INT64	: balput64(value,workptr1);  break;
			}
		}
	return;
}
...
EXAWORD	event_spawn()
{
	...
	/* ---------------------------- */
	if ((childid = LowLevelSpawn()) == MOINS_UN) {
