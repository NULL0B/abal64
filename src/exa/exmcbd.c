...
/*----------------------------------------------------------------------*/
/* Replaces the ASM functions which interface with MC/BD under Prologue	*/
/* -------------------------------------------------------------------- */
/*									*/
...
EXAWORD	func;		/* Code Fonction Type SF Prologue		*/
EXAWORD	pvarid;		/* Variable ID for Collect Result storage	*/
{
