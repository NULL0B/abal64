...
/*------------*/
	...
	VOID	posepiege(EXAWORD,EXAWORD,EXAWORD,EXAWORD,BPTR);
/*------------*/
/* EXDBSYMB.C */
/*------------*/
...
/*    EXI.C   */
/*------------*/
	BPTR	abal_crypt(unsigned short int pkey, BPTR sptr, unsigned short int slen, unsigned short int mode);	/* unsigned short int ,BPTR ,unsigned short int ,unsigned short int */
/*------------*/
/* EXPARSER.C */
/*------------*/
	EXAWORD	fn_parser();	/* BPTR,BPTR,EXAWORD */
...
/*	VOID	pos();	*/	/* EXAWORD  EXAWORD */
	VOID	x_bstart();	/* VOID */
	VOID	x_bflush();	/* VOID */
#if !defined(AVIION) && !defined(RT_AIX) && !defined(LINUX) && !defined(HPUX)
	VOID	x_putch();	/* EXAWORD */
	VOID	x_cprintf();	/* BPTR */
#endif
/*------------*/
...
#define	TRAPTR VPTR
#endif
	TRAPTR 	posepiege();	/* EXAWORD,EXAWORD,EXAWORD,EXAWORD */
#endif
/*------------*/
/* EXDBSYMB.C */
/*------------*/
