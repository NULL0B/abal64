...
#include "extweak.c"		/* Extension de KBF */
...
#ifdef	ABAL64
#include "exclf3.c"		/* Screen management functions		*/
#endif
...
EXAWORD	desc;
{
	...
	switch ( awtyp & VARB_ISOL ) {
		...
		case VARB_INT16: awlen = ABALWORDSIZE; break;
		case VARB_INT32: awlen = (2*ABALWORDSIZE); break;
		case VARB_INT64: awlen = (4*ABALWORDSIZE); break;
