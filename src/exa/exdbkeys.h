...
//#BG 31/10/19 CTRL W plus utilise car ferme onglet TWeb dans Chrome!
//#define	DB_WDWSWAP	0x0017		/* Ctrl W : Change View Window	*/
#define	DB_RUN		0x0018		/* Ctrl X : Execution Continue	*/
//#BG 31/10/19#define	DB_ZOOM		0x001A		/* Ctrl Z : Zoom display ligne	*/
#define	DB_WDWSWAP	0x001A		/* Ctrl Z : Change View Window	*/
