...
EXAWORD	mode;	/* Extraction type Bit definitions			*/
		/* ---------------------------------------------------- */
		/*		   1	0X0001 NetWork Node Name		*/
		/*		   2	0x0002 Device Mnemonic			*/
		/*		   4	0x0004 Path name only			*/
		/*		   8  0x0008 FileName portion		*/
		/*		   16	0x0010 Extension and separator		*/
		/*		   32	0x0020 Amenesik / Sologic Password		*/
		/*		   64 0x0040 VMS Version Number 		*/
		/*		  128	0x0080 Convert to Upper Case		*/
		/*		  256 0x0100 Do not Terminate 1st byte	*/
		/*		        (used by execute_with_path)	*/
		/* 	  512 0x0200 Return Required field separator */
		/* ---------------------------------------------------- */
{
	EXAWORD	ai;
	EXAWORD	bi;
