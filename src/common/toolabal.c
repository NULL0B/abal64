...
if (  ( rt_arg.c > iRtArg )
   ...
   {
   MI_TRACE((CI_TRA_F_DUMP ,CI_MODULE_ID,TFN,"rt_arg",&rt_arg,sizeof(rt_arg)));// pour test (à virer)
   MI_TRACE((CI_TRA_F_ERROR,CI_MODULE_ID,TFN,"rt_arg.c=%u , i=%u",rt_arg.c,iRtArg));
   return NULL;
   }
}
