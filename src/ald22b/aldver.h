...
#define VER_FILEVERSION_STR      "2.2b.0.06\0"
#define VER_FILEVERSION_STRC     "22b006"
...
#define VER_ORIGINALFILENAME_STR     "ald.xp\0"
#define VER_PRODUCTNAME_STR          "ABAL Linker for TwinServer\0"

#elif defined(__linux__) || defined(BDA_UNIX)
#define VER_ORIGINALFILENAME_STR     "ald\0"
#define VER_PRODUCTNAME_STR          "ABAL Linker for UseIt\0"

#elif defined(WIN32) || defined(_WIN32) || defined(BDA_WIN32)
#define VER_ORIGINALFILENAME_STR     "wald32.exe\0"
#define VER_PRODUCTNAME_STR          "ABAL for Windows Linker 32 bits\0"
...
#define VER_INTERNALNAME_STR          "Ald\0"
...
//#include "banbuild.h"
		...
		#define VER_BUILD_STR		"DX      \0"
	#else
		#define VER_BUILD_STR		"D       \0"	
	#endif
#else
	#ifdef VERSION_XX            //123456789\0   
		#define VER_BUILD_STR		"RX      \0"
	#else
