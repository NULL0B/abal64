...
EXAWORD EeEmc_count(EX_FILE_HANDLE, BPTR, EXAWORD, EXAWORD, EXAWORD, EXALONG SPTR);
...
EXAWORD EeEbd_count(EX_FILE_HANDLE, BPTR, EXAWORD, EXAWORD, EXAWORD, EXALONG SPTR);
