...
#undef 	PROTOTYPE_ARGS
#endif
#endif
#endif

#ifndef	PROTOTYPE_ARGS
#include heap of shit
#endif
#ifdef	PROTOTYPE_ARGS
...
/*	------------	*/
  ...
  long    	 atol(BPTR ,EXAWORD );
  long    	 bcdtol(BPTR ,EXAWORD );
...
/*	------------	*/
  ...
  VOID 	  LibFuse(struct fusework SPTR,EXAWORD);
...
EXALONG			mc_key(EX_FILE_HANDLE,EXAWORD,BPTR,EXAWORD,EXAWORD);
...
/*	-----------	*/
  ...
  VOID    traitfilerror();	/* EXAWORD ,EXAWORD 	*/
  VOID    simcprep();	/* EXAWORD 	*/
  EXAWORD fargset();	/* EXAWORD 	*/
  EXAWORD largset();	/* EXAWORD 	*/
  EXAWORD si_prep();	/* EXAWORD 	*/
