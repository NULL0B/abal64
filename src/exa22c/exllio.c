...
extern	EXAWORD	prndest;	/* Current Ouput Device			*/
extern	EXAWORD	prnleng;	/* Output buffer length			*/
extern	BPTR	prnptr;		/* Output buffer pointer		*/
extern	EXAWORD	prndex;		/* Output buffer index			*/
extern	EXAWORD	err_val;	/* CICO error communication		*/
