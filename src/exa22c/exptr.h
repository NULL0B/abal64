...
#ifndef	UNIX
#ifndef VMS
#define	TcodeGetPointer( gadr )       ( *gadr ? *((BPTR SPTR) (gadr + 1)) : (BPTR) 0 ) 
#define	TcodePutPointer( padr, ptr )  *((BPTR SPTR) (padr + 1)) = ptr
#endif
#endif
#ifndef	DOS
#ifndef PROLOGUE
...
#define	DYNOPTR	struct dynamic_control SPTR
...
#define PROGRAM_POINTER			0x0085

/*	---------------------------	*/
/*	Pointer manipulation macros	*/
/*	---------------------------	*/

#define	raz_pointer_variable( a ) 	memset( a , 0, ABALPTRSIZE )
