...
/*		--------------------------------			*/
EXTERN	EXAWORD	FuseCtrl;	/* Nombre de fonctions utilisateurs	*/

EXTERN	EX_FILE_HANDLE TcodeFileHandle;	/* Tcode file system handle	*/

EXTERN	struct fichdt   SPTR AssignTable;      /* Tcode File Table	   */
EXTERN	struct segmform SPTR TcodeSegmentTable;/* Tcode Segment Table      */
EXTERN  struct procform SPTR TcodeProcTable;   /* Tcode Procedure Table    */
...
#ifdef	WIN32
EXTERN	EXAWORD	f_clf5(EXAWORD);
EXTERN	EXAWORD	f_clf6(EXAWORD);
#else
