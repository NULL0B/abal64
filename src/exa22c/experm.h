...
#ifdef	ABALSQL
#define		NGF_SQL			0x00C0	/* SQL ORACLE ETC	*/
#endif
...
#define		ASS_NAME_VALID		0x0100	/* File name zone has  	*/
						/* been allocated   	*/
#define		ASS_BUFF_VALID		0x0200	/* Print or MC Buffer	*/
						/* has been allocated	*/
#define		ASS_BASE_VALID		0x0400	/* Data Base Structure	*/
						/* has been allocated	*/
#define		ASS_VIRT_VALID		0x0800	/* A Virtuel memory 	*/
						/* operation has been	*/
						/* performed on file	*/
#define		ASS_LOAD_VALID		0x1000	/* A executable image	*/
						/* is currently loaded	*/
#ifdef	ABAL21
...
#define		ASS_FIND_VALID		0x8000	/* A FIND operation has	*/
						/* been performed	*/
