...
WORD  status;
  ...
  g_pTabFont->FirstItemForUserFont = hFont+1+CE_FONTID_ADJUST;
...
// * VarGlob:
// ****************************************************************************
WORD BDA_WINAPI BdaTxt_zFont(SWORD fontID)       
{
...
// * VarGlob:
// ****************************************************************************
WORD BDA_WINAPI BdaTxt_zFontChoose(PTRC pFontDesc)
{
...
strcpy( Path, g_pApp->PathFont );
strcat( Path, pFontDesc);
MI_TRACE((CI_TRA_F_DEBUG,CI_MODULE_ID,TFN,"'%s'",Path));
