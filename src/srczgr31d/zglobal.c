...
// Fch:08-02-2002 
// add this variable to change language by patch instead of multi-compilation
char FAR PTR  g_pLanguage = "\0PRL_LANGUAGE (0=French,1=English)";

unsigned char g_VgaPalette[256][4] = 
{
...
//screen text & graphic variables
//Is borrowed at Jammie zGlobal.c

SWORD bmp_error_code=0;
SWORD window_error_code=0;
  ...
  SWORD   g_VesaMode=-1;  // returned mode after init (-1=err, 0->n graphic mode)
  
// -----------------------------------------
// Font
// -----------------------------------------
BYTE  g_FontRescueBuffer[8192];
...
// Win32 or Twin16
TI_APP_CONTEXT  g_App;
SWORD gCptAlloc=0;

// ( For Win16 (1 instance, many applications)
// ( PTI_APP_CONTEXT  g_App[CI_MAXAPPLI];
// ( WORD             g_noApp;
// ( for each instance of application, 
// ( do a dynamic allocation of TI_APP_CONTEXT and manage g_noApp
// ( in DllMain and Wep
...
// Pointers on global informations
// Permits to do abstraction of implementation Win16 or other
PTI_TABFONT      g_pTabFont;
PTI_MEMO_APPLI   g_pApp;
PTI_RECTANGLE    g_pClip;
PTI_MEMO_PRINT   g_pPrint;
PTI_MEMO_CARET   g_pCaret;
PTI_MEMO_LOOK    g_pLook;
PTI_PUPO         g_pPuPo;
PTI_BMP          g_pBmp;  
