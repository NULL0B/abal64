...
// * VarGlob:
// ****************************************************************************
WORD BDA_WINAPI BdaGui_zListHoriScrollBar(WORD x,WORD y,WORD flag,WORD larg,WORD pos,WORD size,WORD state)
{
...
WORD BDA_WINAPI BdaGui_zLisFicScrollBar(WORD x,WORD y,WORD larg,WORD haut,WORD state)
{
