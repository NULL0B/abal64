...
// * VarGlob:
// ****************************************************************************
WORD BDA_WINAPI BdaGui_zPrintVar(WORD state,WORD x,WORD y,PTRC var)
{
...
WORD SpaceKiller(PTRC phrase,WORD lg){
  int i;
  //for(i=0;(i<lg) ;i++){
  for(i=lg;--i>=0;){
...
WORD BDA_WINAPI BdaGui_zPrintItem(WORD x,WORD y,WORD lg,PTRC phrase,PTRC car,WORD coul1,WORD coul2,WORD child)
{
