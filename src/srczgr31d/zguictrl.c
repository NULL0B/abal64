...
// * VarGlob:
// ****************************************************************************
WORD BDA_WINAPI BdaGui_zF1Button(WORD state,WORD x,WORD y)
{
...
// * VarGlob:
// ****************************************************************************
WORD BDA_WINAPI BdaGui_zVaButton(WORD state,WORD x,WORD y)
{
...
// * VarGlob:
// ****************************************************************************
WORD BDA_WINAPI BdaGui_zCheck(WORD state,WORD actif,WORD x,WORD y,WORD coul,WORD fond)
{
...
// * VarGlob:
// ****************************************************************************
WORD BDA_WINAPI BdaGui_zRadio(WORD state,WORD actif,WORD x,WORD y,WORD coul,WORD fond)
{
