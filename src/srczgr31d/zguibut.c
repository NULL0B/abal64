...
// * VarGlob:
// ****************************************************************************
void zButton_Internal(WORD State,WORD t,WORD x,WORD y,WORD c,PTRC text,WORD lg,PTRC cle)
{
...
// * VarGlob:
// ****************************************************************************
WORD BDA_WINAPI BdaGui_zButton(WORD State,WORD t,WORD x,WORD y,WORD c,PTRC text,WORD lg,PTRC cle)
{
...
// * VarGlob:
// ****************************************************************************
WORD BDA_WINAPI BdaGui_zSmallButton(WORD State,WORD x,WORD y,WORD c,PTRC text,WORD lg,PTRC cle)
{
...
// * VarGlob:
// ****************************************************************************
WORD BDA_WINAPI BdaGui_zTabview(WORD State,WORD verti,WORD x,WORD y,WORD c,PTRC text,WORD lg,PTRC cle)
{
