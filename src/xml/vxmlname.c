...
#define en_Auto3631   "Filename"
#define fr_Auto3631   "Fichier"
#define it_Auto3631   "Filename"
#define es_Auto3631   "Filename"
#define de_Auto3631   "Datei"
#define nl_Auto3631   "Filename"
#define pt_Auto3631   "Filename"
#define xx_Auto3631   "Filename"
#define en__Auto3631   ""
#define fr__Auto3631   ""
#define it__Auto3631   ""
#define es__Auto3631   ""
	...
	char * pNature)
{
	...
	_Context->x_Auto3630=100;
	_Context->y_Auto3630=195;
	_Context->w_Auto3630=600;
	_Context->h_Auto3630=210;
...
public	int	accept_xml_filename_show(struct accept_xml_filename_context * _Context)
{
	...
	visual_text(130,295,98,16,vfh[2],16,0,_Context->msg_Auto3631[_Context->language],strlen(_Context->msg_Auto3631[_Context->language]),2);
...
private int Auto3630action(struct accept_xml_filename_context * _Context) {
	...
	do {
		...
		_Context->x_Auto3630 += (visual_event(7)-x);
		x=visual_event(7);
		if (_Context->x_Auto3630 < 0) { _Context->x_Auto3630=0; }
		_Context->y_Auto3630 += (visual_event(6)-y);
		y=visual_event(6);
		if (_Context->y_Auto3630 < 0) { _Context->y_Auto3630=0; }
...
struct accept_xml_filename_context * _Context){
	...
	case _MIMO_DOWN :
		...
		&&  (mx <= (100+532) )  
		&&  (my <= (195+20) )) {
			return( Auto3630action(_Context) );
			}
		}
	if (( mx >= 230 ) 
	&&  ( my >= 295 ) 
