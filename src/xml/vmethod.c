...
#define en_Auto3575   "Visual Forms Method"
#define fr_Auto3575   "M‚thodes du formulaire"
#define it_Auto3575   "Visual Forms Method"
#define es_Auto3575   "Visual Forms Method"
#define de_Auto3575   "Visual Forms Method"
#define nl_Auto3575   "Visual Forms Method"
#define pt_Auto3575   "Visual Forms Method"
#define xx_Auto3575   "Visual Forms Method"
#define en_Auto3576   "Nature"
#define fr_Auto3576   "Nature"
#define it_Auto3576   "Nature"
#define es_Auto3576   "Nature"
#define de_Auto3576   "Nature"
#define nl_Auto3576   "Nature"
#define pt_Auto3576   "Nature"
#define xx_Auto3576   "Nature"
#define en_Auto3577   "Name"
#define fr_Auto3577   "Nom"
#define it_Auto3577   "Name"
#define es_Auto3577   "Name"
#define de_Auto3577   "Name"
#define nl_Auto3577   "Name"
#define pt_Auto3577   "Name"
#define xx_Auto3577   "Name"
#define en_Auto3578   "Parameters"
#define fr_Auto3578   "ParamŠtres"
#define it_Auto3578   "Parameters"
#define es_Auto3578   "Parameters"
#define de_Auto3578   "Parameters"
#define nl_Auto3578   "Parameters"
#define pt_Auto3578   "Parameters"
#define xx_Auto3578   "Parameters"
...
#define en_Auto3579   "ok.gif"
#define fr_Auto3579   "ok.gif"
#define it_Auto3579   "ok.gif"
#define es_Auto3579   "ok.gif"
#define de_Auto3579   "ok.gif"
#define nl_Auto3579   "ok.gif"
#define pt_Auto3579   "ok.gif"
#define xx_Auto3579   "ok.gif"
#define en__Auto3579   ""
#define fr__Auto3579   ""
#define it__Auto3579   ""
#define es__Auto3579   ""
...
#define pt__Auto3579   ""
#define xx__Auto3579   ""
#define en_Auto3580   "screen.gif"
#define fr_Auto3580   "screen.gif"
#define it_Auto3580   "screen.gif"
#define es_Auto3580   "screen.gif"
#define de_Auto3580   "screen.gif"
#define nl_Auto3580   "screen.gif"
#define pt_Auto3580   "screen.gif"
#define xx_Auto3580   "screen.gif"
#define en__Auto3580   ""
#define en_Auto3581   "cancel.gif"
#define fr_Auto3581   "cancel.gif"
#define it_Auto3581   "cancel.gif"
#define es_Auto3581   "cancel.gif"
#define de_Auto3581   "cancel.gif"
#define nl_Auto3581   "cancel.gif"
#define pt_Auto3581   "cancel.gif"
#define xx_Auto3581   "cancel.gif"
...
private struct accept_forms_method_context {
	...
	char * msg_Auto3579[8];
	int	trigger_Auto3579;
	char * hint_Auto3579[8];
	char * msg_Auto3580[8];
	int	trigger_Auto3580;
	char * hint_Auto3580[8];
	char * msg_Auto3581[8];
	int	trigger_Auto3581;
...
private int on_Auto3579_event(struct accept_forms_method_context * _Context);
private int on_Auto3580_event(struct accept_forms_method_context * _Context);
private int on_Auto3581_event(struct accept_forms_method_context * _Context);
	...
	char * pMethodText)
{
	...
	_Context->x_Auto3574=75;
	_Context->y_Auto3574=45;
	_Context->w_Auto3574=650;
	_Context->h_Auto3574=510;
	...
	_Context->pushbuffer=visual_buffer(_Context->x_Auto3574,_Context->y_Auto3574,650+10,510+10);
	return(0);
}
...
public 	int	accept_forms_method_hide(struct accept_forms_method_context * _Context)
{
	...
	&& (_Context->ctrlbuffer != 0)) {
		(void)visual_buffer_put(_Context->pushbuffer,_Context->x_Auto3574,_Context->y_Auto3574);
		_Context->ctrlbuffer=0;
		}
...
private int on_BodyPage_show(struct accept_forms_method_context * _Context) {
	open_window_editor(_Context->x_Auto3574+40,_Context->y_Auto3574+70,
	570,360,_Context->buffer_MethodText);
	return(-1);
}
private int on_MethodText_show(struct accept_forms_method_context * _Context) {
	visual_frame(_Context->x_Auto3574+40,_Context->y_Auto3574+70,570+2,360+2,5);
;
	show_window_editor();
	return(-1);
}
...
public	int	accept_forms_method_show(struct accept_forms_method_context * _Context)
{
	...
	if ((_Context->pushbuffer != (void *) 0)
	&& (!(_Context->ctrlbuffer))) {
		(void)visual_buffer_get(_Context->pushbuffer,_Context->x_Auto3574,_Context->y_Auto3574);
		_Context->ctrlbuffer=1;
		}
	visual_freeze();
	if (((_Context->status = visual_styled_element(_Context->x_Auto3574,_Context->y_Auto3574,650,510,GetWidgetStyle(0),GetWindowVersion(),strlen(GetWindowVersion()))) != 0)
) {
		visual_window(_Context->x_Auto3574,_Context->y_Auto3574,650,510,vfh[2],GetWindowVersion(),strlen(GetWindowVersion()),0x407);
		}
	...
	visual_tabpage(_Context->x_Auto3574+20,_Context->y_Auto3574+30,610,410,vfh[2],_Context->msg_MethodPage[_Context->language],strlen(_Context->msg_MethodPage[_Context->language]),0,2);
	} else {
		visual_tabpage(_Context->x_Auto3574+20,_Context->y_Auto3574+30,610,410,vfh[2],_Context->msg_MethodPage[_Context->language],strlen(_Context->msg_MethodPage[_Context->language]),0,0);
		}
	if (_Context->page_number == 1 ) {
	visual_text(_Context->x_Auto3574+30,_Context->y_Auto3574+60,590,30,vfh[3],16,0,_Context->msg_Auto3575[_Context->language],strlen(_Context->msg_Auto3575[_Context->language]),1283);
		}
	if (_Context->page_number == 1 ) {
	visual_text(_Context->x_Auto3574+40,_Context->y_Auto3574+170,88,16,vfh[2],16,0,_Context->msg_Auto3576[_Context->language],strlen(_Context->msg_Auto3576[_Context->language]),258);
		}
	if (_Context->page_number == 1 ) {
	visual_text(_Context->x_Auto3574+40,_Context->y_Auto3574+200,100,20,vfh[2],16,0,_Context->msg_Auto3577[_Context->language],strlen(_Context->msg_Auto3577[_Context->language]),258);
		}
	if (_Context->page_number == 1 ) {
	visual_text(_Context->x_Auto3574+40,_Context->y_Auto3574+230,88,16,vfh[2],16,0,_Context->msg_Auto3578[_Context->language],strlen(_Context->msg_Auto3578[_Context->language]),258);
		}
	if (_Context->page_number == 1 ) {
	...
	visual_check(_Context->x_Auto3574+40,_Context->y_Auto3574+100,98,16,vfh[2],27,28,_Context->msg_IsPublic[_Context->language],strlen(_Context->msg_IsPublic[_Context->language]),_Context->value_IsPublic|0);
		}
	if (_Context->page_number == 1 ) {
	...
	visual_check(_Context->x_Auto3574+40,_Context->y_Auto3574+130,98,16,vfh[2],27,28,_Context->msg_IsExtern[_Context->language],strlen(_Context->msg_IsExtern[_Context->language]),_Context->value_IsExtern|0);
		}
	if (_Context->page_number == 1 ) {
	...
	visual_check(_Context->x_Auto3574+300,_Context->y_Auto3574+100,104,16,vfh[2],27,28,_Context->msg_IsPointer[_Context->language],strlen(_Context->msg_IsPointer[_Context->language]),_Context->value_IsPointer|0);
		}
	if (_Context->page_number == 1 ) {
	visual_select(_Context->x_Auto3574+140,_Context->y_Auto3574+100,140,160,vfh[2],27,28,parse_selection(_Context->msg_MethodType[_Context->language],&_Context->value_MethodType),768);
		}
	if (_Context->page_number == 1 ) {
	visual_frame(_Context->x_Auto3574+140,_Context->y_Auto3574+130,472+2,16+2,5);
	visual_text(_Context->x_Auto3574+140+1,_Context->y_Auto3574+130+1,472,16,vfh[1],27,28,_Context->buffer_MethodClass,255,0);
		}
	if (_Context->page_number == 1 ) {
	...
	visual_radio(_Context->x_Auto3574+140,_Context->y_Auto3574+170,84,16,vfh[2],27,28,_Context->msg1_MethodNature[_Context->language],strlen(_Context->msg1_MethodNature[_Context->language]),_Context->value_MethodNature,1);
		}
	if (_Context->page_number == 1 ) {
	...
	visual_radio(_Context->x_Auto3574+240,_Context->y_Auto3574+170,112,16,vfh[2],27,28,_Context->msg2_MethodNature[_Context->language],strlen(_Context->msg2_MethodNature[_Context->language]),_Context->value_MethodNature,2);
		}
	if (_Context->page_number == 1 ) {
	...
	visual_radio(_Context->x_Auto3574+360,_Context->y_Auto3574+170,126,16,vfh[2],27,28,_Context->msg3_MethodNature[_Context->language],strlen(_Context->msg3_MethodNature[_Context->language]),_Context->value_MethodNature,3);
		}
	if (_Context->page_number == 1 ) {
	...
	visual_radio(_Context->x_Auto3574+500,_Context->y_Auto3574+170,98,16,vfh[2],27,28,_Context->msg4_MethodNature[_Context->language],strlen(_Context->msg4_MethodNature[_Context->language]),_Context->value_MethodNature,4);
		}
	if (_Context->page_number == 1 ) {
	visual_frame(_Context->x_Auto3574+140,_Context->y_Auto3574+200,472+2,16+2,5);
	visual_text(_Context->x_Auto3574+140+1,_Context->y_Auto3574+200+1,472,16,vfh[1],0,0,_Context->buffer_MethodName,255,0);
		}
	if (_Context->page_number == 1 ) {
	visual_frame(_Context->x_Auto3574+140,_Context->y_Auto3574+230,472+2,192+2,5);
	visual_text(_Context->x_Auto3574+140+1,_Context->y_Auto3574+230+1,472,192,vfh[1],0,0,_Context->buffer_Signature,708,0);
		}
	...
	visual_tabpage(_Context->x_Auto3574+20,_Context->y_Auto3574+30,610,410,vfh[2],_Context->msg_BodyPage[_Context->language],strlen(_Context->msg_BodyPage[_Context->language]),96,2);
		(void) on_BodyPage_show(_Context);
	} else {
		visual_tabpage(_Context->x_Auto3574+20,_Context->y_Auto3574+30,610,410,vfh[2],_Context->msg_BodyPage[_Context->language],strlen(_Context->msg_BodyPage[_Context->language]),96,0);
		}
	if (_Context->page_number == 2 ) {
	(void) on_MethodText_show(_Context);
		}
	_Context->trigger_Auto3579=visual_trigger_code(_Context->msg_Auto3579[_Context->language],strlen(_Context->msg_Auto3579[_Context->language]));
	visual_button(_Context->x_Auto3574+30,_Context->y_Auto3574+450,56,48,vfh[2],34,0,_Context->msg_Auto3579[_Context->language],strlen(_Context->msg_Auto3579[_Context->language]),1040);
	_Context->trigger_Auto3580=visual_trigger_code(_Context->msg_Auto3580[_Context->language],strlen(_Context->msg_Auto3580[_Context->language]));
	visual_button(_Context->x_Auto3574+310,_Context->y_Auto3574+450,56,48,vfh[2],28,28,_Context->msg_Auto3580[_Context->language],strlen(_Context->msg_Auto3580[_Context->language]),1040);
	_Context->trigger_Auto3581=visual_trigger_code(_Context->msg_Auto3581[_Context->language],strlen(_Context->msg_Auto3581[_Context->language]));
	visual_button(_Context->x_Auto3574+560,_Context->y_Auto3574+450,56,48,vfh[2],34,0,_Context->msg_Auto3581[_Context->language],strlen(_Context->msg_Auto3581[_Context->language]),1040);
	visual_thaw(_Context->x_Auto3574,_Context->y_Auto3574,650,510);
...
private int MethodText_help()
{
	switch (visual_national_language(-1)) {
		case 0 : 
			{
			char * mptr[2];
			mptr[0] = "This edit field allows the application source code to be edited using ";
...
private int Auto3574action(struct accept_forms_method_context * _Context) {
	...
	do {
		...
		_Context->x_Auto3574 += (visual_event(7)-x);
		x=visual_event(7);
		if (_Context->x_Auto3574 < 0) { _Context->x_Auto3574=0; }
		_Context->y_Auto3574 += (visual_event(6)-y);
		y=visual_event(6);
		if (_Context->y_Auto3574 < 0) { _Context->y_Auto3574=0; }
...
struct accept_forms_method_context * _Context){
	...
	if (visual_event(1) & _MIMO_ALT) {
		...
		if (_Context->trigger_Auto3579 == mb ) return(16);
		if (_Context->trigger_Auto3580 == mb ) return(17);
		if (_Context->trigger_Auto3581 == mb ) return(18);
		return(-1);
		}
	...
	switch (mt) {
	case _MIMO_UP :
	if ((mx >= (_Context->x_Auto3574+629) )  
	&&  (my >= (_Context->y_Auto3574+4) )  
	&&  (mx <= (_Context->x_Auto3574+646) )  
	&&  (my <= (_Context->y_Auto3574+20) )) {
		return(1);	/* Auto3574 */

		}
	if ((mx >= (_Context->x_Auto3574+613) )  
	&&  (my >= (_Context->y_Auto3574+4) )  
	&&  (mx <= (_Context->x_Auto3574+630) )  
	&&  (my <= (_Context->y_Auto3574+20) )) {
	...
	if ((mx >= (_Context->x_Auto3574+597) )  
	&&  (my >= (_Context->y_Auto3574+4) )  
	&&  (mx <= (_Context->x_Auto3574+614) )  
	&&  (my <= (_Context->y_Auto3574+20) )) {
	...
	case _MIMO_DOWN :
		if ((mx >= (_Context->x_Auto3574+4) )  
		&&  (my >= (_Context->y_Auto3574+4) )  
		&&  (mx <= (_Context->x_Auto3574+582) )  
		&&  (my <= (_Context->y_Auto3574+20) )) {
			return( Auto3574action(_Context) );
			}
		}
	if (_Context->page_number == 1 ) {
	} else {
		if (( mx >= (_Context->x_Auto3574+20+0) ) 
		&&  ( my >= (_Context->y_Auto3574+30) ) 
		&&  ( mx <= (_Context->x_Auto3574+20+95) ) 
		&&  ( my <= (_Context->y_Auto3574+30+24))) {
			return(2); /* MethodPage */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto3574+40) ) 
		&&  ( my >= (_Context->y_Auto3574+100) ) 
		&&  ( mx <= (_Context->x_Auto3574+40+98) ) 
		&&  ( my <= (_Context->y_Auto3574+100+16))) {
			return(3); /* IsPublic */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto3574+40) ) 
		&&  ( my >= (_Context->y_Auto3574+130) ) 
		&&  ( mx <= (_Context->x_Auto3574+40+98) ) 
		&&  ( my <= (_Context->y_Auto3574+130+16))) {
			return(4); /* IsExtern */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto3574+300) ) 
		&&  ( my >= (_Context->y_Auto3574+100) ) 
		&&  ( mx <= (_Context->x_Auto3574+300+104) ) 
		&&  ( my <= (_Context->y_Auto3574+100+16))) {
			return(5); /* IsPointer */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto3574+140+0) ) 
		&&  ( my >= (_Context->y_Auto3574+100) ) 
		&&  ( mx <= (_Context->x_Auto3574+140+140) ) 
		&&  ( my <= (_Context->y_Auto3574+100+16))) {
			return(6); /* MethodType */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto3574+140) ) 
		&&  ( my >= (_Context->y_Auto3574+130) ) 
		&&  ( mx <= (_Context->x_Auto3574+140+472) ) 
		&&  ( my <= (_Context->y_Auto3574+130+16))) {
	...
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto3574+140) ) 
		&&  ( my >= (_Context->y_Auto3574+170) ) 
		&&  ( mx <= (_Context->x_Auto3574+140+84) ) 
		&&  ( my <= (_Context->y_Auto3574+170+16))) {
			return(8); /* MethodNature */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto3574+240) ) 
		&&  ( my >= (_Context->y_Auto3574+170) ) 
		&&  ( mx <= (_Context->x_Auto3574+240+112) ) 
		&&  ( my <= (_Context->y_Auto3574+170+16))) {
			return(9); /* MethodNature */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto3574+360) ) 
		&&  ( my >= (_Context->y_Auto3574+170) ) 
		&&  ( mx <= (_Context->x_Auto3574+360+126) ) 
		&&  ( my <= (_Context->y_Auto3574+170+16))) {
			return(10); /* MethodNature */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto3574+500) ) 
		&&  ( my >= (_Context->y_Auto3574+170) ) 
		&&  ( mx <= (_Context->x_Auto3574+500+98) ) 
		&&  ( my <= (_Context->y_Auto3574+170+16))) {
	...
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto3574+140) ) 
		&&  ( my >= (_Context->y_Auto3574+200) ) 
		&&  ( mx <= (_Context->x_Auto3574+140+472) ) 
		&&  ( my <= (_Context->y_Auto3574+200+16))) {
			return(12); /* MethodName */
			}
		}
	if (_Context->page_number == 1 ) {
		if (( mx >= (_Context->x_Auto3574+140) ) 
		&&  ( my >= (_Context->y_Auto3574+230) ) 
		&&  ( mx <= (_Context->x_Auto3574+140+472) ) 
		&&  ( my <= (_Context->y_Auto3574+230+192))) {
			return(13); /* Signature */
			}
		}
	if (_Context->page_number == 2 ) {
	} else {
		if (( mx >= (_Context->x_Auto3574+20+96) ) 
		&&  ( my >= (_Context->y_Auto3574+30) ) 
		&&  ( mx <= (_Context->x_Auto3574+20+174) ) 
		&&  ( my <= (_Context->y_Auto3574+30+24))) {
			return(14); /* BodyPage */
			}
		}
	if (_Context->page_number == 2 ) {
		if (( mx >= (_Context->x_Auto3574+40) ) 
		&&  ( my >= (_Context->y_Auto3574+70) ) 
		&&  ( mx <= (_Context->x_Auto3574+40+570) ) 
		&&  ( my <= (_Context->y_Auto3574+70+360))) {
			return(15); /* MethodText */
			}
		}
	if (( mx >= (_Context->x_Auto3574+30) ) 
	&&  ( my >= (_Context->y_Auto3574+450) ) 
	&&  ( mx <= (_Context->x_Auto3574+30+56) ) 
	&&  ( my <= (_Context->y_Auto3574+450+48))) {
		return(16); /* Auto3579 */
		}
	if (( mx >= (_Context->x_Auto3574+310) ) 
	&&  ( my >= (_Context->y_Auto3574+450) ) 
	&&  ( mx <= (_Context->x_Auto3574+310+56) ) 
	&&  ( my <= (_Context->y_Auto3574+450+48))) {
		return(17); /* Auto3580 */
		}
	if (( mx >= (_Context->x_Auto3574+560) ) 
	&&  ( my >= (_Context->y_Auto3574+450) ) 
	&&  ( mx <= (_Context->x_Auto3574+560+56) ) 
	&&  ( my <= (_Context->y_Auto3574+450+48))) {
		return(18); /* Auto3581 */
		}
	...
	while(1) {
		switch (_Context->focus_item) {
			...
			case	0x3 :
				/* IsPublic */
				if (_Context->page_number == 1 ) {
				visual_check(_Context->x_Auto3574+40,_Context->y_Auto3574+100,98,16,vfh[2],27,28,_Context->msg_IsPublic[_Context->language],strlen(_Context->msg_IsPublic[_Context->language]),(_Context->value_IsPublic |2));
					_Context->keycode = visual_getch();
					_Context->trigger_IsPublic=visual_trigger_code(_Context->msg_IsPublic[_Context->language],strlen(_Context->msg_IsPublic[_Context->language]));
	visual_check(_Context->x_Auto3574+40,_Context->y_Auto3574+100,98,16,vfh[2],27,28,_Context->msg_IsPublic[_Context->language],strlen(_Context->msg_IsPublic[_Context->language]),_Context->value_IsPublic|0);
				} else {
			...
			case	0x4 :
				/* IsExtern */
				if (_Context->page_number == 1 ) {
				visual_check(_Context->x_Auto3574+40,_Context->y_Auto3574+130,98,16,vfh[2],27,28,_Context->msg_IsExtern[_Context->language],strlen(_Context->msg_IsExtern[_Context->language]),(_Context->value_IsExtern |2));
					_Context->keycode = visual_getch();
					_Context->trigger_IsExtern=visual_trigger_code(_Context->msg_IsExtern[_Context->language],strlen(_Context->msg_IsExtern[_Context->language]));
	visual_check(_Context->x_Auto3574+40,_Context->y_Auto3574+130,98,16,vfh[2],27,28,_Context->msg_IsExtern[_Context->language],strlen(_Context->msg_IsExtern[_Context->language]),_Context->value_IsExtern|0);
				} else {
			...
			case	0x5 :
				/* IsPointer */
				if (_Context->page_number == 1 ) {
				visual_check(_Context->x_Auto3574+300,_Context->y_Auto3574+100,104,16,vfh[2],27,28,_Context->msg_IsPointer[_Context->language],strlen(_Context->msg_IsPointer[_Context->language]),(_Context->value_IsPointer |2));
					_Context->keycode = visual_getch();
					_Context->trigger_IsPointer=visual_trigger_code(_Context->msg_IsPointer[_Context->language],strlen(_Context->msg_IsPointer[_Context->language]));
	visual_check(_Context->x_Auto3574+300,_Context->y_Auto3574+100,104,16,vfh[2],27,28,_Context->msg_IsPointer[_Context->language],strlen(_Context->msg_IsPointer[_Context->language]),_Context->value_IsPointer|0);
				} else {
			...
			case	0x6 :
				/* MethodType */
				if (_Context->page_number == 1 ) {
					_Context->keycode = visual_select(_Context->x_Auto3574+140,_Context->y_Auto3574+100,140,160,vfh[2],27,28,parse_selection(_Context->msg_MethodType[_Context->language],&_Context->value_MethodType),770);
				} else {
				_Context->keycode = 5;
					}
				break;
			case	0x7 :
				/* MethodClass */
				if (_Context->page_number == 1 ) {
					_Context->keycode = visual_edit(_Context->x_Auto3574+140+1,_Context->y_Auto3574+130+1,472,16,vfh[1],_Context->buffer_MethodClass,255);
				} else {
					_Context->keycode = 5;
					}
				break;
			...
			case	0xc :
				/* MethodName */
				if (_Context->page_number == 1 ) {
					_Context->keycode = visual_edit(_Context->x_Auto3574+140+1,_Context->y_Auto3574+200+1,472,16,vfh[1],_Context->buffer_MethodName,255);
				} else {
					_Context->keycode = 5;
					}
				break;
			case	0xd :
				/* Signature */
				if (_Context->page_number == 1 ) {
					_Context->keycode = visual_edit(_Context->x_Auto3574+140+1,_Context->y_Auto3574+230+1,472,192,vfh[1],_Context->buffer_Signature,708);
				} else {
					_Context->keycode = 5;
					}
				break;
			...
			case	0x10 :
				/* Auto3579 */
				_Context->trigger_Auto3579=visual_trigger_code(_Context->msg_Auto3579[_Context->language],strlen(_Context->msg_Auto3579[_Context->language]));
				visual_button(_Context->x_Auto3574+30,_Context->y_Auto3574+450,56,48,vfh[2],34,0,_Context->msg_Auto3579[_Context->language],strlen(_Context->msg_Auto3579[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto3579=visual_trigger_code(_Context->msg_Auto3579[_Context->language],strlen(_Context->msg_Auto3579[_Context->language]));
	visual_button(_Context->x_Auto3574+30,_Context->y_Auto3574+450,56,48,vfh[2],34,0,_Context->msg_Auto3579[_Context->language],strlen(_Context->msg_Auto3579[_Context->language]),1040);
				break;
			case	0x12 :
				/* Auto3581 */
				_Context->trigger_Auto3581=visual_trigger_code(_Context->msg_Auto3581[_Context->language],strlen(_Context->msg_Auto3581[_Context->language]));
				visual_button(_Context->x_Auto3574+560,_Context->y_Auto3574+450,56,48,vfh[2],34,0,_Context->msg_Auto3581[_Context->language],strlen(_Context->msg_Auto3581[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto3581=visual_trigger_code(_Context->msg_Auto3581[_Context->language],strlen(_Context->msg_Auto3581[_Context->language]));
	visual_button(_Context->x_Auto3574+560,_Context->y_Auto3574+450,56,48,vfh[2],34,0,_Context->msg_Auto3581[_Context->language],strlen(_Context->msg_Auto3581[_Context->language]),1040);
				break;
...
retry:
		...
		case	0x100 :
			...
			if (( visual_event(1) == _MIMO_DOWN ) && ( visual_event(2) == _MIMO_RIGHT)) {
				switch ((_Context->focus_item = retcode)) {
					...
					case	0x10 :
						if (Auto3579_help(_Context) != 0) { continue; }
						else { break; }
					case	0x11 :
						if (Auto3580_help(_Context) != 0) { continue; }
						else { break; }
					case	0x12 :
						if (Auto3581_help(_Context) != 0) { continue; }
						else { break; }
					}
				}
			switch ((_Context->focus_item = retcode)) {
	...
	visual_button(_Context->x_Auto3574+30,_Context->y_Auto3574+450,56,48,vfh[2],34,0,_Context->msg_Auto3579[_Context->language],strlen(_Context->msg_Auto3579[_Context->language]),1040);
					...
					if ((_Context->keycode = on_Auto3579_event(_Context)) != -1) break;
				...
				case	0x11 :
					...
					if (visual_event(1) & _MIMO_DOWN) {
						_Context->trigger_Auto3580=visual_trigger_code(_Context->msg_Auto3580[_Context->language],strlen(_Context->msg_Auto3580[_Context->language]));
						visual_button(_Context->x_Auto3574+310,_Context->y_Auto3574+450,56,48,vfh[2],28,28,_Context->msg_Auto3580[_Context->language],strlen(_Context->msg_Auto3580[_Context->language]),1042);
						}
					else if (visual_event(1) & _MIMO_UP) {
						_Context->trigger_Auto3580=visual_trigger_code(_Context->msg_Auto3580[_Context->language],strlen(_Context->msg_Auto3580[_Context->language]));
	visual_button(_Context->x_Auto3574+310,_Context->y_Auto3574+450,56,48,vfh[2],28,28,_Context->msg_Auto3580[_Context->language],strlen(_Context->msg_Auto3580[_Context->language]),1040);
					...
					if ( visual_event(1) &  0x20 ) {
					if ((_Context->keycode = on_Auto3580_event(_Context)) != -1) break;
	...
	visual_button(_Context->x_Auto3574+560,_Context->y_Auto3574+450,56,48,vfh[2],34,0,_Context->msg_Auto3581[_Context->language],strlen(_Context->msg_Auto3581[_Context->language]),1040);
					...
					if ( visual_event(1) &  0x20 ) {
					if ((_Context->keycode = on_Auto3581_event(_Context)) != -1) break;
