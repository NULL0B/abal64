...
#define pt__Auto3552   ""
#define xx__Auto3552   ""
#define en_Auto3557   "WARNING"
#define fr_Auto3557   "ATTENTION"
#define it_Auto3557   "WARNING"
#define es_Auto3557   "WARNING"
#define de_Auto3557   "ACHTUNG"
#define nl_Auto3557   "WARNING"
#define pt_Auto3557   "WARNING"
#define xx_Auto3557   "THOIR AN AIRE"
...
#define en_Auto3558   "Do you want to save these modifications before exiting"
#define fr_Auto3558   "Voulez vous sauver les modifications avant de sortir"
#define it_Auto3558   "Do you want to save these modifications before exiting"
#define es_Auto3558   "Do you want to save these modifications before exiting"
#define de_Auto3558   "Do you want to save these modifications before exiting"
#define nl_Auto3558   "Do you want to save these modifications before exiting"
#define pt_Auto3558   "Do you want to save these modifications before exiting"
#define xx_Auto3558   "A bheil feum air na sgriobhadh"
	...
	char * pAuto3559)
{
	...
	if (_Context->keycode != 27 ) {
		...
		visual_transferin(_Context->buffer_Auto3559, 47, pAuto3559);
		}
	...
	_Context->x_Auto3552=160;
	_Context->y_Auto3552=160;
	_Context->w_Auto3552=480;
	_Context->h_Auto3552=280;
	...
	char * pAuto3559)
{
	...
	if (_Context->keycode != 27 ) {
		strcpy(_Context->signature,"K");
		visual_signature(_Context->signature,_Context->signature);
		visual_transferout(_Context->buffer_Auto3559, 47, pAuto3559);
		}
	if (_Context->pushbuffer != (void *) 0)
...
public	int	accept_exit_show(struct accept_exit_context * _Context)
{
	...
	visual_text(180,200,440,50,vfh[3],28,27,_Context->msg_Auto3557[_Context->language],strlen(_Context->msg_Auto3557[_Context->language]),3);
	...
	visual_text(200,318,400,40,vfh[2],27,28,_Context->msg_Auto3558[_Context->language],strlen(_Context->msg_Auto3558[_Context->language]),259);
	visual_frame(210,300,380+2,20+2,5);
	visual_text(210+1,300+1,380,20,vfh[1],16,15,_Context->buffer_Auto3559,47,3);
