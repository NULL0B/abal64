...
#include <stdio.h>
#include "visual.h"
#define en_Auto3626   "Sing : Palette File Editor"
#define fr_Auto3626   "Sing : Editeur de fichiers palettes"
#define it_Auto3626   "Sing : Palette File Editor"
#define es_Auto3626   "Sing : Palette File Editor"
#define de_Auto3626   "Sing : Palette File Editor"
#define nl_Auto3626   "Sing : Palette File Editor"
#define pt_Auto3626   "Sing : Palette File Editor"
#define xx_Auto3626   "Sing : Palette File Editor"
#define en__Auto3626   ""
#define fr__Auto3626   ""
#define it__Auto3626   ""
#define es__Auto3626   ""
...
#define pt__Drag   ""
#define xx__Drag   ""
#define en_Auto3634   "Palette File"
#define fr_Auto3634   "Fichier Palette"
#define it_Auto3634   "Palette File"
#define es_Auto3634   "Palette File"
#define de_Auto3634   "Datei"
#define nl_Auto3634   "Palette File"
#define pt_Auto3634   "Palette File"
#define xx_Auto3634   "Palette File"
#define en__Auto3634   ""
#define fr__Auto3634   ""
#define it__Auto3634   ""
#define es__Auto3634   ""
...
#define pt__Auto3634   ""
#define xx__Auto3634   ""
#define en_Auto3635   "Blue"
#define fr_Auto3635   "Bleu"
#define it_Auto3635   "Blue"
#define es_Auto3635   "Blue"
#define de_Auto3635   "Blau"
#define nl_Auto3635   "Blue"
#define pt_Auto3635   "Blue"
#define xx_Auto3635   "Gorm"
#define en__Auto3635   ""
#define fr__Auto3635   ""
#define it__Auto3635   ""
#define es__Auto3635   ""
...
#define pt__Auto3635   ""
#define xx__Auto3635   ""
#define en_Auto3636   "Green"
#define fr_Auto3636   "Vert"
#define it_Auto3636   "Green"
#define es_Auto3636   "Green"
#define de_Auto3636   "Grn"
#define nl_Auto3636   "Green"
#define pt_Auto3636   "Green"
#define xx_Auto3636   "Uanne"
#define en__Auto3636   ""
#define fr__Auto3636   ""
#define it__Auto3636   ""
#define es__Auto3636   ""
...
#define pt__Auto3636   ""
#define xx__Auto3636   ""
#define en_Auto3637   "Red"
#define fr_Auto3637   "Rouge"
#define it_Auto3637   "Red"
#define es_Auto3637   "Red"
#define de_Auto3637   "Rot"
#define nl_Auto3637   "Red"
#define pt_Auto3637   "Red"
#define xx_Auto3637   "Dearg"
#define en__Auto3637   ""
#define fr__Auto3637   ""
#define it__Auto3637   ""
#define es__Auto3637   ""
...
#define pt__Auto3637   ""
#define xx__Auto3637   ""
#define en_Auto3638   "Brightness"
#define fr_Auto3638   "Luminosit‚"
#define it_Auto3638   "Brightness"
#define es_Auto3638   "Brightness"
#define de_Auto3638   "Brightness"
#define nl_Auto3638   "Brightness"
#define pt_Auto3638   "Brightness"
#define xx_Auto3638   "Brightness"
#define en__Auto3638   ""
#define fr__Auto3638   ""
#define it__Auto3638   ""
#define es__Auto3638   ""
...
#define en_GreenBar   ""
#define en__GreenBar   ""
#define en_Auto3639   "screen.gif"
#define fr_Auto3639   "screen.gif"
#define it_Auto3639   "screen.gif"
#define es_Auto3639   "screen.gif"
#define de_Auto3639   "screen.gif"
#define nl_Auto3639   "screen.gif"
#define pt_Auto3639   "screen.gif"
#define xx_Auto3639   "screen.gif"
#define en__Auto3639   ""
#define fr__Auto3639   ""
#define it__Auto3639   ""
#define es__Auto3639   ""
...
private int on_Auto3633_event(struct use_palette_editor_context * _Context);
...
private int on_Auto3639_event(struct use_palette_editor_context * _Context);
...
public	int	use_palette_editor_create(struct use_palette_editor_context **cptr)
{
	...
	_Context->x_Auto3626=170;
	_Context->y_Auto3626=15;
	_Context->w_Auto3626=460;
	_Context->h_Auto3626=570;
	...
	_Context->x_Cursor=_Context->x_Auto3626+20;
	_Context->y_Cursor=_Context->y_Auto3626+40;
	...
	_Context->x_Drag=_Context->x_Auto3626+40;
	_Context->y_Drag=_Context->y_Auto3626+40;
	_Context->w_Drag=20;
	_Context->h_Drag=20;
	_Context->fg_Drag=20;
	_Context->bg_Drag=20;
	...
	_Context->pushbuffer=visual_buffer(_Context->x_Auto3626,_Context->y_Auto3626,460+10,570+10);
	return(0);
}
...
public 	int	use_palette_editor_hide(struct use_palette_editor_context * _Context)
{
	...
	&& (_Context->ctrlbuffer != 0)) {
		(void)visual_buffer_put(_Context->pushbuffer,_Context->x_Auto3626,_Context->y_Auto3626);
		_Context->ctrlbuffer=0;
		}
...
private int on_Entry_show(struct use_palette_editor_context * _Context) {
	GetColour(_Context);
	/*visual_frame(_Context->x_Auto3626+415,_Context->y_Auto3626+21,24+2,16+2,5);
visual_text(_Context->x_Auto3626+415+1,_Context->y_Auto3626+21+1,24,16,vfh[1],16,31,_Context->buffer_Entry,3,0);
;*/
	visual_frame(_Context->x_Auto3626+95,_Context->y_Auto3626+440,24+2,16+2,5);
visual_text(_Context->x_Auto3626+95+1,_Context->y_Auto3626+440+1,24,16,vfh[1],16,31,_Context->buffer_RedValue,3,0);
;
	visual_frame(_Context->x_Auto3626+121,_Context->y_Auto3626+440,16+2,16+2,5);
visual_text(_Context->x_Auto3626+121+1,_Context->y_Auto3626+440+1,16,16,vfh[1],16,31,_Context->buffer_RedHex,2,0);
;
		visual_scrollbar(_Context->x_Auto3626+140,_Context->y_Auto3626+440,290,20,vfh[1],27,28,_Context->value_RedBar,_Context->limit_RedBar,_Context->max_RedBar,259);
;
	visual_frame(_Context->x_Auto3626+95,_Context->y_Auto3626+460,24+2,16+2,5);
visual_text(_Context->x_Auto3626+95+1,_Context->y_Auto3626+460+1,24,16,vfh[1],16,31,_Context->buffer_GreenValue,3,0);
;
	visual_frame(_Context->x_Auto3626+121,_Context->y_Auto3626+460,16+2,16+2,5);
visual_text(_Context->x_Auto3626+121+1,_Context->y_Auto3626+460+1,16,16,vfh[1],16,31,_Context->buffer_GreenHex,2,0);
;
		visual_scrollbar(_Context->x_Auto3626+140,_Context->y_Auto3626+460,290,20,vfh[1],27,28,_Context->value_GreenBar,_Context->limit_GreenBar,_Context->max_GreenBar,259);
;
	visual_frame(_Context->x_Auto3626+95,_Context->y_Auto3626+480,24+2,16+2,5);
visual_text(_Context->x_Auto3626+95+1,_Context->y_Auto3626+480+1,24,16,vfh[1],16,31,_Context->buffer_BlueValue,3,0);
;
	visual_frame(_Context->x_Auto3626+121,_Context->y_Auto3626+480,16+2,16+2,5);
visual_text(_Context->x_Auto3626+121+1,_Context->y_Auto3626+480+1,16,16,vfh[1],16,31,_Context->buffer_BlueHex,2,0);
;
		visual_scrollbar(_Context->x_Auto3626+140,_Context->y_Auto3626+480,290,20,vfh[1],27,28,_Context->value_BlueBar,_Context->limit_BlueBar,_Context->max_BlueBar,259);
;
...
private int on_Matrix_show(struct use_palette_editor_context * _Context) {
	...
	sprintf(msg,"%u",n);
	visual_filzone(
	_Context->x_Auto3626+20+((c-1)*w),
	_Context->y_Auto3626+40+((l-1)*h),w,h,n,0);
	if((!(n))||(n==16))
	d=15;
	else d=16;
	visual_text(
	_Context->x_Auto3626+20+((c-1)*w),
	_Context->y_Auto3626+40+((l-1)*h),w,h,vfh[1],d,0,msg,strlen(msg),3);
	if(n==i){
	if(truecolour)
	relieved(_Context->x_Auto3626+20+((c-1)*w),_Context->y_Auto3626+40+((l-1)*h),w,h,0x1613);
	else relief(_Context->x_Auto3626+20+((c-1)*w),_Context->y_Auto3626+40+((l-1)*h),w,h,0x0016,0,0x0013);
	_Context->x_Cursor=_Context->x_Auto3626+20+((c-1)*w);
	_Context->y_Cursor=_Context->y_Auto3626+40+((l-1)*h);
	_Context->w_Cursor=w;
	_Context->h_Cursor=h;
...
;
	...
	relieved(_Context->x_Auto3626+20+((c-1)*w),_Context->y_Auto3626+40+((l-1)*h),w,h,0x1316);
	else relief(_Context->x_Auto3626+20+((c-1)*w),_Context->y_Auto3626+40+((l-1)*h),w,h,0x0013,0,0x0016);
	}
	}
	visual_thaw(_Context->x_Auto3626+20,_Context->y_Auto3626+40,416,352);
		return(-1);
}
private int on_BrightBar_show(struct use_palette_editor_context * _Context) {
	_Context->value_BrightBar=((_Context->value_RedBar+_Context->value_GreenBar+_Context->value_BlueBar)/3);
	sprintf(_Context->buffer_Brightness,"%u",_Context->value_BrightBar);
		visual_scrollbar(_Context->x_Auto3626+140,_Context->y_Auto3626+420,290,20,vfh[1],27,28,_Context->value_BrightBar,_Context->limit_BrightBar,_Context->max_BrightBar,259);

	visual_frame(_Context->x_Auto3626+114,_Context->y_Auto3626+420,24+2,16+2,5);
visual_text(_Context->x_Auto3626+114+1,_Context->y_Auto3626+420+1,24,16,vfh[1],16,31,_Context->buffer_Brightness,3,0);
...
public	int	use_palette_editor_show(struct use_palette_editor_context * _Context)
{
	...
	if ((_Context->pushbuffer != (void *) 0)
	&& (!(_Context->ctrlbuffer))) {
		(void)visual_buffer_get(_Context->pushbuffer,_Context->x_Auto3626,_Context->y_Auto3626);
		_Context->ctrlbuffer=1;
		}
	visual_freeze();
	if (((_Context->status = visual_styled_element(_Context->x_Auto3626,_Context->y_Auto3626,460,570,GetWidgetStyle(0),_Context->msg_Auto3626[_Context->language],strlen(_Context->msg_Auto3626[_Context->language]))) != 0)
) {
		visual_window(_Context->x_Auto3626,_Context->y_Auto3626,460,570,vfh[2],_Context->msg_Auto3626[_Context->language],strlen(_Context->msg_Auto3626[_Context->language]),0x407);
		}
	visual_frame(_Context->x_Auto3626+18,_Context->y_Auto3626+38,421,357,2);
	visual_frame(_Context->x_Auto3626+18,_Context->y_Auto3626+411,421,100,4);
	visual_frame(_Context->x_Auto3626+18,_Context->y_Auto3626+512,421,50,4);
	visual_frame(_Context->x_Auto3626+30,_Context->y_Auto3626+440,110,20,2);
	visual_frame(_Context->x_Auto3626+30,_Context->y_Auto3626+480,110,20,2);
	visual_frame(_Context->x_Auto3626+30,_Context->y_Auto3626+460,110,20,2);
	visual_frame(_Context->x_Auto3626+30,_Context->y_Auto3626+540,256+2,16+2,5);
	visual_text(_Context->x_Auto3626+30+1,_Context->y_Auto3626+540+1,256,16,vfh[1],16,31,_Context->buffer_PaletteName,255,0);
	_Context->trigger_Auto3633=visual_trigger_code(_Context->msg_Auto3633[_Context->language],strlen(_Context->msg_Auto3633[_Context->language]));
	visual_button(_Context->x_Auto3626+287,_Context->y_Auto3626+540,20,16,vfh[8],27,28,_Context->msg_Auto3633[_Context->language],strlen(_Context->msg_Auto3633[_Context->language]),0);
	_Context->trigger_Load=visual_trigger_code(_Context->msg_Load[_Context->language],strlen(_Context->msg_Load[_Context->language]));
	visual_button(_Context->x_Auto3626+350,_Context->y_Auto3626+517,40,40,vfh[8],27,28,_Context->msg_Load[_Context->language],strlen(_Context->msg_Load[_Context->language]),1296);
	_Context->trigger_Save=visual_trigger_code(_Context->msg_Save[_Context->language],strlen(_Context->msg_Save[_Context->language]));
	visual_button(_Context->x_Auto3626+309,_Context->y_Auto3626+517,40,40,vfh[8],27,28,_Context->msg_Save[_Context->language],strlen(_Context->msg_Save[_Context->language]),1296);
	(void) on_Entry_show(_Context);
	(void) on_Matrix_show(_Context);
	visual_text(_Context->x_Auto3626+30,_Context->y_Auto3626+525,256,16,vfh[2],16,0,_Context->msg_Auto3634[_Context->language],strlen(_Context->msg_Auto3634[_Context->language]),1282);
	visual_text(_Context->x_Auto3626+33,_Context->y_Auto3626+483,56,16,vfh[2],9,0,_Context->msg_Auto3635[_Context->language],strlen(_Context->msg_Auto3635[_Context->language]),1281);
	visual_text(_Context->x_Auto3626+33,_Context->y_Auto3626+463,56,16,vfh[2],10,0,_Context->msg_Auto3636[_Context->language],strlen(_Context->msg_Auto3636[_Context->language]),1281);
	visual_text(_Context->x_Auto3626+33,_Context->y_Auto3626+442,56,16,vfh[2],12,0,_Context->msg_Auto3637[_Context->language],strlen(_Context->msg_Auto3637[_Context->language]),1281);
	visual_text(_Context->x_Auto3626+33,_Context->y_Auto3626+421,70,16,vfh[2],31,0,_Context->msg_Auto3638[_Context->language],strlen(_Context->msg_Auto3638[_Context->language]),1281);
	visual_frame(_Context->x_Auto3626+114,_Context->y_Auto3626+420,24+2,16+2,5);
	visual_text(_Context->x_Auto3626+114+1,_Context->y_Auto3626+420+1,24,16,vfh[1],16,31,_Context->buffer_Brightness,3,0);
	...
	visual_scrollbar(_Context->x_Auto3626+140,_Context->y_Auto3626+480,290,20,vfh[1],27,28,_Context->value_BlueBar,_Context->limit_BlueBar,_Context->max_BlueBar,259);
	visual_scrollbar(_Context->x_Auto3626+140,_Context->y_Auto3626+460,290,20,vfh[1],27,28,_Context->value_GreenBar,_Context->limit_GreenBar,_Context->max_GreenBar,259);
	_Context->trigger_Auto3639=visual_trigger_code(_Context->msg_Auto3639[_Context->language],strlen(_Context->msg_Auto3639[_Context->language]));
	visual_button(_Context->x_Auto3626+391,_Context->y_Auto3626+517,40,40,vfh[8],27,28,_Context->msg_Auto3639[_Context->language],strlen(_Context->msg_Auto3639[_Context->language]),1296);
	visual_thaw(_Context->x_Auto3626,_Context->y_Auto3626,460,570);
...
private int Matrix_help()
{
	switch (visual_national_language(-1)) {
		case 0 : 
			...
			mptr[6]="to another location by a simple drag and drop operation using the ";
			mptr[7]="mouse.  ";
			mptr[8]="    ";
			return(visual_online_help(mptr,9));
			}
...
private int Auto3626action(struct use_palette_editor_context * _Context) {
	...
	do {
		...
		_Context->x_Auto3626 += (visual_event(7)-x);
		x=visual_event(7);
		if (_Context->x_Auto3626 < 0) { _Context->x_Auto3626=0; }
		_Context->y_Auto3626 += (visual_event(6)-y);
		y=visual_event(6);
		if (_Context->y_Auto3626 < 0) { _Context->y_Auto3626=0; }
...
private int on_Matrix_event(struct use_palette_editor_context * _Context) {
	...
	int x=visual_event(7);
	int y=visual_event(6);
	x-=_Context->x_Auto3626+20;
	y-=_Context->y_Auto3626+40;
	w=416/16;
	h=352/16;
	x/=w;
	y/=h;
...
;
	...
	x=visual_event(7);
	y=visual_event(6);
	if((x>_Context->x_Auto3626+20)
	&&(y>_Context->y_Auto3626+40)
	&&(x<(_Context->x_Auto3626+20+416))
	&&(y<(_Context->y_Auto3626+40+352))){
	x-=_Context->x_Auto3626+20;
	y-=_Context->y_Auto3626+40;
	w=(416/16);
	h=(352/16);
...
private int on_BrightBar_action(struct use_palette_editor_context * _Context) {
	...
	if ( visual_event(7) < (_Context->x_Auto3626+140+20) ) {
	...
	if ( visual_event(7) > (_Context->x_Auto3626+140+290-20) ) {
		do { while( visual_getch() != 256); } while ( visual_event(1)  != _MIMO_UP );
		_Context->value_BrightBar += 1;
	...
	do {
		...
		_Context->value_BrightBar = (((visual_event(7) - (_Context->x_Auto3626+140+20)) * _Context->max_BrightBar) / (290 - (2 * 20)));
		if (_Context->value_BrightBar < 0) 
			_Context->value_BrightBar = 0;
		else if (_Context->value_BrightBar > (_Context->max_BrightBar-_Context->limit_BrightBar)) 
			_Context->value_BrightBar = (_Context->max_BrightBar-_Context->limit_BrightBar);
...
private int on_RedBar_action(struct use_palette_editor_context * _Context) {
	...
	do {
		...
		_Context->value_RedBar = (((visual_event(7) - (_Context->x_Auto3626+140+20)) * _Context->max_RedBar) / (290 - (2 * 20)));
		if (_Context->value_RedBar < 0) 
			_Context->value_RedBar = 0;
		else if (_Context->value_RedBar > (_Context->max_RedBar-_Context->limit_RedBar)) 
			_Context->value_RedBar = (_Context->max_RedBar-_Context->limit_RedBar);
...
private int on_BlueBar_action(struct use_palette_editor_context * _Context) {
	...
	do {
		...
		_Context->value_BlueBar = (((visual_event(7) - (_Context->x_Auto3626+140+20)) * _Context->max_BlueBar) / (290 - (2 * 20)));
		if (_Context->value_BlueBar < 0) 
			_Context->value_BlueBar = 0;
		else if (_Context->value_BlueBar > (_Context->max_BlueBar-_Context->limit_BlueBar)) 
			_Context->value_BlueBar = (_Context->max_BlueBar-_Context->limit_BlueBar);
...
private int on_GreenBar_action(struct use_palette_editor_context * _Context) {
	...
	do {
		...
		_Context->value_GreenBar = (((visual_event(7) - (_Context->x_Auto3626+140+20)) * _Context->max_GreenBar) / (290 - (2 * 20)));
		if (_Context->value_GreenBar < 0) 
			_Context->value_GreenBar = 0;
		else if (_Context->value_GreenBar > (_Context->max_GreenBar-_Context->limit_GreenBar)) 
			_Context->value_GreenBar = (_Context->max_GreenBar-_Context->limit_GreenBar);
...
struct use_palette_editor_context * _Context){
	...
	if (visual_event(1) & _MIMO_ALT) {
		...
		if (_Context->trigger_Auto3633 == mb ) return(3);
		if (_Context->trigger_Load == mb ) return(4);
		if (_Context->trigger_Save == mb ) return(5);
		if (_Context->trigger_Auto3639 == mb ) return(19);
		return(-1);
		}
	...
	switch (mt) {
	case _MIMO_UP :
	if ((mx >= (_Context->x_Auto3626+439) )  
	&&  (my >= (_Context->y_Auto3626+4) )  
	&&  (mx <= (_Context->x_Auto3626+456) )  
	&&  (my <= (_Context->y_Auto3626+20) )) {
		return(1);	/* Auto3626 */

		}
	if ((mx >= (_Context->x_Auto3626+423) )  
	&&  (my >= (_Context->y_Auto3626+4) )  
	&&  (mx <= (_Context->x_Auto3626+440) )  
	&&  (my <= (_Context->y_Auto3626+20) )) {
	...
	if ((mx >= (_Context->x_Auto3626+407) )  
	&&  (my >= (_Context->y_Auto3626+4) )  
	&&  (mx <= (_Context->x_Auto3626+424) )  
	&&  (my <= (_Context->y_Auto3626+20) )) {
	...
	case _MIMO_DOWN :
		if ((mx >= (_Context->x_Auto3626+4) )  
		&&  (my >= (_Context->y_Auto3626+4) )  
		&&  (mx <= (_Context->x_Auto3626+392) )  
		&&  (my <= (_Context->y_Auto3626+20) )) {
			return( Auto3626action(_Context) );
			}
		}
	if (( mx >= (_Context->x_Auto3626+30) ) 
	&&  ( my >= (_Context->y_Auto3626+540) ) 
	&&  ( mx <= (_Context->x_Auto3626+30+256) ) 
	&&  ( my <= (_Context->y_Auto3626+540+16))) {
		return(2); /* PaletteName */
		}
	if (( mx >= (_Context->x_Auto3626+287) ) 
	&&  ( my >= (_Context->y_Auto3626+540) ) 
	&&  ( mx <= (_Context->x_Auto3626+287+20) ) 
	&&  ( my <= (_Context->y_Auto3626+540+16))) {
		return(3); /* Auto3633 */
		}
	if (( mx >= (_Context->x_Auto3626+350) ) 
	&&  ( my >= (_Context->y_Auto3626+517) ) 
	&&  ( mx <= (_Context->x_Auto3626+350+40) ) 
	&&  ( my <= (_Context->y_Auto3626+517+40))) {
		return(4); /* Load */
		}
	if (( mx >= (_Context->x_Auto3626+309) ) 
	&&  ( my >= (_Context->y_Auto3626+517) ) 
	&&  ( mx <= (_Context->x_Auto3626+309+40) ) 
	&&  ( my <= (_Context->y_Auto3626+517+40))) {
		return(5); /* Save */
		}
	if (( mx >= (_Context->x_Auto3626+415) ) 
	&&  ( my >= (_Context->y_Auto3626+21) ) 
	&&  ( mx <= (_Context->x_Auto3626+415+24) ) 
	&&  ( my <= (_Context->y_Auto3626+21+16))) {
		return(6); /* Entry */
		}
	if (( mx >= (_Context->x_Auto3626+20) ) 
	&&  ( my >= (_Context->y_Auto3626+40) ) 
	&&  ( mx <= (_Context->x_Auto3626+20+416) ) 
	&&  ( my <= (_Context->y_Auto3626+40+352))) {
		return(7); /* Matrix */
		}
	if (( mx >= (_Context->x_Auto3626+114) ) 
	&&  ( my >= (_Context->y_Auto3626+420) ) 
	&&  ( mx <= (_Context->x_Auto3626+114+24) ) 
	&&  ( my <= (_Context->y_Auto3626+420+16))) {
		return(8); /* Brightness */
		}
	if (( mx >= (_Context->x_Auto3626+95) ) 
	&&  ( my >= (_Context->y_Auto3626+440) ) 
	&&  ( mx <= (_Context->x_Auto3626+95+24) ) 
	&&  ( my <= (_Context->y_Auto3626+440+16))) {
		return(9); /* RedValue */
		}
	if (( mx >= (_Context->x_Auto3626+95) ) 
	&&  ( my >= (_Context->y_Auto3626+480) ) 
	&&  ( mx <= (_Context->x_Auto3626+95+24) ) 
	&&  ( my <= (_Context->y_Auto3626+480+16))) {
		return(10); /* BlueValue */
		}
	if (( mx >= (_Context->x_Auto3626+95) ) 
	&&  ( my >= (_Context->y_Auto3626+460) ) 
	&&  ( mx <= (_Context->x_Auto3626+95+24) ) 
	&&  ( my <= (_Context->y_Auto3626+460+16))) {
		return(11); /* GreenValue */
		}
	if (( mx >= (_Context->x_Auto3626+121) ) 
	&&  ( my >= (_Context->y_Auto3626+440) ) 
	&&  ( mx <= (_Context->x_Auto3626+121+16) ) 
	&&  ( my <= (_Context->y_Auto3626+440+16))) {
		return(12); /* RedHex */
		}
	if (( mx >= (_Context->x_Auto3626+121) ) 
	...
	if (( mx >= (_Context->x_Auto3626+140) ) 
	&&  ( my >= (_Context->y_Auto3626+420) ) 
	&&  ( mx <= (_Context->x_Auto3626+140+290) ) 
	&&  ( my <= (_Context->y_Auto3626+420+20))) {
		return(15); /* BrightBar */
		}
	if (( mx >= (_Context->x_Auto3626+140) ) 
	&&  ( my >= (_Context->y_Auto3626+440) ) 
	&&  ( mx <= (_Context->x_Auto3626+140+290) ) 
	&&  ( my <= (_Context->y_Auto3626+440+20))) {
		return(16); /* RedBar */
		}
	if (( mx >= (_Context->x_Auto3626+140) ) 
	&&  ( my >= (_Context->y_Auto3626+480) ) 
	&&  ( mx <= (_Context->x_Auto3626+140+290) ) 
	&&  ( my <= (_Context->y_Auto3626+480+20))) {
		return(17); /* BlueBar */
		}
	if (( mx >= (_Context->x_Auto3626+140) ) 
	&&  ( my >= (_Context->y_Auto3626+460) ) 
	&&  ( mx <= (_Context->x_Auto3626+140+290) ) 
	&&  ( my <= (_Context->y_Auto3626+460+20))) {
		return(18); /* GreenBar */
		}
	if (( mx >= (_Context->x_Auto3626+391) ) 
	&&  ( my >= (_Context->y_Auto3626+517) ) 
	&&  ( mx <= (_Context->x_Auto3626+391+40) ) 
	&&  ( my <= (_Context->y_Auto3626+517+40))) {
		return(19); /* Auto3639 */
		}
...
public	int	use_palette_editor_focus(struct use_palette_editor_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			case	0x2 :
				/* PaletteName */
				_Context->keycode = visual_edit(_Context->x_Auto3626+30+1,_Context->y_Auto3626+540+1,256,16,vfh[1],_Context->buffer_PaletteName,255);
			break;
			case	0x3 :
				/* Auto3633 */
				_Context->trigger_Auto3633=visual_trigger_code(_Context->msg_Auto3633[_Context->language],strlen(_Context->msg_Auto3633[_Context->language]));
				visual_button(_Context->x_Auto3626+287,_Context->y_Auto3626+540,20,16,vfh[8],27,28,_Context->msg_Auto3633[_Context->language],strlen(_Context->msg_Auto3633[_Context->language]),2);
	...
	visual_button(_Context->x_Auto3626+287,_Context->y_Auto3626+540,20,16,vfh[8],27,28,_Context->msg_Auto3633[_Context->language],strlen(_Context->msg_Auto3633[_Context->language]),0);
			...
			case	0x4 :
				/* Load */
				_Context->trigger_Load=visual_trigger_code(_Context->msg_Load[_Context->language],strlen(_Context->msg_Load[_Context->language]));
				visual_button(_Context->x_Auto3626+350,_Context->y_Auto3626+517,40,40,vfh[8],27,28,_Context->msg_Load[_Context->language],strlen(_Context->msg_Load[_Context->language]),1298);
				_Context->keycode = visual_getch();
				_Context->trigger_Load=visual_trigger_code(_Context->msg_Load[_Context->language],strlen(_Context->msg_Load[_Context->language]));
	visual_button(_Context->x_Auto3626+350,_Context->y_Auto3626+517,40,40,vfh[8],27,28,_Context->msg_Load[_Context->language],strlen(_Context->msg_Load[_Context->language]),1296);
				break;
			case	0x5 :
				/* Save */
				_Context->trigger_Save=visual_trigger_code(_Context->msg_Save[_Context->language],strlen(_Context->msg_Save[_Context->language]));
				visual_button(_Context->x_Auto3626+309,_Context->y_Auto3626+517,40,40,vfh[8],27,28,_Context->msg_Save[_Context->language],strlen(_Context->msg_Save[_Context->language]),1298);
				_Context->keycode = visual_getch();
				_Context->trigger_Save=visual_trigger_code(_Context->msg_Save[_Context->language],strlen(_Context->msg_Save[_Context->language]));
	visual_button(_Context->x_Auto3626+309,_Context->y_Auto3626+517,40,40,vfh[8],27,28,_Context->msg_Save[_Context->language],strlen(_Context->msg_Save[_Context->language]),1296);
				break;
			case	0x6 :
				/* Entry */
				_Context->keycode = visual_edit(_Context->x_Auto3626+415+1,_Context->y_Auto3626+21+1,24,16,vfh[1],_Context->buffer_Entry,3);
				on_Entry_show(_Context);
			break;
			case	0x7 :
				/* Matrix */
			...
			case	0x8 :
				/* Brightness */
				_Context->keycode = visual_edit(_Context->x_Auto3626+114+1,_Context->y_Auto3626+420+1,24,16,vfh[1],_Context->buffer_Brightness,3);
			break;
			case	0x9 :
				/* RedValue */
				_Context->keycode = visual_edit(_Context->x_Auto3626+95+1,_Context->y_Auto3626+440+1,24,16,vfh[1],_Context->buffer_RedValue,3);
				PutColour(_Context);
					use_palette_editor_show(_Context);
;
				;
			...
			case	0xa :
				/* BlueValue */
				_Context->keycode = visual_edit(_Context->x_Auto3626+95+1,_Context->y_Auto3626+480+1,24,16,vfh[1],_Context->buffer_BlueValue,3);
				PutColour(_Context);
					use_palette_editor_show(_Context);
;
			break;
			case	0xb :
				/* GreenValue */
				_Context->keycode = visual_edit(_Context->x_Auto3626+95+1,_Context->y_Auto3626+460+1,24,16,vfh[1],_Context->buffer_GreenValue,3);
				PutColour(_Context);
					use_palette_editor_show(_Context);
;
			break;
			...
			case	0x13 :
				/* Auto3639 */
				_Context->trigger_Auto3639=visual_trigger_code(_Context->msg_Auto3639[_Context->language],strlen(_Context->msg_Auto3639[_Context->language]));
				visual_button(_Context->x_Auto3626+391,_Context->y_Auto3626+517,40,40,vfh[8],27,28,_Context->msg_Auto3639[_Context->language],strlen(_Context->msg_Auto3639[_Context->language]),1298);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto3639=visual_trigger_code(_Context->msg_Auto3639[_Context->language],strlen(_Context->msg_Auto3639[_Context->language]));
	visual_button(_Context->x_Auto3626+391,_Context->y_Auto3626+517,40,40,vfh[8],27,28,_Context->msg_Auto3639[_Context->language],strlen(_Context->msg_Auto3639[_Context->language]),1296);
				break;
...
retry:
		...
		case	0x100 :
			...
			if (( visual_event(1) == _MIMO_DOWN ) && ( visual_event(2) == _MIMO_RIGHT)) {
				switch ((_Context->focus_item = retcode)) {
					...
					case	0x13 :
						if (Auto3639_help(_Context) != 0) { continue; }
						else { break; }
					}
				}
			switch ((_Context->focus_item = retcode)) {
	...
	visual_button(_Context->x_Auto3626+287,_Context->y_Auto3626+540,20,16,vfh[8],27,28,_Context->msg_Auto3633[_Context->language],strlen(_Context->msg_Auto3633[_Context->language]),0);
					...
					if ((_Context->keycode = on_Auto3633_event(_Context)) != -1) break;
	...
	visual_button(_Context->x_Auto3626+391,_Context->y_Auto3626+517,40,40,vfh[8],27,28,_Context->msg_Auto3639[_Context->language],strlen(_Context->msg_Auto3639[_Context->language]),1296);
					...
					if ( visual_event(1) &  0x20 ) {
					if ((_Context->keycode = on_Auto3639_event(_Context)) != -1) break;
