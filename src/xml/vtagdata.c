...
#include <stdio.h>
#include "visual.h"
#define en_Auto3629   "Sing : Version 1.0a"
#define en__Auto3629   ""
#define en_Auto3630   "Html Document : Hyperlink Selection"
#define en__Auto3630   ""
#define en_hList   "Href|Text"
#define en__hList   ""
#define en__hBar   ""
#define en_Auto3631   "Resulting Anchor Expression"
#define en__Auto3631   ""
#define en_Result   ""
#define en__Result   ""
...
_Context->indsort_hList=NULL;	/* pas de pointeur de table intermédiaire */		_Context->max_hBar=0;
	...
	_Context->x_Auto3629=0;
	_Context->y_Auto3629=85;
	_Context->w_Auto3629=800;
	_Context->h_Auto3629=430;
	...
	_Context->pushbuffer=visual_buffer(_Context->x_Auto3629,_Context->y_Auto3629,800+10,430+10);
	return(0);
}
...
public 	int	choose_html_tag_data_hide(struct choose_html_tag_data_context * _Context)
{
	...
	&& (_Context->ctrlbuffer != 0)) {
		(void)visual_buffer_put(_Context->pushbuffer,_Context->x_Auto3629,_Context->y_Auto3629);
		_Context->ctrlbuffer=0;
		}
...
public	int	choose_html_tag_data_show(struct choose_html_tag_data_context * _Context)
{
	...
	if ((_Context->pushbuffer != (void *) 0)
	&& (!(_Context->ctrlbuffer))) {
		(void)visual_buffer_get(_Context->pushbuffer,_Context->x_Auto3629,_Context->y_Auto3629);
		_Context->ctrlbuffer=1;
		}
	visual_freeze();
	visual_window(_Context->x_Auto3629,_Context->y_Auto3629,800,430,vfh[2],_Context->msg_Auto3629[_Context->language],strlen(_Context->msg_Auto3629[_Context->language]),0x407);
	visual_text(_Context->x_Auto3629+10,_Context->y_Auto3629+30,759,20,vfh[3],16,0,_Context->msg_Auto3630[_Context->language],strlen(_Context->msg_Auto3630[_Context->language]),1283);
	visual_table(_Context->x_Auto3629+10,_Context->y_Auto3629+60,756,292,vfh[1],0,0,_Context->msg_hList[_Context->language],_Context->buffer_hList,0x4401,"(W32,$)");
	visual_scrollbar(_Context->x_Auto3629+770,_Context->y_Auto3629+60,20,290,vfh[1],0,0,_Context->value_hBar,_Context->limit_hBar,_Context->max_hBar,3);
	visual_text(_Context->x_Auto3629+80,_Context->y_Auto3629+370,616,16,vfh[2],16,0,_Context->msg_Auto3631[_Context->language],strlen(_Context->msg_Auto3631[_Context->language]),259);
	visual_frame(_Context->x_Auto3629+80,_Context->y_Auto3629+390,616+2,16+2,5);
	visual_text(_Context->x_Auto3629+80+1,_Context->y_Auto3629+390+1,616,16,vfh[1],27,28,_Context->buffer_Result,255,0);
	_Context->trigger_Accept=visual_trigger_code(_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]));
	visual_button(_Context->x_Auto3629+10,_Context->y_Auto3629+370,56,48,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),1040);
	_Context->trigger_Cancel=visual_trigger_code(_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]));
	visual_button(_Context->x_Auto3629+710,_Context->y_Auto3629+370,56,48,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),1040);
	visual_thaw(_Context->x_Auto3629,_Context->y_Auto3629,800,430);
...
private int Auto3629action(struct choose_html_tag_data_context * _Context) {
	...
	do {
		...
		_Context->x_Auto3629 += (visual_event(7)-x);
		x=visual_event(7);
		if (_Context->x_Auto3629 < 0) { _Context->x_Auto3629=0; }
		_Context->y_Auto3629 += (visual_event(6)-y);
		y=visual_event(6);
		if (_Context->y_Auto3629 < 0) { _Context->y_Auto3629=0; }
...
private int on_hBar_action(struct choose_html_tag_data_context * _Context) {
	...
	if ( visual_event(6) < (_Context->y_Auto3629+60+20) ) {
		do { while( visual_getch() != 256); } while ( visual_event(1)  != _MIMO_UP );
		_Context->value_hBar -= 1;
		if (_Context->value_hBar < 0) 
			_Context->value_hBar = 0;
	status = choose_html_tag_data_show(_Context);
	visual_scrollbar(_Context->x_Auto3629+770,_Context->y_Auto3629+60,20,290,vfh[1],0,0,_Context->value_hBar,_Context->limit_hBar,_Context->max_hBar,259);
		return(-1);
		}
	if ( visual_event(6) > (_Context->y_Auto3629+60+290-20) ) {
		do { while( visual_getch() != 256); } while ( visual_event(1)  != _MIMO_UP );
		_Context->value_hBar += 1;
	...
	do {
		...
		_Context->value_hBar = (((visual_event(6) - (_Context->y_Auto3629+60+20)) * _Context->max_hBar) / (290 - (2 * 20)));
		if (_Context->value_hBar < 0) 
			_Context->value_hBar = 0;
		else if (_Context->value_hBar > (_Context->max_hBar-_Context->limit_hBar)) 
			_Context->value_hBar = (_Context->max_hBar-_Context->limit_hBar);
...
struct choose_html_tag_data_context * _Context){
	...
	switch (mt) {
	case _MIMO_UP :
	if ((mx >= (_Context->x_Auto3629+779) )  
	&&  (my >= (_Context->y_Auto3629+4) )  
	&&  (mx <= (_Context->x_Auto3629+796) )  
	&&  (my <= (_Context->y_Auto3629+20) )) {
		return(1);	/* Auto3629 */

		}
	if ((mx >= (_Context->x_Auto3629+763) )  
	&&  (my >= (_Context->y_Auto3629+4) )  
	&&  (mx <= (_Context->x_Auto3629+780) )  
	&&  (my <= (_Context->y_Auto3629+20) )) {
	...
	if ((mx >= (_Context->x_Auto3629+747) )  
	&&  (my >= (_Context->y_Auto3629+4) )  
	&&  (mx <= (_Context->x_Auto3629+764) )  
	&&  (my <= (_Context->y_Auto3629+20) )) {
	...
	case _MIMO_DOWN :
		if ((mx >= (_Context->x_Auto3629+4) )  
		&&  (my >= (_Context->y_Auto3629+4) )  
		&&  (mx <= (_Context->x_Auto3629+732) )  
		&&  (my <= (_Context->y_Auto3629+20) )) {
			return( Auto3629action(_Context) );
			}
		}
	if (( mx >= (_Context->x_Auto3629+10) ) 
	&&  ( my >= (_Context->y_Auto3629+60) ) 
	&&  ( mx <= (_Context->x_Auto3629+10+756) ) 
	&&  ( my <= (_Context->y_Auto3629+60+292))) {
		if ((_Context->value_hList = ((visual_event(6) - (_Context->y_Auto3629+60)) / 16)) < 1)
		...
		_Context->column_hList = (visual_event(7) - (_Context->x_Auto3629+10));
	...
	if (( mx >= (_Context->x_Auto3629+770) ) 
	&&  ( my >= (_Context->y_Auto3629+60) ) 
	&&  ( mx <= (_Context->x_Auto3629+770+20) ) 
	&&  ( my <= (_Context->y_Auto3629+60+290))) {
		return(3); /* hBar */
		}
	if (( mx >= (_Context->x_Auto3629+80) ) 
	&&  ( my >= (_Context->y_Auto3629+390) ) 
	&&  ( mx <= (_Context->x_Auto3629+80+616) ) 
	&&  ( my <= (_Context->y_Auto3629+390+16))) {
		return(4); /* Result */
		}
	if (( mx >= (_Context->x_Auto3629+10) ) 
	&&  ( my >= (_Context->y_Auto3629+370) ) 
	&&  ( mx <= (_Context->x_Auto3629+10+56) ) 
	&&  ( my <= (_Context->y_Auto3629+370+48))) {
		return(5); /* Accept */
		}
	if (( mx >= (_Context->x_Auto3629+710) ) 
	&&  ( my >= (_Context->y_Auto3629+370) ) 
	&&  ( mx <= (_Context->x_Auto3629+710+56) ) 
	&&  ( my <= (_Context->y_Auto3629+370+48))) {
		return(6); /* Cancel */
		}
	...
	while(1) {
		switch (_Context->focus_item) {
			case	0x2 :
				...
				case	0x1 :
					_Context->keycode=visual_edit((_Context->x_Auto3629+10+2),(_Context->y_Auto3629+60+(_Context->value_hList*16)+2),256,16,vfh[1],&_Context->buffer_hList[(_Context->value_hList-1)][0],32);
				visual_text((_Context->x_Auto3629+10+2),(_Context->y_Auto3629+60+(_Context->value_hList*16)+2),256,16,vfh[1],0,(24-((_Context->value_hList-1)&1)),&_Context->buffer_hList[(_Context->value_hList-1)][0],32,0);
					break;
				case	0x2 :
					_Context->keycode=visual_edit((_Context->x_Auto3629+10+266),(_Context->y_Auto3629+60+(_Context->value_hList*16)+2),480,16,vfh[1],&_Context->buffer_hList[(_Context->value_hList-1)][33],60);
				visual_text((_Context->x_Auto3629+10+266),(_Context->y_Auto3629+60+(_Context->value_hList*16)+2),480,16,vfh[1],0,(24-((_Context->value_hList-1)&1)),&_Context->buffer_hList[(_Context->value_hList-1)][33],60,0);
					break;
					}
...
retry:
			...
			switch ((_Context->focus_item = retcode)) {
				...
				case	0x5 :
					...
					if (visual_event(1) & _MIMO_DOWN) {
						_Context->trigger_Accept=visual_trigger_code(_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]));
						visual_button(_Context->x_Auto3629+10,_Context->y_Auto3629+370,56,48,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),1042);
						}
	...
	visual_button(_Context->x_Auto3629+10,_Context->y_Auto3629+370,56,48,vfh[2],34,0,_Context->msg_Accept[_Context->language],strlen(_Context->msg_Accept[_Context->language]),1040);
				...
				case	0x6 :
					...
					if (visual_event(1) & _MIMO_DOWN) {
						_Context->trigger_Cancel=visual_trigger_code(_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]));
						visual_button(_Context->x_Auto3629+710,_Context->y_Auto3629+370,56,48,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),1042);
						}
					else if (visual_event(1) & _MIMO_UP) {
						_Context->trigger_Cancel=visual_trigger_code(_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]));
	visual_button(_Context->x_Auto3629+710,_Context->y_Auto3629+370,56,48,vfh[2],34,0,_Context->msg_Cancel[_Context->language],strlen(_Context->msg_Cancel[_Context->language]),1040);
