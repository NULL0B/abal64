...
#define pt__Auto3585   ""
#define xx__Auto3585   ""
#define en_Auto3586   "Locate Text"
#define fr_Auto3586   "Rechercher"
#define it_Auto3586   "Locate Text"
#define es_Auto3586   "Locate Text"
#define de_Auto3586   "Sucher Text"
#define nl_Auto3586   "Locate Text"
#define pt_Auto3586   "Locate Text"
#define xx_Auto3586   "Locate Text"
#define en_Auto3587   "Replace With"
#define fr_Auto3587   "Remplacer"
#define it_Auto3587   "Replace With"
#define es_Auto3587   "Replace With"
#define de_Auto3587   "Replace With"
#define nl_Auto3587   "Replace With"
#define pt_Auto3587   "Replace With"
#define xx_Auto3587   "Replace With"
#define en_Criteria   ""
#define en_Replace   ""
	...
	char * pReplaceAll)
{
	...
	_Context->x_Auto3585=95;
	_Context->y_Auto3585=250;
	_Context->w_Auto3585=610;
	_Context->h_Auto3585=100;
	...
	_Context->pushbuffer=visual_buffer(_Context->x_Auto3585,_Context->y_Auto3585,610+10,100+10);
	return(0);
}
...
public 	int	accept_replace_hide(struct accept_replace_context * _Context)
{
	...
	&& (_Context->ctrlbuffer != 0)) {
		(void)visual_buffer_put(_Context->pushbuffer,_Context->x_Auto3585,_Context->y_Auto3585);
		_Context->ctrlbuffer=0;
		}
...
public	int	accept_replace_show(struct accept_replace_context * _Context)
{
	...
	if ((_Context->pushbuffer != (void *) 0)
	&& (!(_Context->ctrlbuffer))) {
		(void)visual_buffer_get(_Context->pushbuffer,_Context->x_Auto3585,_Context->y_Auto3585);
		_Context->ctrlbuffer=1;
		}
	visual_freeze();
	if (((_Context->status = visual_styled_element(_Context->x_Auto3585,_Context->y_Auto3585,610,100,GetWidgetStyle(0),GetWindowVersion(),strlen(GetWindowVersion()))) != 0)
) {
		visual_window(_Context->x_Auto3585,_Context->y_Auto3585,610,100,vfh[2],GetWindowVersion(),strlen(GetWindowVersion()),0x407);
		}
	visual_text(_Context->x_Auto3585+10,_Context->y_Auto3585+30,84,16,vfh[2],27,0,_Context->msg_Auto3586[_Context->language],strlen(_Context->msg_Auto3586[_Context->language]),771);
	visual_text(_Context->x_Auto3585+10,_Context->y_Auto3585+50,84,16,vfh[2],27,0,_Context->msg_Auto3587[_Context->language],strlen(_Context->msg_Auto3587[_Context->language]),771);
	visual_frame(_Context->x_Auto3585+100,_Context->y_Auto3585+30,424+2,16+2,5);
	visual_text(_Context->x_Auto3585+100+1,_Context->y_Auto3585+30+1,424,16,vfh[1],16,22,_Context->buffer_Criteria,255,0);
	visual_frame(_Context->x_Auto3585+100,_Context->y_Auto3585+50,424+2,16+2,5);
	visual_text(_Context->x_Auto3585+100+1,_Context->y_Auto3585+50+1,424,16,vfh[1],27,0,_Context->buffer_Replace,255,0);
	...
	visual_check(_Context->x_Auto3585+100,_Context->y_Auto3585+70,140,16,vfh[2],16,22,_Context->msg_IgnoreCase[_Context->language],strlen(_Context->msg_IgnoreCase[_Context->language]),_Context->value_IgnoreCase|0);
	...
	visual_check(_Context->x_Auto3585+240,_Context->y_Auto3585+70,168,16,vfh[2],16,22,_Context->msg_ReverseSearch[_Context->language],strlen(_Context->msg_ReverseSearch[_Context->language]),_Context->value_ReverseSearch|0);
	...
	visual_check(_Context->x_Auto3585+420,_Context->y_Auto3585+70,154,16,vfh[2],27,0,_Context->msg_ReplaceAll[_Context->language],strlen(_Context->msg_ReplaceAll[_Context->language]),_Context->value_ReplaceAll|0);
	...
	visual_button(_Context->x_Auto3585+530,_Context->y_Auto3585+30,68,16,vfh[8],16,22,_Context->msg_DoReplace[_Context->language],strlen(_Context->msg_DoReplace[_Context->language]),0);
	_Context->trigger_Quit=visual_trigger_code(_Context->msg_Quit[_Context->language],strlen(_Context->msg_Quit[_Context->language]));
	visual_button(_Context->x_Auto3585+530,_Context->y_Auto3585+50,70,20,vfh[8],16,22,_Context->msg_Quit[_Context->language],strlen(_Context->msg_Quit[_Context->language]),0);
	visual_thaw(_Context->x_Auto3585,_Context->y_Auto3585,610,100);
...
private int Auto3585action(struct accept_replace_context * _Context) {
	...
	do {
		...
		_Context->x_Auto3585 += (visual_event(7)-x);
		x=visual_event(7);
		if (_Context->x_Auto3585 < 0) { _Context->x_Auto3585=0; }
		_Context->y_Auto3585 += (visual_event(6)-y);
		y=visual_event(6);
		if (_Context->y_Auto3585 < 0) { _Context->y_Auto3585=0; }
...
struct accept_replace_context * _Context){
	...
	switch (mt) {
	case _MIMO_UP :
	if ((mx >= (_Context->x_Auto3585+589) )  
	&&  (my >= (_Context->y_Auto3585+4) )  
	&&  (mx <= (_Context->x_Auto3585+606) )  
	&&  (my <= (_Context->y_Auto3585+20) )) {
		return(1);	/* Auto3585 */

		}
	if ((mx >= (_Context->x_Auto3585+573) )  
	&&  (my >= (_Context->y_Auto3585+4) )  
	&&  (mx <= (_Context->x_Auto3585+590) )  
	&&  (my <= (_Context->y_Auto3585+20) )) {
	...
	if ((mx >= (_Context->x_Auto3585+557) )  
	&&  (my >= (_Context->y_Auto3585+4) )  
	&&  (mx <= (_Context->x_Auto3585+574) )  
	&&  (my <= (_Context->y_Auto3585+20) )) {
	...
	case _MIMO_DOWN :
		if ((mx >= (_Context->x_Auto3585+4) )  
		&&  (my >= (_Context->y_Auto3585+4) )  
		&&  (mx <= (_Context->x_Auto3585+542) )  
		&&  (my <= (_Context->y_Auto3585+20) )) {
			return( Auto3585action(_Context) );
			}
		}
	if (( mx >= (_Context->x_Auto3585+100) ) 
	&&  ( my >= (_Context->y_Auto3585+30) ) 
	&&  ( mx <= (_Context->x_Auto3585+100+424) ) 
	&&  ( my <= (_Context->y_Auto3585+30+16))) {
		return(2); /* Criteria */
		}
	if (( mx >= (_Context->x_Auto3585+100) ) 
	&&  ( my >= (_Context->y_Auto3585+50) ) 
	&&  ( mx <= (_Context->x_Auto3585+100+424) ) 
	&&  ( my <= (_Context->y_Auto3585+50+16))) {
		return(3); /* Replace */
		}
	if (( mx >= (_Context->x_Auto3585+100) ) 
	&&  ( my >= (_Context->y_Auto3585+70) ) 
	&&  ( mx <= (_Context->x_Auto3585+100+140) ) 
	&&  ( my <= (_Context->y_Auto3585+70+16))) {
		return(4); /* IgnoreCase */
		}
	if (( mx >= (_Context->x_Auto3585+240) ) 
	&&  ( my >= (_Context->y_Auto3585+70) ) 
	&&  ( mx <= (_Context->x_Auto3585+240+168) ) 
	&&  ( my <= (_Context->y_Auto3585+70+16))) {
		return(5); /* ReverseSearch */
		}
	if (( mx >= (_Context->x_Auto3585+420) ) 
	&&  ( my >= (_Context->y_Auto3585+70) ) 
	&&  ( mx <= (_Context->x_Auto3585+420+154) ) 
	&&  ( my <= (_Context->y_Auto3585+70+16))) {
		return(6); /* ReplaceAll */
		}
	if (( mx >= (_Context->x_Auto3585+530) ) 
	&&  ( my >= (_Context->y_Auto3585+30) ) 
	&&  ( mx <= (_Context->x_Auto3585+530+68) ) 
	&&  ( my <= (_Context->y_Auto3585+30+16))) {
		return(7); /* DoReplace */
		}
	if (( mx >= (_Context->x_Auto3585+530) ) 
	&&  ( my >= (_Context->y_Auto3585+50) ) 
	&&  ( mx <= (_Context->x_Auto3585+530+70) ) 
	&&  ( my <= (_Context->y_Auto3585+50+20))) {
		return(8); /* Quit */
		}
...
public	int	accept_replace_focus(struct accept_replace_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			case	0x2 :
				/* Criteria */
				_Context->keycode = visual_edit(_Context->x_Auto3585+100+1,_Context->y_Auto3585+30+1,424,16,vfh[1],_Context->buffer_Criteria,255);
			...
			case	0x3 :
				/* Replace */
				_Context->keycode = visual_edit(_Context->x_Auto3585+100+1,_Context->y_Auto3585+50+1,424,16,vfh[1],_Context->buffer_Replace,255);
				if(_Context->keycode==13){
				on_DoReplace_event(_Context);
				_Context->keycode=0;
				}
			...
			case	0x4 :
				/* IgnoreCase */
				visual_check(_Context->x_Auto3585+100,_Context->y_Auto3585+70,140,16,vfh[2],16,22,_Context->msg_IgnoreCase[_Context->language],strlen(_Context->msg_IgnoreCase[_Context->language]),(_Context->value_IgnoreCase |2));
	...
	visual_check(_Context->x_Auto3585+100,_Context->y_Auto3585+70,140,16,vfh[2],16,22,_Context->msg_IgnoreCase[_Context->language],strlen(_Context->msg_IgnoreCase[_Context->language]),_Context->value_IgnoreCase|0);
			...
			case	0x5 :
				/* ReverseSearch */
				visual_check(_Context->x_Auto3585+240,_Context->y_Auto3585+70,168,16,vfh[2],16,22,_Context->msg_ReverseSearch[_Context->language],strlen(_Context->msg_ReverseSearch[_Context->language]),(_Context->value_ReverseSearch |2));
				_Context->keycode = visual_getch();
				_Context->trigger_ReverseSearch=visual_trigger_code(_Context->msg_ReverseSearch[_Context->language],strlen(_Context->msg_ReverseSearch[_Context->language]));
	visual_check(_Context->x_Auto3585+240,_Context->y_Auto3585+70,168,16,vfh[2],16,22,_Context->msg_ReverseSearch[_Context->language],strlen(_Context->msg_ReverseSearch[_Context->language]),_Context->value_ReverseSearch|0);
				break;
			case	0x6 :
				/* ReplaceAll */
				visual_check(_Context->x_Auto3585+420,_Context->y_Auto3585+70,154,16,vfh[2],27,0,_Context->msg_ReplaceAll[_Context->language],strlen(_Context->msg_ReplaceAll[_Context->language]),(_Context->value_ReplaceAll |2));
				_Context->keycode = visual_getch();
				_Context->trigger_ReplaceAll=visual_trigger_code(_Context->msg_ReplaceAll[_Context->language],strlen(_Context->msg_ReplaceAll[_Context->language]));
	visual_check(_Context->x_Auto3585+420,_Context->y_Auto3585+70,154,16,vfh[2],27,0,_Context->msg_ReplaceAll[_Context->language],strlen(_Context->msg_ReplaceAll[_Context->language]),_Context->value_ReplaceAll|0);
				break;
			case	0x7 :
				/* DoReplace */
				_Context->trigger_DoReplace=visual_trigger_code(_Context->msg_DoReplace[_Context->language],strlen(_Context->msg_DoReplace[_Context->language]));
				visual_button(_Context->x_Auto3585+530,_Context->y_Auto3585+30,68,16,vfh[8],16,22,_Context->msg_DoReplace[_Context->language],strlen(_Context->msg_DoReplace[_Context->language]),2);
				_Context->keycode = visual_getch();
				_Context->trigger_DoReplace=visual_trigger_code(_Context->msg_DoReplace[_Context->language],strlen(_Context->msg_DoReplace[_Context->language]));
	visual_button(_Context->x_Auto3585+530,_Context->y_Auto3585+30,68,16,vfh[8],16,22,_Context->msg_DoReplace[_Context->language],strlen(_Context->msg_DoReplace[_Context->language]),0);
				break;
			case	0x8 :
				/* Quit */
				_Context->trigger_Quit=visual_trigger_code(_Context->msg_Quit[_Context->language],strlen(_Context->msg_Quit[_Context->language]));
				visual_button(_Context->x_Auto3585+530,_Context->y_Auto3585+50,70,20,vfh[8],16,22,_Context->msg_Quit[_Context->language],strlen(_Context->msg_Quit[_Context->language]),2);
				_Context->keycode = visual_getch();
				_Context->trigger_Quit=visual_trigger_code(_Context->msg_Quit[_Context->language],strlen(_Context->msg_Quit[_Context->language]));
	visual_button(_Context->x_Auto3585+530,_Context->y_Auto3585+50,70,20,vfh[8],16,22,_Context->msg_Quit[_Context->language],strlen(_Context->msg_Quit[_Context->language]),0);
				break;
