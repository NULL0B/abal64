...
static int	vfh[16];
private int on_Auto3577_event(struct accept_modelsave_context * _Context);
private int on_Select_event(struct accept_modelsave_context * _Context);
private int on_Auto3578_event(struct accept_modelsave_context * _Context);
...
public	int	accept_modelsave_show(struct accept_modelsave_context * _Context)
{
	...
	visual_button(_Context->x_auto6+20,_Context->y_auto6+140,56,48,vfh[2],34,0,_Context->msg_Auto3577[_Context->language],strlen(_Context->msg_Auto3577[_Context->language]),1040);
	...
	visual_button(_Context->x_auto6+520,_Context->y_auto6+140,56,48,vfh[2],34,0,_Context->msg_Auto3578[_Context->language],strlen(_Context->msg_Auto3578[_Context->language]),1040);
...
private int Select_help()
{
	switch (visual_national_language(-1)) {
		case 0 : 
			{
			char * mptr[2];
			mptr[0] = "This button allows the target model filename to be selected using ";
...
struct accept_modelsave_context * _Context){
	...
	if (visual_event(1) & _MIMO_ALT) {
		...
		if (_Context->trigger_Auto3577 == mb ) return(3);
		if (_Context->trigger_Select == mb ) return(4);
		if (_Context->trigger_Auto3578 == mb ) return(5);
...
public	int	accept_modelsave_focus(struct accept_modelsave_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			...
			case	0x3 :
				/* Auto3577 */
				_Context->trigger_Auto3577=visual_trigger_code(_Context->msg_Auto3577[_Context->language],strlen(_Context->msg_Auto3577[_Context->language]));
				visual_button(_Context->x_auto6+20,_Context->y_auto6+140,56,48,vfh[2],34,0,_Context->msg_Auto3577[_Context->language],strlen(_Context->msg_Auto3577[_Context->language]),1042);
	...
	visual_button(_Context->x_auto6+360,_Context->y_auto6+150,100,30,vfh[2],27,24,_Context->msg_Select[_Context->language],strlen(_Context->msg_Select[_Context->language]),0);
			...
			case	0x5 :
				/* Auto3578 */
				_Context->trigger_Auto3578=visual_trigger_code(_Context->msg_Auto3578[_Context->language],strlen(_Context->msg_Auto3578[_Context->language]));
				visual_button(_Context->x_auto6+520,_Context->y_auto6+140,56,48,vfh[2],34,0,_Context->msg_Auto3578[_Context->language],strlen(_Context->msg_Auto3578[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto3578=visual_trigger_code(_Context->msg_Auto3578[_Context->language],strlen(_Context->msg_Auto3578[_Context->language]));
	visual_button(_Context->x_auto6+520,_Context->y_auto6+140,56,48,vfh[2],34,0,_Context->msg_Auto3578[_Context->language],strlen(_Context->msg_Auto3578[_Context->language]),1040);
				break;
