...
WORD			check_case_operator( RESULTPTR, WORD );
...
RESULTPTR	primary_integer_term( VOID );
...
WORD			evaluate_case_comparison( WORD, RESULTPTR, RESULTPTR, WORD, WORD );
