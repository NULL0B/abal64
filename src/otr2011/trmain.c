...
#ifdef	ABALV33
#ifdef	otr32
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','3','a','0','0','1',1 };
#else
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','3','a','0','0','1',1 };
#endif
...
#ifdef	ABAL32B
#ifdef	otr32
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','2','b','1','0','1',1 };
#else
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','2','b','1','0','1',1 };
#endif
...
#ifdef	ABAL33A
#ifdef	otr32
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','2','b','0','0','4',1 };
#else
...
#ifdef	ABAL32A
#ifdef	otr32
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','2','a','0','1','4',1 };
#else
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','2','a','0','1','4',1 };
#endif
...
#ifdef	otr32
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','1','e','0','1','4',1 };
#else
static	char 	LaPaterne[32] = { '*','P','R','L','@','I','N','F','O','*','#',6,'3','1','e','0','1','4',1 };
#endif
