 ...
 *      02!09!97 : S Barthe : ajout ifdef SHAREDLO pour partageabilite imprimante
...
static CHAR *message[] = {
	...
	"CICO - Version 4.1 (",                         /* 11 */
	UPDATE,                                         /* 12 */
	")\nCopyright (c) 1989-2019 Amenesik / Sologic\n\n",      /* 13 */
};
...
//#BG 24/05/19 16 couleurs de fond
#ifndef TEST_BG16
#define BACKGR_8	term_str[BACK_FIRST + 8]	/* gris fonce	*/
#define BACKGR_9	term_str[BACK_FIRST + 9]	/* rouge clair	*/
#define BACKGR_A	term_str[BACK_FIRST + 10]	/* vert clair	*/
#define BACKGR_B	term_str[BACK_FIRST + 11]	/* jaune	*/
#define BACKGR_C	term_str[BACK_FIRST + 12]	/* bleu clair	*/
#define BACKGR_D	term_str[BACK_FIRST + 13]	/* magenta clair	*/
#define BACKGR_E	term_str[BACK_FIRST + 14]	/* cyan clair	*/
#define BACKGR_F	term_str[BACK_FIRST + 15]	/* blanc	*/
#else
#define BACKGR_8	"\033[100m"		/* gris fonce	*/
#define BACKGR_9	"\033[101m"		/* rouge clair	*/
#define BACKGR_A	"\033[102m"		/* vert clair	*/
#define BACKGR_B	"\033[103m"		/* jaune	*/
#define BACKGR_C	"\033[104m"		/* bleu clair	*/
#define BACKGR_D	"\033[105m"		/* magenta clair*/
#define BACKGR_E	"\033[106m"		/* cyan clair	*/
#define BACKGR_F	"\033[107m"		/* blanc	*/
#endif
...
static BYTE *term_str[ NB_CAPA ];
#else
static BYTE *term_str[SET_NB + ATB_NB + FORE_NB + BACK_NB + SCR_NB + SEC_NB + NKEY_STR_NB + SCAN_NB + COMP_NB];
#endif
