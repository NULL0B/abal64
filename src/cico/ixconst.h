...
#define ECR_SIGNATURE14			"CICO14"
#ifdef	_USEIT_FOR_WHATEVER
#define ECR_SIGNATURE22			"CICO22"
#define ECR_SIGNATURE41			"CICO41"	//#BG 24/05/19 16 couleurs de fond
#endif
...
#define ETAT_DEFINE  		16	/* esc N			*/
#define ETAT_IMAGE   		17	/* esc I image description	*/
#define ETAT_VIDEO   		18	/* esc V video description	*/
#define ETAT_LABEL   		19	/* esc X label description	*/
#define ETAT_FONT    		20 	/* esc Y font description	*/
#define ETAT_HUE     		21	/* esc H colour description	*/
#define ETAT_UPLOAD  		22	/* esc ! [ 0 | 1 ] uploader	*/
