...
#define VER_FILEVERSION_STR      "old 4.0.0\0"
#define VER_FILEVERSION_STRC     "400"
...
#define VER_FILEDESCRIPTION_STR      "ABAL 16 bits Object Linker for TwinServer\0"

#elif defined(__linux__) || defined(BDA_UNIX)
#define VER_ORIGINALFILENAME_STR     "old\0"
#define VER_FILEDESCRIPTION_STR      "ABAL 16-32 bits  Object Linker for UiLS\0"

#elif defined(WIN32) || defined(_WIN32) || defined(BDA_WIN32)
#define VER_ORIGINALFILENAME_STR     "wold32.exe\0"
#define VER_FILEDESCRIPTION_STR      "ABAL 16-32 bits Object Linker for Windows\0"
...
// ----------------------------------------------------------------
	...
	#if defined (_DEBUG)
		#define VER_BUILD_STR		"DT9      \0"	
	#else
		#define VER_BUILD_STR		"RT9      \0"	
	#endif

#else

	#if defined (_DEBUG)
		#define VER_BUILD_STR		"D9       \0"	
	#else
		#define VER_BUILD_STR		"R9       \0"	
	#endif
