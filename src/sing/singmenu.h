...
#define	_SING_HELP	0x0008		/* Ctrl H :	KBF(128)	:	F1	*/
#define	_SING_PROD	0x0010		/* Ctrl P :	KBF(129)	:	F2	*/
#define	_SING_BASE	0x001A		/* Ctrl Z :	KBF(130)	:	F3	*/
#define	_SING_FLOW	0x0006		/* Ctrl F :	KBF(131)	:	F4	*/

#define	_CREATE_WITHOUT_SIZE	'X1'
#define	_CREATE_WITH_SIZE	'X2'
#define	_SHOW_AUTOMATIC		'X3'
#define	_SHOW_CONDITIONAL	'X4'
#define	_FOCUS_WITH_FOCUS	'X5'
#define	_FOCUS_WITHOUT_FOCUS	'X6'
#define	_EVENT_WITH_EVENT	'X7'
#define	_EVENT_WITHOUT_EVENT	'X8'
#define	_HIDE_NO_POPUP		'X9'
#define	_HIDE_WITH_POPUP	'XA'
...
#define	_FORM_HELP		'FH'
#define	_FORM_FIT 		'FW'
#define	_FORM_ROLLBACK		'FB'
#define	_FORM_ROLLFORE		'FE'
#define	_FORM_STYLE   		'FX'
#define	_FORM_METH		'FM'
#define	_FORM_COMPARE		'FK'
#define	_FORM_IMPORT		'FV'
...
#define	_FILE_MERGE		'FY'
#define	_FILE_METH		'FM'
...
#define	__3D_ORDER 	'3O'
#define	__3D_PROJECT	'3P'
#define	__3D_FILEMAN	'3Q'
#define	__3D_RIGHT	'3R'
#define	__3D_AUDIO 	'3S'
#define	__3D_TEXT 	'3T'
#define	__3D_UP		'3U'
#define	__3D_MOVIE 	'3V'
#define	__3D_IMAGE 	'3X'
#define	__3D_LEFT	'3Y'
#define	__3D_CALC	'3Z'
#define __EXPORT_LABELS	'EL'
#define __IMPORT_LABELS	'IL'
#define __SORT_NAME	'SN'
#define __SORT_TYPE	'ST'
