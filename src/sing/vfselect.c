...
#define en_Auto3562   "Selected Filename(s)"
#define fr_Auto3562   "Fichier(s) s‚lectionn‚(s)"
#define it_Auto3562   "Selected Filename(s)"
#define es_Auto3562   "Selected Filename(s)"
#define de_Auto3562   "Selected Filename(s)"
#define nl_Auto3562   "Selected Filename(s)"
#define pt_Auto3562   "Selected Filename(s)"
#define xx_Auto3562   "Selected Filename(s)"
#define en_Result   ""
#define en_Auto3563   "File Selection Criteria"
#define fr_Auto3563   "CritŠre de s‚lection de fichiers"
#define it_Auto3563   "File Selection Criteria"
#define es_Auto3563   "File Selection Criteria"
#define de_Auto3563   "File Selection Criteria"
#define nl_Auto3563   "File Selection Criteria"
#define pt_Auto3563   "File Selection Criteria"
#define xx_Auto3563   "File Selection Criteria"
#define en_Auto3564   "File Type"
#define fr_Auto3564   "Type de fichier"
#define it_Auto3564   "File Type"
#define es_Auto3564   "File Type"
#define de_Auto3564   "File Type"
#define nl_Auto3564   "File Type"
#define pt_Auto3564   "File Type"
#define xx_Auto3564   "File Type"
...
private int on_Auto3565_event(struct file_selector_context * _Context);
...
private int on_Auto3566_event(struct file_selector_context * _Context);
...
_Context->indsort_FileInfos=NULL;	/* pas de pointeur de table intermédiaire */	if (_Context->keycode != 27 ) {
	...
	_Context->x_Auto3561=60;
	_Context->y_Auto3561=25;
	_Context->w_Auto3561=680;
	_Context->h_Auto3561=550;
	...
	_Context->pushbuffer=visual_buffer(_Context->x_Auto3561,_Context->y_Auto3561,680+10,550+10);
	return(0);
}
...
public 	int	file_selector_hide(struct file_selector_context * _Context)
{
	...
	&& (_Context->ctrlbuffer != 0)) {
		(void)visual_buffer_put(_Context->pushbuffer,_Context->x_Auto3561,_Context->y_Auto3561);
		_Context->ctrlbuffer=0;
		}
...
private int on_FileNames_show(struct file_selector_context * _Context) {
	if(!(_Context->value_InfoSelector)){
		visual_table(_Context->x_Auto3561+20,_Context->y_Auto3561+80,630,300,vfh[1],27,0,_Context->msg_FileNames[_Context->language],_Context->buffer_FileNames,0x0401,(char*) 0);

	}
	else{
		visual_table(_Context->x_Auto3561+20,_Context->y_Auto3561+80,630,300,vfh[1],27,0,_Context->msg_FileInfos[_Context->language],_Context->buffer_FileInfos,0x4401,"($,N11Z,W10,W10)");
;
	}
	return(-1);
}
...
public	int	file_selector_show(struct file_selector_context * _Context)
{
	...
	if ((_Context->pushbuffer != (void *) 0)
	&& (!(_Context->ctrlbuffer))) {
		(void)visual_buffer_get(_Context->pushbuffer,_Context->x_Auto3561,_Context->y_Auto3561);
		_Context->ctrlbuffer=1;
		}
	visual_freeze();
	if (((_Context->status = visual_styled_element(_Context->x_Auto3561,_Context->y_Auto3561,680,550,GetWidgetStyle(0),GetWindowVersion(),strlen(GetWindowVersion()))) != 0)
) {
		visual_window(_Context->x_Auto3561,_Context->y_Auto3561,680,550,vfh[2],GetWindowVersion(),strlen(GetWindowVersion()),0x407);
		}
	visual_text(_Context->x_Auto3561+20,_Context->y_Auto3561+390,490,20,vfh[2],27,0,_Context->msg_amato666[_Context->language],strlen(_Context->msg_amato666[_Context->language]),258);
	visual_text(_Context->x_Auto3561+20,_Context->y_Auto3561+30,630,16,vfh[2],27,0,_Context->msg_Auto3562[_Context->language],strlen(_Context->msg_Auto3562[_Context->language]),258);
	visual_frame(_Context->x_Auto3561+20,_Context->y_Auto3561+50,630+2,20+2,5);
	visual_text(_Context->x_Auto3561+20+1,_Context->y_Auto3561+50+1,630,20,vfh[1],27,0,_Context->buffer_Result,255,0);
	visual_text(_Context->x_Auto3561+180,_Context->y_Auto3561+440,470,20,vfh[2],27,0,_Context->msg_Auto3563[_Context->language],strlen(_Context->msg_Auto3563[_Context->language]),258);
	visual_text(_Context->x_Auto3561+20,_Context->y_Auto3561+440,120,20,vfh[2],27,0,_Context->msg_Auto3564[_Context->language],strlen(_Context->msg_Auto3564[_Context->language]),258);
	...
	visual_button(_Context->x_Auto3561+20,_Context->y_Auto3561+490,56,48,vfh[2],34,0,_Context->msg_Auto3565[_Context->language],strlen(_Context->msg_Auto3565[_Context->language]),1040);
	_Context->trigger_Find=visual_trigger_code(_Context->msg_Find[_Context->language],strlen(_Context->msg_Find[_Context->language]));
	visual_button(_Context->x_Auto3561+180,_Context->y_Auto3561+500,120,30,vfh[2],27,0,_Context->msg_Find[_Context->language],strlen(_Context->msg_Find[_Context->language]),0);
	...
	visual_switch(_Context->x_Auto3561+320,_Context->y_Auto3561+500,56,32,vfh[2],12,31,_Context->msg_InfoSelector[_Context->language],strlen(_Context->msg_InfoSelector[_Context->language]),_Context->value_InfoSelector| 0x0030);
	...
	visual_button(_Context->x_Auto3561+400,_Context->y_Auto3561+500,110,30,vfh[2],27,0,_Context->msg_Delete[_Context->language],strlen(_Context->msg_Delete[_Context->language]),0);
	...
	visual_button(_Context->x_Auto3561+590,_Context->y_Auto3561+490,56,48,vfh[2],34,0,_Context->msg_Auto3566[_Context->language],strlen(_Context->msg_Auto3566[_Context->language]),1040);
	visual_select(_Context->x_Auto3561+20,_Context->y_Auto3561+460,120,80,vfh[2],27,0,parse_selection(WidgetFileNames,&_Context->value_FileType),768);
	visual_frame(_Context->x_Auto3561+20,_Context->y_Auto3561+410,630+2,20+2,5);
	visual_text(_Context->x_Auto3561+20+1,_Context->y_Auto3561+410+1,630,20,vfh[1],0,0,_Context->buffer_Path,255,0);
	visual_frame(_Context->x_Auto3561+180,_Context->y_Auto3561+460,470+2,20+2,5);
	visual_text(_Context->x_Auto3561+180+1,_Context->y_Auto3561+460+1,470,20,vfh[1],27,0,_Context->buffer_FileSelection,255,0);
	visual_scrollbar(_Context->x_Auto3561+650,_Context->y_Auto3561+80,20,300,vfh[1],0,0,_Context->value_Slider,_Context->limit_Slider,_Context->max_Slider,3);
	(void) on_FileNames_show(_Context);
	(void) on_FileInfos_show(_Context);
	visual_thaw(_Context->x_Auto3561,_Context->y_Auto3561,680,550);
...
private int Auto3561action(struct file_selector_context * _Context) {
	...
	do {
		...
		_Context->x_Auto3561 += (visual_event(7)-x);
		x=visual_event(7);
		if (_Context->x_Auto3561 < 0) { _Context->x_Auto3561=0; }
		_Context->y_Auto3561 += (visual_event(6)-y);
		y=visual_event(6);
		if (_Context->y_Auto3561 < 0) { _Context->y_Auto3561=0; }
...
private int on_Slider_action(struct file_selector_context * _Context) {
	...
	if ( visual_event(6) < (_Context->y_Auto3561+80+20) ) {
		do { while( visual_getch() != 256); } while ( visual_event(1)  != _MIMO_UP );
		_Context->value_Slider -= 1;
		if (_Context->value_Slider < 0) 
			_Context->value_Slider = 0;
		(void) on_Slider_event(_Context);
	visual_scrollbar(_Context->x_Auto3561+650,_Context->y_Auto3561+80,20,300,vfh[1],0,0,_Context->value_Slider,_Context->limit_Slider,_Context->max_Slider,259);
		return(-1);
		}
	if ( visual_event(6) > (_Context->y_Auto3561+80+300-20) ) {
		do { while( visual_getch() != 256); } while ( visual_event(1)  != _MIMO_UP );
		_Context->value_Slider += 1;
	...
	do {
		...
		_Context->value_Slider = (((visual_event(6) - (_Context->y_Auto3561+80+20)) * _Context->max_Slider) / (300 - (2 * 20)));
		if (_Context->value_Slider < 0) 
			_Context->value_Slider = 0;
		else if (_Context->value_Slider > (_Context->max_Slider-_Context->limit_Slider)) 
			_Context->value_Slider = (_Context->max_Slider-_Context->limit_Slider);
...
struct file_selector_context * _Context){
	...
	switch (mt) {
	case _MIMO_UP :
	if ((mx >= (_Context->x_Auto3561+659) )  
	&&  (my >= (_Context->y_Auto3561+4) )  
	&&  (mx <= (_Context->x_Auto3561+676) )  
	&&  (my <= (_Context->y_Auto3561+20) )) {
		return(1);	/* Auto3561 */

		}
	if ((mx >= (_Context->x_Auto3561+643) )  
	&&  (my >= (_Context->y_Auto3561+4) )  
	&&  (mx <= (_Context->x_Auto3561+660) )  
	&&  (my <= (_Context->y_Auto3561+20) )) {
	...
	if ((mx >= (_Context->x_Auto3561+627) )  
	&&  (my >= (_Context->y_Auto3561+4) )  
	&&  (mx <= (_Context->x_Auto3561+644) )  
	&&  (my <= (_Context->y_Auto3561+20) )) {
	...
	case _MIMO_DOWN :
		if ((mx >= (_Context->x_Auto3561+4) )  
		&&  (my >= (_Context->y_Auto3561+4) )  
		&&  (mx <= (_Context->x_Auto3561+612) )  
		&&  (my <= (_Context->y_Auto3561+20) )) {
			return( Auto3561action(_Context) );
			}
		}
	if (( mx >= (_Context->x_Auto3561+20) ) 
	&&  ( my >= (_Context->y_Auto3561+50) ) 
	&&  ( mx <= (_Context->x_Auto3561+20+630) ) 
	&&  ( my <= (_Context->y_Auto3561+50+20))) {
		return(2); /* Result */
		}
	if (( mx >= (_Context->x_Auto3561+20) ) 
	&&  ( my >= (_Context->y_Auto3561+490) ) 
	&&  ( mx <= (_Context->x_Auto3561+20+56) ) 
	&&  ( my <= (_Context->y_Auto3561+490+48))) {
		return(3); /* Auto3565 */
		}
	if (( mx >= (_Context->x_Auto3561+180) ) 
	&&  ( my >= (_Context->y_Auto3561+500) ) 
	&&  ( mx <= (_Context->x_Auto3561+180+120) ) 
	&&  ( my <= (_Context->y_Auto3561+500+30))) {
		return(4); /* Find */
		}
	if (( mx >= (_Context->x_Auto3561+320) ) 
	&&  ( my >= (_Context->y_Auto3561+500) ) 
	&&  ( mx <= (_Context->x_Auto3561+320+56) ) 
	&&  ( my <= (_Context->y_Auto3561+500+32))) {
		return(5); /* InfoSelector */
		}
	if (( mx >= (_Context->x_Auto3561+400) ) 
	&&  ( my >= (_Context->y_Auto3561+500) ) 
	&&  ( mx <= (_Context->x_Auto3561+400+110) ) 
	&&  ( my <= (_Context->y_Auto3561+500+30))) {
		return(6); /* Delete */
		}
	if (( mx >= (_Context->x_Auto3561+590) ) 
	&&  ( my >= (_Context->y_Auto3561+490) ) 
	&&  ( mx <= (_Context->x_Auto3561+590+56) ) 
	&&  ( my <= (_Context->y_Auto3561+490+48))) {
		return(7); /* Auto3566 */
		}
	if (( mx >= (_Context->x_Auto3561+20+0) ) 
	&&  ( my >= (_Context->y_Auto3561+460) ) 
	&&  ( mx <= (_Context->x_Auto3561+20+120) ) 
	&&  ( my <= (_Context->y_Auto3561+460+16))) {
		return(8); /* FileType */
		}
	if (( mx >= (_Context->x_Auto3561+20) ) 
	&&  ( my >= (_Context->y_Auto3561+410) ) 
	&&  ( mx <= (_Context->x_Auto3561+20+630) ) 
	&&  ( my <= (_Context->y_Auto3561+410+20))) {
		return(9); /* Path */
		}
	if (( mx >= (_Context->x_Auto3561+180) ) 
	&&  ( my >= (_Context->y_Auto3561+460) ) 
	&&  ( mx <= (_Context->x_Auto3561+180+470) ) 
	&&  ( my <= (_Context->y_Auto3561+460+20))) {
		return(10); /* FileSelection */
		}
	if (( mx >= (_Context->x_Auto3561+650) ) 
	&&  ( my >= (_Context->y_Auto3561+80) ) 
	&&  ( mx <= (_Context->x_Auto3561+650+20) ) 
	&&  ( my <= (_Context->y_Auto3561+80+300))) {
		return(11); /* Slider */
		}
	if (( mx >= (_Context->x_Auto3561+20) ) 
	&&  ( my >= (_Context->y_Auto3561+80) ) 
	&&  ( mx <= (_Context->x_Auto3561+20+630) ) 
	&&  ( my <= (_Context->y_Auto3561+80+300))) {
		if ((_Context->value_FileNames = ((visual_event(6) - (_Context->y_Auto3561+80)) / 16)) < 1)
		...
		_Context->column_FileNames = (visual_event(7) - (_Context->x_Auto3561+20));
	...
	&&  ( mx <= (_Context->x_Auto3561+20+630) ) 
	&&  ( my <= (_Context->y_Auto3561+80+300))) {
		if ((_Context->value_FileInfos = ((visual_event(6) - (_Context->y_Auto3561+80)) / 16)) < 1)
		...
		_Context->column_FileInfos = (visual_event(7) - (_Context->x_Auto3561+20));
...
public	int	file_selector_focus(struct file_selector_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			case	0x2 :
				/* Result */
				_Context->keycode = visual_edit(_Context->x_Auto3561+20+1,_Context->y_Auto3561+50+1,630,20,vfh[1],_Context->buffer_Result,255);
			break;
			case	0x3 :
				/* Auto3565 */
				_Context->trigger_Auto3565=visual_trigger_code(_Context->msg_Auto3565[_Context->language],strlen(_Context->msg_Auto3565[_Context->language]));
				visual_button(_Context->x_Auto3561+20,_Context->y_Auto3561+490,56,48,vfh[2],34,0,_Context->msg_Auto3565[_Context->language],strlen(_Context->msg_Auto3565[_Context->language]),1042);
	...
	visual_button(_Context->x_Auto3561+20,_Context->y_Auto3561+490,56,48,vfh[2],34,0,_Context->msg_Auto3565[_Context->language],strlen(_Context->msg_Auto3565[_Context->language]),1040);
			...
			case	0x4 :
				/* Find */
				_Context->trigger_Find=visual_trigger_code(_Context->msg_Find[_Context->language],strlen(_Context->msg_Find[_Context->language]));
				visual_button(_Context->x_Auto3561+180,_Context->y_Auto3561+500,120,30,vfh[2],27,0,_Context->msg_Find[_Context->language],strlen(_Context->msg_Find[_Context->language]),2);
				_Context->keycode = visual_getch();
				_Context->trigger_Find=visual_trigger_code(_Context->msg_Find[_Context->language],strlen(_Context->msg_Find[_Context->language]));
	visual_button(_Context->x_Auto3561+180,_Context->y_Auto3561+500,120,30,vfh[2],27,0,_Context->msg_Find[_Context->language],strlen(_Context->msg_Find[_Context->language]),0);
				break;
			case	0x5 :
				/* InfoSelector */
				visual_switch(_Context->x_Auto3561+320,_Context->y_Auto3561+500,56,32,vfh[2],12,31,_Context->msg_InfoSelector[_Context->language],strlen(_Context->msg_InfoSelector[_Context->language]),(_Context->value_InfoSelector | 2 | 0x0030 ));
				_Context->keycode = visual_getch();
				_Context->trigger_InfoSelector=visual_trigger_code(_Context->msg_InfoSelector[_Context->language],strlen(_Context->msg_InfoSelector[_Context->language]));
	visual_switch(_Context->x_Auto3561+320,_Context->y_Auto3561+500,56,32,vfh[2],12,31,_Context->msg_InfoSelector[_Context->language],strlen(_Context->msg_InfoSelector[_Context->language]),_Context->value_InfoSelector| 0x0030);
				break;
			case	0x6 :
				/* Delete */
				_Context->trigger_Delete=visual_trigger_code(_Context->msg_Delete[_Context->language],strlen(_Context->msg_Delete[_Context->language]));
				visual_button(_Context->x_Auto3561+400,_Context->y_Auto3561+500,110,30,vfh[2],27,0,_Context->msg_Delete[_Context->language],strlen(_Context->msg_Delete[_Context->language]),2);
				_Context->keycode = visual_getch();
				_Context->trigger_Delete=visual_trigger_code(_Context->msg_Delete[_Context->language],strlen(_Context->msg_Delete[_Context->language]));
	visual_button(_Context->x_Auto3561+400,_Context->y_Auto3561+500,110,30,vfh[2],27,0,_Context->msg_Delete[_Context->language],strlen(_Context->msg_Delete[_Context->language]),0);
				break;
			case	0x7 :
				/* Auto3566 */
				_Context->trigger_Auto3566=visual_trigger_code(_Context->msg_Auto3566[_Context->language],strlen(_Context->msg_Auto3566[_Context->language]));
				visual_button(_Context->x_Auto3561+590,_Context->y_Auto3561+490,56,48,vfh[2],34,0,_Context->msg_Auto3566[_Context->language],strlen(_Context->msg_Auto3566[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto3566=visual_trigger_code(_Context->msg_Auto3566[_Context->language],strlen(_Context->msg_Auto3566[_Context->language]));
	visual_button(_Context->x_Auto3561+590,_Context->y_Auto3561+490,56,48,vfh[2],34,0,_Context->msg_Auto3566[_Context->language],strlen(_Context->msg_Auto3566[_Context->language]),1040);
				break;
			case	0x8 :
				/* FileType */
				_Context->keycode = visual_select(_Context->x_Auto3561+20,_Context->y_Auto3561+460,120,80,vfh[2],27,0,parse_selection(WidgetFileNames,&_Context->value_FileType),770);
				(void) on_FileType_losefocus(_Context);
				break;
			case	0x9 :
				/* Path */
				_Context->keycode = visual_edit(_Context->x_Auto3561+20+1,_Context->y_Auto3561+410+1,630,20,vfh[1],_Context->buffer_Path,255);
				(void) on_Path_losefocus(_Context);
			break;
			case	0xa :
				/* FileSelection */
				_Context->keycode = visual_edit(_Context->x_Auto3561+180+1,_Context->y_Auto3561+460+1,470,20,vfh[1],_Context->buffer_FileSelection,255);
			break;
			case	0xc :
				/* FileNames */
	_Context->keycode = visual_getch();
			...
			case	0xd :
				...
				case	0x1 :
					_Context->keycode=visual_edit((_Context->x_Auto3561+20+2),(_Context->y_Auto3561+80+(_Context->value_FileInfos*16)+2),336,16,vfh[1],&_Context->buffer_FileInfos[(_Context->value_FileInfos-1)][0],42);
				visual_text((_Context->x_Auto3561+20+2),(_Context->y_Auto3561+80+(_Context->value_FileInfos*16)+2),336,16,vfh[1],27,(24-((_Context->value_FileInfos-1)&1)),&_Context->buffer_FileInfos[(_Context->value_FileInfos-1)][0],42,0);
					break;
				case	0x2 :
					_Context->keycode=visual_edit((_Context->x_Auto3561+20+346),(_Context->y_Auto3561+80+(_Context->value_FileInfos*16)+2),96,16,vfh[1],&_Context->buffer_FileInfos[(_Context->value_FileInfos-1)][43],12);
				visual_text((_Context->x_Auto3561+20+346),(_Context->y_Auto3561+80+(_Context->value_FileInfos*16)+2),96,16,vfh[1],27,(24-((_Context->value_FileInfos-1)&1)),&_Context->buffer_FileInfos[(_Context->value_FileInfos-1)][43],12,0);
					break;
				case	0x3 :
					_Context->keycode=visual_edit((_Context->x_Auto3561+20+450),(_Context->y_Auto3561+80+(_Context->value_FileInfos*16)+2),80,16,vfh[1],&_Context->buffer_FileInfos[(_Context->value_FileInfos-1)][56],10);
				visual_text((_Context->x_Auto3561+20+450),(_Context->y_Auto3561+80+(_Context->value_FileInfos*16)+2),80,16,vfh[1],27,(24-((_Context->value_FileInfos-1)&1)),&_Context->buffer_FileInfos[(_Context->value_FileInfos-1)][56],10,0);
					break;
				case	0x4 :
					_Context->keycode=visual_edit((_Context->x_Auto3561+20+538),(_Context->y_Auto3561+80+(_Context->value_FileInfos*16)+2),80,16,vfh[1],&_Context->buffer_FileInfos[(_Context->value_FileInfos-1)][67],10);
				visual_text((_Context->x_Auto3561+20+538),(_Context->y_Auto3561+80+(_Context->value_FileInfos*16)+2),80,16,vfh[1],27,(24-((_Context->value_FileInfos-1)&1)),&_Context->buffer_FileInfos[(_Context->value_FileInfos-1)][67],10,0);
					break;
					}
				if ( _Context->keycode == 9 ) {
