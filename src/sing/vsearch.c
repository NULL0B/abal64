...
#define pt__Auto3588   ""
#define xx__Auto3588   ""
#define en_Auto3589   "Locate Text"
#define fr_Auto3589   "Rechercher"
#define it_Auto3589   "Locate Text"
#define es_Auto3589   "Locate Text"
#define de_Auto3589   "Locate Text"
#define nl_Auto3589   "Locate Text"
#define pt_Auto3589   "Locate Text"
#define xx_Auto3589   "Locate Text"
#define en_Criteria   ""
	...
	char * pReverseSearch)
{
	...
	_Context->x_Auto3588=95;
	_Context->y_Auto3588=260;
	_Context->w_Auto3588=610;
	_Context->h_Auto3588=80;
	...
	_Context->pushbuffer=visual_buffer(_Context->x_Auto3588,_Context->y_Auto3588,610+10,80+10);
	return(0);
}
...
public 	int	accept_search_hide(struct accept_search_context * _Context)
{
	...
	&& (_Context->ctrlbuffer != 0)) {
		(void)visual_buffer_put(_Context->pushbuffer,_Context->x_Auto3588,_Context->y_Auto3588);
		_Context->ctrlbuffer=0;
		}
...
public	int	accept_search_show(struct accept_search_context * _Context)
{
	...
	if ((_Context->pushbuffer != (void *) 0)
	&& (!(_Context->ctrlbuffer))) {
		(void)visual_buffer_get(_Context->pushbuffer,_Context->x_Auto3588,_Context->y_Auto3588);
		_Context->ctrlbuffer=1;
		}
	visual_freeze();
	if (((_Context->status = visual_styled_element(_Context->x_Auto3588,_Context->y_Auto3588,610,80,GetWidgetStyle(0),GetWindowVersion(),strlen(GetWindowVersion()))) != 0)
) {
		visual_window(_Context->x_Auto3588,_Context->y_Auto3588,610,80,vfh[2],GetWindowVersion(),strlen(GetWindowVersion()),0x407);
		}
	visual_text(_Context->x_Auto3588+20,_Context->y_Auto3588+30,570,20,vfh[2],27,0,_Context->msg_Auto3589[_Context->language],strlen(_Context->msg_Auto3589[_Context->language]),1282);
	visual_frame(_Context->x_Auto3588+100,_Context->y_Auto3588+30,424+2,16+2,5);
	visual_text(_Context->x_Auto3588+100+1,_Context->y_Auto3588+30+1,424,16,vfh[1],16,22,_Context->buffer_Criteria,255,0);
	...
	visual_check(_Context->x_Auto3588+90,_Context->y_Auto3588+50,154,16,vfh[2],16,22,_Context->msg_IgnoreCase[_Context->language],strlen(_Context->msg_IgnoreCase[_Context->language]),_Context->value_IgnoreCase|0);
	...
	visual_check(_Context->x_Auto3588+250,_Context->y_Auto3588+50,168,16,vfh[2],16,22,_Context->msg_ReverseSearch[_Context->language],strlen(_Context->msg_ReverseSearch[_Context->language]),_Context->value_ReverseSearch|0);
	...
	visual_button(_Context->x_Auto3588+530,_Context->y_Auto3588+30,68,16,vfh[8],16,22,_Context->msg_DoFind[_Context->language],strlen(_Context->msg_DoFind[_Context->language]),0);
	_Context->trigger_Quit=visual_trigger_code(_Context->msg_Quit[_Context->language],strlen(_Context->msg_Quit[_Context->language]));
	visual_button(_Context->x_Auto3588+530,_Context->y_Auto3588+50,68,16,vfh[8],16,22,_Context->msg_Quit[_Context->language],strlen(_Context->msg_Quit[_Context->language]),0);
	visual_thaw(_Context->x_Auto3588,_Context->y_Auto3588,610,80);
...
private int Auto3588action(struct accept_search_context * _Context) {
	...
	do {
		...
		_Context->x_Auto3588 += (visual_event(7)-x);
		x=visual_event(7);
		if (_Context->x_Auto3588 < 0) { _Context->x_Auto3588=0; }
		_Context->y_Auto3588 += (visual_event(6)-y);
		y=visual_event(6);
		if (_Context->y_Auto3588 < 0) { _Context->y_Auto3588=0; }
...
struct accept_search_context * _Context){
	...
	switch (mt) {
	case _MIMO_UP :
	if ((mx >= (_Context->x_Auto3588+589) )  
	&&  (my >= (_Context->y_Auto3588+4) )  
	&&  (mx <= (_Context->x_Auto3588+606) )  
	&&  (my <= (_Context->y_Auto3588+20) )) {
		return(1);	/* Auto3588 */

		}
	if ((mx >= (_Context->x_Auto3588+573) )  
	&&  (my >= (_Context->y_Auto3588+4) )  
	&&  (mx <= (_Context->x_Auto3588+590) )  
	&&  (my <= (_Context->y_Auto3588+20) )) {
	...
	if ((mx >= (_Context->x_Auto3588+557) )  
	&&  (my >= (_Context->y_Auto3588+4) )  
	&&  (mx <= (_Context->x_Auto3588+574) )  
	&&  (my <= (_Context->y_Auto3588+20) )) {
	...
	case _MIMO_DOWN :
		if ((mx >= (_Context->x_Auto3588+4) )  
		&&  (my >= (_Context->y_Auto3588+4) )  
		&&  (mx <= (_Context->x_Auto3588+542) )  
		&&  (my <= (_Context->y_Auto3588+20) )) {
			return( Auto3588action(_Context) );
			}
		}
	if (( mx >= (_Context->x_Auto3588+100) ) 
	&&  ( my >= (_Context->y_Auto3588+30) ) 
	&&  ( mx <= (_Context->x_Auto3588+100+424) ) 
	&&  ( my <= (_Context->y_Auto3588+30+16))) {
		return(2); /* Criteria */
		}
	if (( mx >= (_Context->x_Auto3588+90) ) 
	&&  ( my >= (_Context->y_Auto3588+50) ) 
	&&  ( mx <= (_Context->x_Auto3588+90+154) ) 
	&&  ( my <= (_Context->y_Auto3588+50+16))) {
		return(3); /* IgnoreCase */
		}
	if (( mx >= (_Context->x_Auto3588+250) ) 
	&&  ( my >= (_Context->y_Auto3588+50) ) 
	&&  ( mx <= (_Context->x_Auto3588+250+168) ) 
	&&  ( my <= (_Context->y_Auto3588+50+16))) {
		return(4); /* ReverseSearch */
		}
	if (( mx >= (_Context->x_Auto3588+530) ) 
	&&  ( my >= (_Context->y_Auto3588+30) ) 
	&&  ( mx <= (_Context->x_Auto3588+530+68) ) 
	&&  ( my <= (_Context->y_Auto3588+30+16))) {
		return(5); /* DoFind */
		}
	if (( mx >= (_Context->x_Auto3588+530) ) 
...
public	int	accept_search_focus(struct accept_search_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			case	0x2 :
				/* Criteria */
				_Context->keycode = visual_edit(_Context->x_Auto3588+100+1,_Context->y_Auto3588+30+1,424,16,vfh[1],_Context->buffer_Criteria,255);
			...
			case	0x3 :
				/* IgnoreCase */
				visual_check(_Context->x_Auto3588+90,_Context->y_Auto3588+50,154,16,vfh[2],16,22,_Context->msg_IgnoreCase[_Context->language],strlen(_Context->msg_IgnoreCase[_Context->language]),(_Context->value_IgnoreCase |2));
	...
	visual_check(_Context->x_Auto3588+90,_Context->y_Auto3588+50,154,16,vfh[2],16,22,_Context->msg_IgnoreCase[_Context->language],strlen(_Context->msg_IgnoreCase[_Context->language]),_Context->value_IgnoreCase|0);
			...
			case	0x4 :
				/* ReverseSearch */
				visual_check(_Context->x_Auto3588+250,_Context->y_Auto3588+50,168,16,vfh[2],16,22,_Context->msg_ReverseSearch[_Context->language],strlen(_Context->msg_ReverseSearch[_Context->language]),(_Context->value_ReverseSearch |2));
				_Context->keycode = visual_getch();
				_Context->trigger_ReverseSearch=visual_trigger_code(_Context->msg_ReverseSearch[_Context->language],strlen(_Context->msg_ReverseSearch[_Context->language]));
	visual_check(_Context->x_Auto3588+250,_Context->y_Auto3588+50,168,16,vfh[2],16,22,_Context->msg_ReverseSearch[_Context->language],strlen(_Context->msg_ReverseSearch[_Context->language]),_Context->value_ReverseSearch|0);
				break;
			case	0x5 :
				/* DoFind */
				_Context->trigger_DoFind=visual_trigger_code(_Context->msg_DoFind[_Context->language],strlen(_Context->msg_DoFind[_Context->language]));
				visual_button(_Context->x_Auto3588+530,_Context->y_Auto3588+30,68,16,vfh[8],16,22,_Context->msg_DoFind[_Context->language],strlen(_Context->msg_DoFind[_Context->language]),2);
				_Context->keycode = visual_getch();
				_Context->trigger_DoFind=visual_trigger_code(_Context->msg_DoFind[_Context->language],strlen(_Context->msg_DoFind[_Context->language]));
	visual_button(_Context->x_Auto3588+530,_Context->y_Auto3588+30,68,16,vfh[8],16,22,_Context->msg_DoFind[_Context->language],strlen(_Context->msg_DoFind[_Context->language]),0);
				break;
			case	0x6 :
				/* Quit */
				_Context->trigger_Quit=visual_trigger_code(_Context->msg_Quit[_Context->language],strlen(_Context->msg_Quit[_Context->language]));
				visual_button(_Context->x_Auto3588+530,_Context->y_Auto3588+50,68,16,vfh[8],16,22,_Context->msg_Quit[_Context->language],strlen(_Context->msg_Quit[_Context->language]),2);
				_Context->keycode = visual_getch();
				_Context->trigger_Quit=visual_trigger_code(_Context->msg_Quit[_Context->language],strlen(_Context->msg_Quit[_Context->language]));
	visual_button(_Context->x_Auto3588+530,_Context->y_Auto3588+50,68,16,vfh[8],16,22,_Context->msg_Quit[_Context->language],strlen(_Context->msg_Quit[_Context->language]),0);
				break;
