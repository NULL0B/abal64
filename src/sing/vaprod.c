...
#define pt__auto2   ""
#define xx__auto2   ""
#define en_Auto3535   "ABAL and ABAL++ Source Production"
#define fr_Auto3535   "Production de Source ABAL et ABAL++"
#define it_Auto3535   "ABAL and ABAL++ Source Production"
#define es_Auto3535   "ABAL and ABAL++ Source Production"
#define de_Auto3535   "ABAL and ABAL++ Source Produktion"
#define nl_Auto3535   "ABAL and ABAL++ Source Production"
#define pt_Auto3535   "ABAL and ABAL++ Source Production"
#define xx_Auto3535   "ABAL and ABAL++ Source Production"
...
#define en_Auto3538   "Nature"
#define fr_Auto3538   "Nature"
#define it_Auto3538   "Nature"
#define es_Auto3538   "Nature"
#define de_Auto3538   "Nature"
#define nl_Auto3538   "Nature"
#define pt_Auto3538   "Nature"
#define xx_Auto3538   "Nature"
#define en_Auto3539   "abalicon.gif"
#define fr_Auto3539   "abalicon.gif"
#define it_Auto3539   "abalicon.gif"
#define es_Auto3539   "abalicon.gif"
#define de_Auto3539   "abalicon.gif"
#define nl_Auto3539   "abalicon.gif"
#define pt_Auto3539   "abalicon.gif"
#define xx_Auto3539   "abalicon.gif"
...
#define en_Auto3542   "Dimensions"
#define fr_Auto3542   "Dimensions"
#define it_Auto3542   "Dimensions"
#define es_Auto3542   "Dimensions"
#define de_Auto3542   "Dimensions"
#define nl_Auto3542   "Dimensions"
#define pt_Auto3542   "Dimensions"
#define xx_Auto3542   "Dimensions"
...
#define en_Auto3543   "Tcode Constants"
#define fr_Auto3543   "Constantes Tcode"
#define it_Auto3543   "Tcode Constants"
#define es_Auto3543   "Tcode Constants"
#define de_Auto3543   "Tcode Constants"
#define nl_Auto3543   "Tcode Constants"
#define pt_Auto3543   "Tcode Constants"
#define xx_Auto3543   "Tcode Constants"
#define en_Auto3545   "Tcode Pragmas"
#define fr_Auto3545   "Pragmas Tcode"
#define it_Auto3545   "Tcode Pragmas"
#define es_Auto3545   "Tcode Pragmas"
#define de_Auto3545   "Tcode Pragmas"
#define nl_Auto3545   "Tcode Pragmas"
#define pt_Auto3545   "Tcode Pragmas"
#define xx_Auto3545   "Tcode Pragmas"
...
private int on_Auto3540_event(struct accept_abal_production_context * _Context);
private int on_Auto3541_event(struct accept_abal_production_context * _Context);
...
public	int	accept_abal_production_show(struct accept_abal_production_context * _Context)
{
	...
	visual_text(_Context->x_auto2+10,_Context->y_auto2+30,590,30,vfh[3],27,0,_Context->msg_Auto3535[_Context->language],strlen(_Context->msg_Auto3535[_Context->language]),515);
	...
	if (_Context->page_number == 1 ) {
	visual_text(_Context->x_auto2+50,_Context->y_auto2+250,141,18,vfh[2],27,0,_Context->msg_Auto3538[_Context->language],strlen(_Context->msg_Auto3538[_Context->language]),2);
		}
	if (_Context->page_number == 1 ) {
	visual_image(_Context->x_auto2+370,_Context->y_auto2+270,51,53,_Context->msg_Auto3539[_Context->language],3);
		}
	if (_Context->page_number == 1 ) {
	...
	visual_button(_Context->x_auto2+20,_Context->y_auto2+410,56,48,vfh[2],34,0,_Context->msg_Auto3540[_Context->language],strlen(_Context->msg_Auto3540[_Context->language]),1040);
	...
	visual_button(_Context->x_auto2+540,_Context->y_auto2+410,56,48,vfh[2],34,0,_Context->msg_Auto3541[_Context->language],strlen(_Context->msg_Auto3541[_Context->language]),1040);
	if (_Context->page_number == 1 ) {
	visual_text(_Context->x_auto2+430,_Context->y_auto2+250,140,20,vfh[2],27,0,_Context->msg_Auto3542[_Context->language],strlen(_Context->msg_Auto3542[_Context->language]),1);
		}
	if (_Context->page_number == 1 ) {
	...
	if (_Context->page_number == 4 ) {
	visual_text(_Context->x_auto2+40,_Context->y_auto2+110,260,16,vfh[2],16,0,_Context->msg_Auto3543[_Context->language],strlen(_Context->msg_Auto3543[_Context->language]),259);
	...
	if (_Context->page_number == 4 ) {
	visual_text(_Context->x_auto2+310,_Context->y_auto2+110,270,16,vfh[2],16,0,_Context->msg_Auto3545[_Context->language],strlen(_Context->msg_Auto3545[_Context->language]),259);
...
private int ExactDimensions_help()
{
	switch (visual_national_language(-1)) {
		case 0 : 
			...
			mptr[8]="screen width using the Conf(68) and Conf(69) values during the OnCreate method of the parent form.    ";
			return(visual_online_help(mptr,9));
			}
			break;
		case 1 : 
...
private int UseEdit_help()
{
	switch (visual_national_language(-1)) {
		case 0 : 
			...
			mptr[1]="field will be opened  for inspection using the standard Text Editor.   ";
			return(visual_online_help(mptr,2));
			}
			break;
		case 1 : 
...
struct accept_abal_production_context * _Context){
	...
	if (visual_event(1) & _MIMO_ALT) {
		...
		if (_Context->trigger_Auto3540 == mb ) return(13);
		if (_Context->trigger_Auto3541 == mb ) return(14);
...
public	int	accept_abal_production_focus(struct accept_abal_production_context * _Context)
{
	...
	visual_check(_Context->x_auto2+210,_Context->y_auto2+310,168,16,vfh[2],27,0,_Context->msg_ExactDimensions[_Context->language],strlen(_Context->msg_ExactDimensions[_Context->language]),_Context->value_ExactDimensions|0);
			...
			case	0xd :
				/* Auto3540 */
				_Context->trigger_Auto3540=visual_trigger_code(_Context->msg_Auto3540[_Context->language],strlen(_Context->msg_Auto3540[_Context->language]));
				visual_button(_Context->x_auto2+20,_Context->y_auto2+410,56,48,vfh[2],34,0,_Context->msg_Auto3540[_Context->language],strlen(_Context->msg_Auto3540[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto3540=visual_trigger_code(_Context->msg_Auto3540[_Context->language],strlen(_Context->msg_Auto3540[_Context->language]));
	visual_button(_Context->x_auto2+20,_Context->y_auto2+410,56,48,vfh[2],34,0,_Context->msg_Auto3540[_Context->language],strlen(_Context->msg_Auto3540[_Context->language]),1040);
				break;
			case	0xe :
				/* Auto3541 */
				_Context->trigger_Auto3541=visual_trigger_code(_Context->msg_Auto3541[_Context->language],strlen(_Context->msg_Auto3541[_Context->language]));
				visual_button(_Context->x_auto2+540,_Context->y_auto2+410,56,48,vfh[2],34,0,_Context->msg_Auto3541[_Context->language],strlen(_Context->msg_Auto3541[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto3541=visual_trigger_code(_Context->msg_Auto3541[_Context->language],strlen(_Context->msg_Auto3541[_Context->language]));
	visual_button(_Context->x_auto2+540,_Context->y_auto2+410,56,48,vfh[2],34,0,_Context->msg_Auto3541[_Context->language],strlen(_Context->msg_Auto3541[_Context->language]),1040);
				break;
	...
	visual_button(_Context->x_auto2+310,_Context->y_auto2+360,90,30,vfh[2],27,24,_Context->msg_Select[_Context->language],strlen(_Context->msg_Select[_Context->language]),0);
			...
			case	0x16 :
				/* Dependance */
				if (_Context->page_number == 2 ) {
					_Context->keycode = on_Dependance_getfocus(_Context);
				} else {
					_Context->keycode = 5;
					}
				break;
			...
			case	0x18 :
				/* Linkage */
				if (_Context->page_number == 3 ) {
					_Context->keycode = on_Linkage_getfocus(_Context);
				} else {
					_Context->keycode = 5;
					}
				break;
