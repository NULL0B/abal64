...
#define en_Auto3590   ""
#define en__Auto3590   ""
#define en_Auto3591   "Brightness"
#define fr_Auto3591   "Luminosit‚"
#define it_Auto3591   "Brightness"
#define es_Auto3591   "Brightness"
#define de_Auto3591   "Brightness"
#define nl_Auto3591   "Brightness"
#define pt_Auto3591   "Brightness"
#define xx_Auto3591   "Brightness"
#define en__Auto3591   ""
#define en_Auto3592   "Blue"
#define fr_Auto3592   "Bleu"
#define it_Auto3592   "Blue"
#define es_Auto3592   "Blue"
#define de_Auto3592   "Blau"
#define nl_Auto3592   "Blau"
#define pt_Auto3592   "Blue"
#define xx_Auto3592   "Blue"
#define en__Auto3592   ""
#define en_Auto3593   "Green"
#define fr_Auto3593   "Vert"
#define it_Auto3593   "Green"
#define es_Auto3593   "Green"
#define de_Auto3593   "Gr&uuml;n"
#define nl_Auto3593   "Green"
#define pt_Auto3593   "Green"
#define xx_Auto3593   "Green"
#define en__Auto3593   ""
#define en_Auto3594   "Red"
#define fr_Auto3594   "Rouge"
#define it_Auto3594   "Red"
#define es_Auto3594   "Red"
#define de_Auto3594   "Rot"
#define nl_Auto3594   "Red"
#define pt_Auto3594   "Red"
#define xx_Auto3594   "Red"
#define en__Auto3594   ""
...
private struct accept_colour_transformation_context {
	...
	char	buffer_Auto3587[5];
	char * hint_Auto3588[8];
	char	buffer_Auto3588[5];
	char * hint_Auto3589[8];
	char	buffer_Auto3589[5];
	char * hint_Auto3590[8];
	char	buffer_Auto3590[5];
	char * msg_Auto3591[8];
...
static int	vfh[16];
private int on_Auto3587_show(struct accept_colour_transformation_context * _Context);
private int on_Auto3588_show(struct accept_colour_transformation_context * _Context);
private int on_Auto3589_show(struct accept_colour_transformation_context * _Context);
private int on_Auto3590_show(struct accept_colour_transformation_context * _Context);
...
public	int	accept_colour_transformation_create(struct accept_colour_transformation_context **cptr)
{
	...
	_Context->focus_items=13;
		...
		for (i=0; i < 4; i++)  *(_Context->buffer_Auto3587+i)=' ';
		for (i=0; i < 4; i++)  *(_Context->buffer_Auto3588+i)=' ';
		for (i=0; i < 4; i++)  *(_Context->buffer_Auto3589+i)=' ';
		for (i=0; i < 4; i++)  *(_Context->buffer_Auto3590+i)=' ';
...
private int on_Auto3587_show(struct accept_colour_transformation_context * _Context) {
	sprintf(_Context->buffer_Auto3587,"%u",_Context->value_Brightness);
	visual_frame(_Context->x_Window+420,_Context->y_Window+40,32+2,16+2,5);
visual_text(_Context->x_Window+420+1,_Context->y_Window+40+1,32,16,vfh[1],27,28,_Context->buffer_Auto3587,4,0);
;
	return(-1);
}
private int on_Auto3588_show(struct accept_colour_transformation_context * _Context) {
	sprintf(_Context->buffer_Auto3588,"%u",_Context->value_Red);
	visual_frame(_Context->x_Window+420,_Context->y_Window+60,32+2,16+2,5);
visual_text(_Context->x_Window+420+1,_Context->y_Window+60+1,32,16,vfh[1],27,28,_Context->buffer_Auto3588,4,0);
;
	return(-1);
}
private int on_Auto3589_show(struct accept_colour_transformation_context * _Context) {
	sprintf(_Context->buffer_Auto3589,"%u",_Context->value_Green);
	visual_frame(_Context->x_Window+420,_Context->y_Window+80,32+2,16+2,5);
visual_text(_Context->x_Window+420+1,_Context->y_Window+80+1,32,16,vfh[1],27,28,_Context->buffer_Auto3589,4,0);
;
	return(-1);
}
private int on_Auto3590_show(struct accept_colour_transformation_context * _Context) {
	sprintf(_Context->buffer_Auto3590,"%u",_Context->value_Blue);
	visual_frame(_Context->x_Window+420,_Context->y_Window+100,32+2,16+2,5);
visual_text(_Context->x_Window+420+1,_Context->y_Window+100+1,32,16,vfh[1],27,28,_Context->buffer_Auto3590,4,0);
;
	return(-1);
}
...
public	int	accept_colour_transformation_show(struct accept_colour_transformation_context * _Context)
{
	...
	(void) on_Auto3587_show(_Context);
	(void) on_Auto3588_show(_Context);
	(void) on_Auto3589_show(_Context);
	(void) on_Auto3590_show(_Context);
	visual_text(_Context->x_Window+30,_Context->y_Window+40,70,16,vfh[2],16,21,_Context->msg_Auto3591[_Context->language],strlen(_Context->msg_Auto3591[_Context->language]),257);
	visual_text(_Context->x_Window+30,_Context->y_Window+100,70,16,vfh[2],16,21,_Context->msg_Auto3592[_Context->language],strlen(_Context->msg_Auto3592[_Context->language]),257);
	visual_text(_Context->x_Window+30,_Context->y_Window+80,70,16,vfh[2],16,21,_Context->msg_Auto3593[_Context->language],strlen(_Context->msg_Auto3593[_Context->language]),257);
	visual_text(_Context->x_Window+30,_Context->y_Window+60,70,16,vfh[2],16,21,_Context->msg_Auto3594[_Context->language],strlen(_Context->msg_Auto3594[_Context->language]),257);
