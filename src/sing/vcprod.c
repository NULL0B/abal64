...
#define en_Auto3543   "ok.gif"
#define fr_Auto3543   "ok.gif"
#define it_Auto3543   "ok.gif"
#define es_Auto3543   "ok.gif"
#define de_Auto3543   "ok.gif"
#define nl_Auto3543   "ok.gif"
#define pt_Auto3543   "ok.gif"
#define xx_Auto3543   "ok.gif"
#define en_Auto3544   "cancel.gif"
#define fr_Auto3544   "cancel.gif"
#define it_Auto3544   "cancel.gif"
#define es_Auto3544   "cancel.gif"
#define de_Auto3544   "cancel.gif"
#define nl_Auto3544   "cancel.gif"
#define pt_Auto3544   "cancel.gif"
#define xx_Auto3544   "cancel.gif"
...
private int on_Auto3543_event(struct accept_c_production_context * _Context);
private int on_Auto3544_event(struct accept_c_production_context * _Context);
...
public	int	accept_c_production_show(struct accept_c_production_context * _Context)
{
	...
	_Context->trigger_Auto3543=visual_trigger_code(_Context->msg_Auto3543[_Context->language],strlen(_Context->msg_Auto3543[_Context->language]));
	visual_button(_Context->x_auto2+20,_Context->y_auto2+270,42,48,vfh[2],34,0,_Context->msg_Auto3543[_Context->language],strlen(_Context->msg_Auto3543[_Context->language]),1040);
	...
	visual_button(_Context->x_auto2+540,_Context->y_auto2+270,42,48,vfh[2],34,0,_Context->msg_Auto3544[_Context->language],strlen(_Context->msg_Auto3544[_Context->language]),1040);
...
struct accept_c_production_context * _Context){
	...
	if (visual_event(1) & _MIMO_ALT) {
		...
		if (_Context->trigger_Auto3543 == mb ) return(10);
		if (_Context->trigger_Auto3544 == mb ) return(11);
...
public	int	accept_c_production_focus(struct accept_c_production_context * _Context)
{
	...
	visual_check(_Context->x_auto2+350,_Context->y_auto2+230,126,16,vfh[2],16,0,_Context->msg_IsTrueColour[_Context->language],strlen(_Context->msg_IsTrueColour[_Context->language]),_Context->value_IsTrueColour|0);
			...
			case	0xa :
				/* Auto3543 */
				_Context->trigger_Auto3543=visual_trigger_code(_Context->msg_Auto3543[_Context->language],strlen(_Context->msg_Auto3543[_Context->language]));
				visual_button(_Context->x_auto2+20,_Context->y_auto2+270,42,48,vfh[2],34,0,_Context->msg_Auto3543[_Context->language],strlen(_Context->msg_Auto3543[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto3543=visual_trigger_code(_Context->msg_Auto3543[_Context->language],strlen(_Context->msg_Auto3543[_Context->language]));
	visual_button(_Context->x_auto2+20,_Context->y_auto2+270,42,48,vfh[2],34,0,_Context->msg_Auto3543[_Context->language],strlen(_Context->msg_Auto3543[_Context->language]),1040);
				break;
			case	0xb :
				/* Auto3544 */
				_Context->trigger_Auto3544=visual_trigger_code(_Context->msg_Auto3544[_Context->language],strlen(_Context->msg_Auto3544[_Context->language]));
				visual_button(_Context->x_auto2+540,_Context->y_auto2+270,42,48,vfh[2],34,0,_Context->msg_Auto3544[_Context->language],strlen(_Context->msg_Auto3544[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto3544=visual_trigger_code(_Context->msg_Auto3544[_Context->language],strlen(_Context->msg_Auto3544[_Context->language]));
	visual_button(_Context->x_auto2+540,_Context->y_auto2+270,42,48,vfh[2],34,0,_Context->msg_Auto3544[_Context->language],strlen(_Context->msg_Auto3544[_Context->language]),1040);
				break;
...
retry:
		...
		case	0x100 :
			...
			if (( visual_event(1) == _MIMO_DOWN ) && ( visual_event(2) == _MIMO_RIGHT)) {
				switch ((_Context->focus_item = retcode)) {
					...
					case	0xa :
						if (Auto3543_help(_Context) != 0) { continue; }
						else { break; }
					case	0xb :
						if (Auto3544_help(_Context) != 0) { continue; }
						else { break; }
					case	0xd :
	...
	visual_button(_Context->x_auto2+20,_Context->y_auto2+270,42,48,vfh[2],34,0,_Context->msg_Auto3543[_Context->language],strlen(_Context->msg_Auto3543[_Context->language]),1040);
					...
					if ( visual_event(1) &  0x20 ) {
					if ((_Context->keycode = on_Auto3543_event(_Context)) != -1) break;
