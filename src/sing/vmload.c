...
#define en_FileName   ""
#define en__FileName   ""
#define en_Auto3575   "ok.gif"
#define fr_Auto3575   "ok.gif"
#define it_Auto3575   "ok.gif"
#define es_Auto3575   "ok.gif"
#define de_Auto3575   "ok.gif"
#define nl_Auto3575   "ok.gif"
#define pt_Auto3575   "ok.gif"
#define xx_Auto3575   "ok.gif"
#define en__Auto3575   ""
...
#define en_Auto3576   "cancel.gif"
#define fr_Auto3576   "cancel.gif"
#define it_Auto3576   "cancel.gif"
#define es_Auto3576   "cancel.gif"
#define de_Auto3576   "cancel.gif"
#define nl_Auto3576   "cancel.gif"
#define pt_Auto3576   "cancel.gif"
#define xx_Auto3576   "cancel.gif"
#define en__Auto3576   ""
...
static int	vfh[16];
private int on_Auto3575_event(struct accept_modelfilename_context * _Context);
private int on_Select_event(struct accept_modelfilename_context * _Context);
private int on_Auto3576_event(struct accept_modelfilename_context * _Context);
...
public	int	accept_modelfilename_show(struct accept_modelfilename_context * _Context)
{
	...
	_Context->trigger_Auto3575=visual_trigger_code(_Context->msg_Auto3575[_Context->language],strlen(_Context->msg_Auto3575[_Context->language]));
	visual_button(_Context->x_auto703+20,_Context->y_auto703+140,56,48,vfh[2],34,0,_Context->msg_Auto3575[_Context->language],strlen(_Context->msg_Auto3575[_Context->language]),1040);
	...
	_Context->trigger_Auto3576=visual_trigger_code(_Context->msg_Auto3576[_Context->language],strlen(_Context->msg_Auto3576[_Context->language]));
	visual_button(_Context->x_auto703+510,_Context->y_auto703+140,56,48,vfh[2],34,0,_Context->msg_Auto3576[_Context->language],strlen(_Context->msg_Auto3576[_Context->language]),1040);
...
struct accept_modelfilename_context * _Context){
	...
	if (visual_event(1) & _MIMO_ALT) {
		...
		if (_Context->trigger_Auto3575 == mb ) return(3);
		if (_Context->trigger_Select == mb ) return(4);
		if (_Context->trigger_Auto3576 == mb ) return(5);
		return(-1);
		}
...
public	int	accept_modelfilename_focus(struct accept_modelfilename_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			...
			case	0x3 :
				/* Auto3575 */
				_Context->trigger_Auto3575=visual_trigger_code(_Context->msg_Auto3575[_Context->language],strlen(_Context->msg_Auto3575[_Context->language]));
				visual_button(_Context->x_auto703+20,_Context->y_auto703+140,56,48,vfh[2],34,0,_Context->msg_Auto3575[_Context->language],strlen(_Context->msg_Auto3575[_Context->language]),1042);
	...
	visual_button(_Context->x_auto703+350,_Context->y_auto703+150,100,30,vfh[2],27,24,_Context->msg_Select[_Context->language],strlen(_Context->msg_Select[_Context->language]),0);
			...
			case	0x5 :
				/* Auto3576 */
				_Context->trigger_Auto3576=visual_trigger_code(_Context->msg_Auto3576[_Context->language],strlen(_Context->msg_Auto3576[_Context->language]));
				visual_button(_Context->x_auto703+510,_Context->y_auto703+140,56,48,vfh[2],34,0,_Context->msg_Auto3576[_Context->language],strlen(_Context->msg_Auto3576[_Context->language]),1042);
				_Context->keycode = visual_getch();
				_Context->trigger_Auto3576=visual_trigger_code(_Context->msg_Auto3576[_Context->language],strlen(_Context->msg_Auto3576[_Context->language]));
	visual_button(_Context->x_auto703+510,_Context->y_auto703+140,56,48,vfh[2],34,0,_Context->msg_Auto3576[_Context->language],strlen(_Context->msg_Auto3576[_Context->language]),1040);
				break;
...
retry:
		...
		case	0x100 :
			...
			if (( visual_event(1) == _MIMO_DOWN ) && ( visual_event(2) == _MIMO_RIGHT)) {
				switch ((_Context->focus_item = retcode)) {
					...
					case	0x3 :
						if (Auto3575_help(_Context) != 0) { continue; }
						else { break; }
					case	0x4 :
						if (Select_help(_Context) != 0) { continue; }
						else { break; }
					case	0x5 :
						if (Auto3576_help(_Context) != 0) { continue; }
						else { break; }
					}
				}
			switch ((_Context->focus_item = retcode)) {
	...
	visual_button(_Context->x_auto703+20,_Context->y_auto703+140,56,48,vfh[2],34,0,_Context->msg_Auto3575[_Context->language],strlen(_Context->msg_Auto3575[_Context->language]),1040);
					...
					if ((_Context->keycode = on_Auto3575_event(_Context)) != -1) break;
	...
	visual_button(_Context->x_auto703+510,_Context->y_auto703+140,56,48,vfh[2],34,0,_Context->msg_Auto3576[_Context->language],strlen(_Context->msg_Auto3576[_Context->language]),1040);
					...
					if ( visual_event(1) &  0x20 ) {
					if ((_Context->keycode = on_Auto3576_event(_Context)) != -1) break;
