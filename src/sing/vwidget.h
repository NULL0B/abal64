...
#define	_WIDGET_PUBLIC		0x0001
#define	_WIDGET_EXTERN		0x0002
#define	_WIDGET_DISABLE		0x0004
#define	_WIDGET_INHIBIT		0x0008
#define	_WIDGET_ACCESS		(_WIDGET_DISABLE | _WIDGET_INHIBIT)
...
#define	_WIDGET_UPLOAD     	18
#define	_WIDGET_IFRAME		19
#define	_WIDGET_CHAINTOP	20
#define	_WIDGET_IMAGE		21
#define	_WIDGET_DROPZONE	22
#define	_WIDGET_NETWORK 	23
#define	_WIDGET_AUDIO   	24
#define	_WIDGET_AJAX    	25
#define	_WIDGET_VIDEO		26
...
#ifdef	ABAL32A
#define	WidgetTypeList	 	"void|int8|int16|int32|float|numeric|string|constant|pointer|class|overlay|textfile|module|chain|loadgo|system|hyperlink|task|upload|iframe|chaintop|image|dropzone|network|audio|ajax|video"
#else
#define	WidgetTypeList	 	"void|int8|int16|int32|float|numeric|string|constant|pointer|class|overlay|textfile|module|chain|chaintop|loadgo|system|hyperlink|task|upload|iframe|chaintop|image|dropzone"
#endif

#define	WidgetAlignList	 	"none|right|left|center|justify"
#define	WidgetDataList		"variable|instance|visual|sifile|mcfile|vmemory|sqfile|dbfile|adfile|visualgroup|occi|mirror|replicate"
#define	WidgetTabList		"standard|concave|convex"
#define	WidgetImageList	 	"none|right|left|center|tile|makefit|bestfit|cover"
...
#define	FormTypeList "Dialog Box|Event Driven|HQ Document|Draft Document|Web Service|Web Agent"

#define	ProductionLanguageList	production_languages()
#ifdef	ABAL34A
#define ProductionLanguages "Abal|Abal++|Html|C|C++|Android|Java|Php|REACT|BiFS|LASeR|Cobol|XMTA|NODE.JS"
#else
#define ProductionLanguages "Abal|Abal++|Html|C|C++|Android|Java|Php|REACT|BIFS|LASeR|Cobol|XMTA|NODE.JS"
#endif
