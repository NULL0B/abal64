...
#define en_Auto3640   "Source Filename"
#define fr_Auto3640   "Fichier"
#define it_Auto3640   "Filename"
#define es_Auto3640   "Filename"
#define de_Auto3640   "Datei"
...
#define pt__Auto3640   ""
#define xx__Auto3640   ""
#define en_Auto3641   "Symbol Conversion"
#define fr_Auto3641   "Fichier"
#define it_Auto3641   "Filename"
#define es_Auto3641   "Filename"
#define de_Auto3641   "Datei"
#define nl_Auto3641   "Filename"
#define pt_Auto3641   "Filename"
#define xx_Auto3641   "Filename"
#define en__Auto3641   ""
#define fr__Auto3641   ""
#define it__Auto3641   ""
#define es__Auto3641   ""
	...
	char * pEcho)
{
	...
	_Context->x_Auto3639=105;
	_Context->y_Auto3639=195;
	_Context->w_Auto3639=590;
	_Context->h_Auto3639=210;
...
public	int	accept_abal_filename_show(struct accept_abal_filename_context * _Context)
{
	...
	visual_text(125,285,126,16,vfh[2],16,0,_Context->msg_Auto3640[_Context->language],strlen(_Context->msg_Auto3640[_Context->language]),258);
	visual_text(125,325,126,16,vfh[2],16,0,_Context->msg_Auto3641[_Context->language],strlen(_Context->msg_Auto3641[_Context->language]),258);
...
private int Auto3639action(struct accept_abal_filename_context * _Context) {
	...
	do {
		...
		_Context->x_Auto3639 += (visual_event(7)-x);
		x=visual_event(7);
		if (_Context->x_Auto3639 < 0) { _Context->x_Auto3639=0; }
		_Context->y_Auto3639 += (visual_event(6)-y);
		y=visual_event(6);
		if (_Context->y_Auto3639 < 0) { _Context->y_Auto3639=0; }
...
struct accept_abal_filename_context * _Context){
	...
	case _MIMO_DOWN :
		...
		&&  (mx <= (105+522) )  
		&&  (my <= (195+20) )) {
			return( Auto3639action(_Context) );
			}
		}
	if (( mx >= 245 ) 
	&&  ( my >= 285 ) 
