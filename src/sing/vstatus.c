...
public	int	visual_status_bar_create(struct visual_status_bar_context **cptr)
{
	...
	_Context->x_ZoneOne=105;
	_Context->y_ZoneOne=281;
	...
	_Context->x_ZoneThree=625;
	_Context->y_ZoneThree=281;
	...
	_Context->x_ZoneError=625;
	_Context->y_ZoneError=281;
	...
	_Context->x_ZoneTwo=365;
	_Context->y_ZoneTwo=281;
...
public	int	visual_status_bar_show(struct visual_status_bar_context * _Context)
{
	...
	int ow;
	int oh;
	_Context->x_Frame=97;_Context->y_Frame=274;_Context->w_Frame=790;_Context->h_Frame=30;;
	ow=_Context->w_Frame;
	...
	_Context->h_Frame+=1;
	_Context->x_ZoneOne=105;_Context->y_ZoneOne=281;_Context->w_ZoneOne=252;_Context->h_ZoneOne=16;;
	_Context->x_ZoneTwo=365;_Context->y_ZoneTwo=281;_Context->w_ZoneTwo=252;_Context->h_ZoneTwo=16;;
	_Context->x_ZoneThree=625;_Context->y_ZoneThree=281;_Context->w_ZoneThree=252;_Context->h_ZoneThree=16;;
	_Context->x_ZoneError=625;_Context->y_ZoneError=281;_Context->w_ZoneError=252;_Context->h_ZoneError=16;;
...
public	int	visual_status_bar_focus(struct visual_status_bar_context * _Context)
{
	...
	while(1) {
		switch (_Context->focus_item) {
			case	0x1 :
				/* IsError */
				visual_check(109,282,64,16,vfh[1],27,28,_Context->msg_IsError[_Context->language],strlen(_Context->msg_IsError[_Context->language]),(_Context->value_IsError |2));
	...
	visual_check(109,282,64,16,vfh[1],27,28,_Context->msg_IsError[_Context->language],strlen(_Context->msg_IsError[_Context->language]),_Context->value_IsError|0);
				break;
