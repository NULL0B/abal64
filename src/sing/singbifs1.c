...
void	bifs_proto_instance( FILE * h, struct form_control * fptr )
{
	char	work[1024];
	bifs_def_tag(h,fptr->identifier,"This");
	bifs_close_tag(h,fptr->identifier);
	return;
}


void	bifs_proto_definition( FILE * h, struct form_control * fptr )
{
	char	work[1024];
	struct	form_item * iptr;
