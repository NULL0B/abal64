...
char *	guifontname( int number );	/* GWB le 22/08/2007 */

/* inipixel.c */
int	get_pixel_size();
void *	share_psu(int process,void * aptr,void * bptr, void * cptr);

/* stdfont.c */
int	fontcharactersize(int c, int number );
int	guifontsave( int number, char * filename );
int	load_font( int number, char * filename );
int	standard_load_font( char * fontfilename );
struct	standard_font * drop_font( struct standard_font * fptr );
	/* GWB le 22/08/2007 */
char * get_hq_fontname( int number, int item );
int	set_hq_fontname( int number, int item, char * hqfontname );
char *	fontcharacterdata(int c, int number );

/* pixelco.c */
int	textsizelen(int fid, char * sptr, int l);
int	PixelFontCat(int atx, int aty, int fontid, int c );
int	PixelFontLat(int atx, int aty, int fontid,unsigned  char * sptr, int l );
int	PixelFontSat(int atx, int aty,int fontid, char * sptr );
...
/* varrow.c */
int	visual_arrow( int atx, int aty, int nbx, int nby, int dath, int style );
int	visual_focus( int atx, int aty, int nbx, int nby );

/* vgetch.c */
int	cancel_replay_record();

/* vline.c */
void	drawline(int fromx,int fromy, int tox, int toy, int thick, int colour, int (*output)(int,int,int,int,int) );

/* vmakefit.c */
void	istretch_columns( char * tptr, int tw, char * sptr, int sw, int pixelsize );
void	isquash_columns( char * tptr, int tw, char * sptr, int sw, int pixelsize );
