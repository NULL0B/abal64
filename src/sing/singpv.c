...
#ifdef	ABAL32A
#define	_GDT_DATE	"29/11/2017"
#else
#define	_GDT_DATE	"30/07/2011"
#define	_GDT_DATE	"28/10/2014"
#endif
...
#ifdef	NEWSING
public 	char 	LaPaterne[20] = { '*','P','R','L','@','I','N','F','O','*','#',6,'6','1','a','0','2','8',0 };
public 	char 	StringPaterne[20] = { '*','P','R','L','@','I','N','F','O','*','$','6','6','1','a','0','2','1',0 };
#else
#ifdef	ABALCPP 
...
private	int	banner()
{
	...
	printf("\n   Copyright (c) 2017 Amenesik \n");
	printf("\n   Production : ABAL/ABAL++/C/PHP/REACT/BiFS/LASeR/Widget/Android \n");
	printf("\n   Syntax : \t sing [ options parameters ] \n");
	printf("\n          -i config@host         : inject configuration as host configuration entry ");
