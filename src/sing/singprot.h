...
public	int	c_define_messages(FILE * h,struct form_control * fptr);
...
public int compile_cpp(char *cname);
public int link_cpp(char *cname);
public int compile_dll_cpp(char *cname);
public int link_dll_cpp(char *cname);
