...
#define	NODE_EXTENSION		".html"
#define	TXT_EXTENSION		".txt"
#define	JSON_EXTENSION		".json"
#define	INC_EXTENSION		".inc"
#define	WSDL_EXTENSION		".wsdl"
#define	REACT_EXTENSION		".html"

#define	SVG_EXTENSION		".svg"
#define	LASER_EXTENSION		".svg"
#define	BIFS_EXTENSION		".bt"
#define	XMTA_EXTENSION		".xmt"
#define	MPEG_EXTENSION		".mpeg"
#define	MP4_EXTENSION		".mp4"
#define	MP3_EXTENSION		".mp3"

#define	XSD_EXTENSION		".xsd"
