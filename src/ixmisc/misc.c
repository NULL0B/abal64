...
/*global*/ VOID MakeNom(rep,nom,ext,pt)
BYTE XPTR rep;
BYTE XPTR nom;
BYTE XPTR ext;
BYTE XPTR pt;
...
/*global*/ VOID MakeReper(Nrep,Dnom)
BYTE XPTR Nrep;
BYTE XPTR Dnom;
{
	BINAIRE index;
...
VOID  diff_repfich(repertoire,fichier,resultat)
BYTE XPTR repertoire;
BYTE XPTR fichier;
BYTE XPTR resultat;
{
	BYTE misctmpA[LGREP];
...
VOID make_full_path(prep,pfic,pres)
BYTE XPTR prep;
BYTE XPTR pfic;
BYTE XPTR pres;
{
