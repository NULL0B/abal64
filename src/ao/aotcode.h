...
#define		_tc_GWS		0x75		/* Word to Global % int	   */
#define		_tc_LWS		0x77		/* Word to Local  % int	   */
...
#define		_tc_CVR		0x70		/* Store Constant to reg   */
#define		_tc_LDE		0x70		/* Extended LDF 	   */
...
#define		_tc_OLE		0x57		/* OP Reg Ettiq		   */
...
#define		_clf_CHR	0x7D		/* CLF CHR		*/
#define		_clf_LENDOLLAR	0x3B		/* CLF LEN$		*/
#define		_clf_RESTORE	0x27		/* CLF SET RESTORE	*/
...
#define	ONSEM_JOIN	0x8000	/* Indicates Jointure necessary for BD	*/
...
#define	OFSEM_JOIN	0x7FFF	/* Clears the Jointure semaphore	*/
