// ***************************************************************************************************
// * bankrnl.h
// * Banner Kernel pour code C Twin, UseIT, Windows
// *                 et resources Windows
// ***************************************************************************************************
...
//     __linux__   (spécification POSIX) UNIX (habitude Amenesik Sologic)
//     __Prl PROLOGUE
//////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef __BANNER_C__
#define __BANNER_C__
...
#define COPYRIGHT_VAR   "Copyright (c) 2000-%4s Amenesik Sologic Software", & __DATE__ [7]
#define COPYRIGHT       "\n   Copyright (c) 1998-%4s Amenesik Sologic Software", & __DATE__ [7]
...
struct T_VerPattern 
  ...
  char buildsize;
   ...
   s_VersionPattern = { {'*','P','R','L','@','I','N','F','O','*','#'} ,6,VER_FILEVERSION_STRC, 
                '-',__DATE__, 
                '-',__TIME__,
                '-',"VERSION_STATUS:",VER_STATUS, 
                '-',{'*','P','R','L','@','B','U','I','L','D','*','#'},9,VER_BUILD_STR
                } ;
...
int Banner_DisplayBanner(void) 
{
  ...
  if (strlen(VER_INTERNALNAME_STR)!=0)
    printf("\n   %s",VER_INTERNALNAME_STR);
  if (strlen(VER_PRODUCTNAME_STR)!=0)
    printf("\n   %s",VER_PRODUCTNAME_STR);
  if (strlen(VER_COMMENT)!=0)
    printf("\n   %s",VER_COMMENT);
