 ...
 *	---------------------------------------------
 *
 *	Copyright (c) 1988 Prologue s.a.
 *
 *	ixenix.c - fichier parametre pour console SCO XENIX version 1.4 +imprimante
 *
 *	$Header:   C:/cico/fp/xenix.c@@   1.2   23 Aug 1990 14:35:28   NS  $
 *
 */
...
char *nom = "console SCO XENIX Monochrome+Imprimante ($Date: 01 Feb 1997 14:35:28  $)";
